 ...
 * @since 18/12/2021
 */
public class DesktopSwtCaretImpl extends CodeEditorCaretBase {
  public DesktopSwtCaretImpl(@Nonnull CodeEditorBase editor, @Nonnull CodeEditorCaretModelBase caretModel) {
