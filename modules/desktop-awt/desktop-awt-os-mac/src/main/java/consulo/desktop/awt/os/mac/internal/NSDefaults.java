...
public final class NSDefaults {
    ...
    private static final class Path {
        ...
        private static final class Node {
            ...
            @Override
            public String toString() {
                return String.format("sel='%s' nodeName='%s'", mySelector, myNodeName);
            }

            boolean isValid() {
                return !cachedNodeObj.equals(ID.NIL);
            }

            boolean isDomain() {
                return mySelector.equals("persistentDomainForName:");
            }
    ...
    public static boolean setShowFnKeysEnabled(String appId, boolean val) {
        return setShowFnKeysEnabled(appId, val, false);
    }
