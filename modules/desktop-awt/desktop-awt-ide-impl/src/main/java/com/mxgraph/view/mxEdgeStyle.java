...
public class mxEdgeStyle {
  ...
  public static mxEdgeStyleFunction ElbowConnector = new mxEdgeStyleFunction() {
    ...
    public void apply(mxCellState state, mxCellState source, mxCellState target, List<mxPoint> points, List<mxPoint> result) {
      ...
      if (!horizontal &&
          (vertical || mxUtils.getString(state.getStyle(), mxConstants.STYLE_ELBOW, "").equals(mxConstants.ELBOW_VERTICAL))) {
  ...
  public static mxEdgeStyleFunction SegmentConnector = new mxEdgeStyleFunction() {
    ...
    public void apply(mxCellState state, mxCellState source, mxCellState target, List<mxPoint> hints, List<mxPoint> result) {
      ...
      if (hints != null && hints.size() > 0) {
        ...
        if (horizontal &&
            ((pts.get(0) != null && pts.get(0).getY() != hint.getY()) ||
             (pts.get(0) == null && source != null && (hint.getY() < source.getY() || hint.getY() > source.getY() + source.getHeight())))) {
          result.add(new mxPoint(pt.getX(), hint.getY()));
        }
        else if (!horizontal &&
                 ((pts.get(0) != null && pts.get(0).getX() != hint.getX()) ||
                  (pts.get(0) == null &&
                   source != null &&
      ...
      if (horizontal &&
          ((pts.get(lastInx) != null && pts.get(lastInx).getY() != hint.getY()) ||
           (pts.get(lastInx) == null &&
            target != null &&
            (hint.getY() < target.getY() || hint.getY() > target.getY() + target.getHeight())))) {
        result.add(new mxPoint(pt.getX(), hint.getY()));
      }
      else if (!horizontal &&
               ((pts.get(lastInx) != null && pts.get(lastInx).getX() != hint.getX()) ||
                (pts.get(lastInx) == null &&
                 target != null &&
  ...
  public static int[][][] inlineRoutePatterns =
    new int[][][]{{null, {2114, 2568}, null, null}, {null, {514, 2081, 2114, 2568}, null, null}, {null, {2114, 2561}, null, null},
