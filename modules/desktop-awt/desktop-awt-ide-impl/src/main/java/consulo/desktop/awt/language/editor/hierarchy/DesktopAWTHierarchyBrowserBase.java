 ...
 * @author yole
 */
public abstract class DesktopAWTHierarchyBrowserBase extends SimpleToolWindowPanel implements Disposable, UiDataProvider {
    ...
    protected DesktopAWTHierarchyBrowserBase(Project project) {
        super(true, true);
        myProject = project;
    ...
    protected void appendActions(DefaultActionGroup actionGroup, @Nullable String helpID) {
    ...
    protected final @Nullable PsiElement getElementFromDescriptor(HierarchyNodeDescriptor descriptor) {
        return descriptor.getHierarchyElement();
    }
    ...
    protected final @Nullable HierarchyNodeDescriptor getSelectedDescriptor() {
        DefaultMutableTreeNode node = getSelectedNode();
        return node != null ? getDescriptor(node) : null;
    }

    public final @Nullable PsiElement getSelectedElement() {
