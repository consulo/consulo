...
public abstract class OpenInEditorWithMouseAction extends DumbAwareAction implements AnActionWithSyncUpdate {
    ...
    public void update(AnActionEvent e) {
        ...
        MouseEvent convertedEvent = SwingUtilities.convertMouseEvent(component, mouseEvent, componentAt);
