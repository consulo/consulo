 ...
 */
public class CustomRoundedFlatListUI
    extends BasicListUI
    ...
    public static ComponentUI createUI(JComponent c) {
        return new CustomRoundedFlatListUI();
    }
    ...
    public static void paintCellSelection(JList<?> list, Graphics g, int row, int x, int y, int width, int height) {
        if (!(list.getUI() instanceof CustomRoundedFlatListUI)) {
            return;
        }

        CustomRoundedFlatListUI ui = (CustomRoundedFlatListUI) list.getUI();
