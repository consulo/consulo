...
import static consulo.desktop.awt.fileChooser.impl.system.windows2.IFileOpenDialog.CLSID_FILEOPENDIALOG;
import static consulo.desktop.awt.fileChooser.impl.system.windows2.IFileOpenDialog.IID_IFILEOPENDIALOG;
    ...
    public AsyncResult<VirtualFile[]> chooseAsync(@Nullable ComponentManager project, @Nonnull VirtualFile[] toSelectFiles) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            if (finalDirectoryName != null) {
                ...
                COMUtils.checkRC(Shell32.INSTANCE.SHCreateItemFromParsingName(
                    new WString(FileUtil.toSystemDependentName(finalDirectoryName)),
                    Pointer.NULL,
                    new Guid.REFIID(IShellItem.IID_ISHELLITEM),
                    ppv
                ));
