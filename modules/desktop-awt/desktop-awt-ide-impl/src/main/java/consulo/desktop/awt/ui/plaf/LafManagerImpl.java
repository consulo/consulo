...
import consulo.desktop.awt.ui.plaf.flatLaf.FlatDarkLookAndFeelInfo;
import consulo.desktop.awt.ui.plaf.flatLaf.FlatLightLookAndFeelInfo;
import consulo.desktop.awt.ui.plaf.flatLaf.component.FlatLafTextBoxWithExtensionsImpl;
...
public final class LafManagerImpl implements LafManager, Disposable, PersistentStateComponent<Element> {
    ...
    LafManagerImpl() {
        ...
        lafList.add(new FlatLightLookAndFeelInfo());
        lafList.add(new FlatDarkLookAndFeelInfo());
    ...
    public static void installMacOSXFonts(UIDefaults defaults) {
        ...
        for (Object key : new HashSet<>(defaults.keySet())) {
            ...
            if (!StringUtil.endsWithIgnoreCase(((String) key), "font")) {
                continue;
            }
    ...
    public void updateUI() {
        ...
        else if (UIUtil.isWinLafOnVista() && !UIUtil.isUnderFlatLookAndFeel()) {
        ...
        if (UIUtil.isUnderFlatLookAndFeel()) {
            uiDefaults.put(SupportTextBoxWithExtensionsExtender.class, (SupportTextBoxWithExtensionsExtender) FlatLafTextBoxWithExtensionsImpl::new);
        }
