...
import consulo.desktop.awt.ui.plaf.darcula.DarculaSpinnerUI;
...
public final class WinIntelliJSpinnerUI extends DarculaSpinnerUI {
        ...
        JButton button = new BasicArrowButton(direction) {
            ...
            public void paint(Graphics g) {
                ...
                try {
                    ...
                    // paint icon
                    Icon icon = WinIconLookup.INSTANCE.getIcon(iconName, false, false, isEnabled());
    ...
    protected Dimension getSizeWithButtons(Insets i, Dimension size) {
        ...
        Dimension themeMinimumSize = JBUI.size(72, 0);
