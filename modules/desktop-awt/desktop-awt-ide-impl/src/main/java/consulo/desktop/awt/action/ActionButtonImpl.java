...
public class ActionButtonImpl extends JButton implements ActionButtonEx, Accessible {
  ...
  public boolean isEnabled() {
    return myPresentation != null && myPresentation.isEnabled();
  }
