        ...
        if (
            ...
            if (includedAttachments.size() == 1) {
                myAttachmentWarningLabel.setHtmlText(
                    DiagnosticLocalize.diagnosticErrorReportIncludeAttachmentWarning(includedAttachments.get(0).getName()).get()
                );
            }
            else {
                myAttachmentWarningLabel.setHtmlText(
                    DiagnosticLocalize.diagnosticErrorReportIncludeAttachmentsWarning(includedAttachments.size()).get()
                );
            }
        }
        else {
                ...
                if (StringUtil.isEmpty(vendor)) {
                    if (StringUtil.isEmpty(contactInfo)) {
                        ...
                        myForeignPluginWarningLabel.setHyperlinkText(
                            DiagnosticLocalize.errorDialogForeignPluginWarningTextVendor().get() + " ",
                            contactInfo,
                            "."
                        );
                    ...
                    myForeignPluginWarningLabel.setText(
                        DiagnosticLocalize.errorDialogForeignPluginWarningTextVendor().get() + " " + vendor + "."
                    );
                }
                else {
                    myForeignPluginWarningLabel.setHyperlinkText(
