...
import consulo.desktop.awt.uiOld.debugger.UiDebuggerExtension;
import consulo.desktop.awt.uiOld.debugger.extensions.UiScriptFileType;
...
public class PlaybackDebugger implements UiDebuggerExtension, PlaybackRunner.StatusCallback {
    ...
    private void initUi() {
        ...
        north.add(
            ActionManager.getInstance().createActionToolbar(ActionPlaces.UNKNOWN, controlGroup, true).getComponent(),
            BorderLayout.WEST
        );
