...
import consulo.desktop.awt.ui.plaf.darcula.DarculaComboBoxUI;
...
public class WinIntelliJComboBoxUI extends DarculaComboBoxUI {
  ...
  protected Rectangle rectangleForCurrentValue() {
    ...
    int buttonWidth = h;
    if (arrowButton != null) {
      buttonWidth = comboBox.getComponentOrientation().isLeftToRight() ? arrowButton.getWidth() - i.right : arrowButton.getWidth() - i.left;
    }
  ...
  public void paintCurrentValue(Graphics g, Rectangle bounds, boolean hasFocus) {
    @SuppressWarnings("unchecked") ListCellRenderer<Object> renderer = comboBox.getRenderer();
  ...
  public static Icon getArrowIcon(@Nonnull JComponent c) {
    return WinIconLookup.INSTANCE.getIcon("comboDropTriangle", false, false, c.isEnabled());
  }
  ...
  private boolean isHover() {
    return comboBox != null && comboBox.getClientProperty(HOVER_PROPERTY) == Boolean.TRUE || arrowButton != null && arrowButton.getClientProperty(HOVER_PROPERTY) == Boolean.TRUE;
  }
  ...
  private boolean isPressed() {
    return comboBox != null && comboBox.getClientProperty(PRESSED_PROPERTY) == Boolean.TRUE || arrowButton != null && arrowButton.getModel().isPressed();
  }
  ...
  protected ComboPopup createPopup() {
    if (comboBox.getClientProperty(DarculaJBPopupComboPopup.CLIENT_PROP) != null) {
      return new DarculaJBPopupComboPopup<>(comboBox) {
        @Override
        public void configureList(@Nonnull JList<Object> list) {
        ...
        public void customizeListRendererComponent(JComponent component) {
          ...
          component.setBorder(getList().getComponentOrientation().isLeftToRight() ? JBUI.Borders.empty(0, 5, 0, 1) : JBUI.Borders.empty(0, 1, 0, 5));
        }
      };
    }
    return new CustomComboPopup(comboBox) {
      ...
      protected void customizeListRendererComponent(JComponent component) {
        super.customizeListRendererComponent(component);
        component.setBorder(list.getComponentOrientation().isLeftToRight() ? JBUI.Borders.empty(0, 5, 0, 1) : JBUI.Borders.empty(0, 1, 0, 5));
      }
