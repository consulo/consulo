    ...
    public void handle(IdeaLoggingEvent event) {
        ...
        try {
            ...
            if (kind != null) {
                ...
                UIAccess uiAccess = application == null ? null : application.getLastUIAccess();
                if (uiAccess != null) {
                    uiAccess.give(() -> new OutOfMemoryDialog(kind).showAsync());
                }
            }
            ...
            if (message != null && message.contains("Could not initialize class MessagePool") || e instanceof NullPointerException && application == null) {
