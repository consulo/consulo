 ...
 */
@ExtensionImpl
public class DesktopRemoteDesktopServiceNotificationGroupContributor implements NotificationGroupContributor {
  @Override
  public void contribute(@Nonnull Consumer<NotificationGroup> registrator) {
    registrator.accept(DesktopRemoteDesktopDetector.NOTIFICATION_GROUP);
  }
}
