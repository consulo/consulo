...
public final class DefaultTreeUI extends BasicTreeUI {
  ...
  @Nullable
  private static Color getBackground(@Nonnull JTree tree, @Nonnull TreePath path, int row, boolean selected) {
    if (selected) {
  ...
  //@ApiStatus.Internal
  public static void setBackground(@Nonnull JTree tree, @Nonnull Component component, int row) {
  ...
  private static void setBackground(@Nonnull JTree tree, @Nonnull Component component, @Nullable Color background, boolean opaque) {
  ...
  private static boolean isSuspiciousRenderer(Component component) {
    if (component instanceof JComponent) {
      Method method = ReflectionUtil.getMethod(component.getClass(), "validate");
  ...
  private static boolean isLeadSelectionNeeded(@Nonnull JTree tree, int row) {
  ...
  protected boolean isToggleEvent(MouseEvent event) {
    ...
    JTree tree = getTree();
    return tree != null && EditSourceOnDoubleClickHandlerBase.isExpandPreferable(tree, tree.getSelectionPath());
  }
