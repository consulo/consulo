...
public class EditorComponentImpl extends JTextComponent
    ...
    public @Nullable InputMethodRequests getInputMethodRequests() {
        return IdeEventQueueProxy.getInstance().isInputMethodEnabled() ? myEditor.getInputMethodRequests() : null;
    }
    ...
    private class AccessibleEditorComponentImpl extends AccessibleJComponent
        implements AccessibleText, AccessibleEditableText, AccessibleExtendedText, CaretListener, DocumentListener {
        ...
        private @Nullable AccessibleTextSequence getSequenceAtIndex(
            ...
            switch (type) {
                case AccessibleText.CHARACTER:
                    ...
                    if (offset + direction < document.getTextLength() && offset + direction >= 0) {
                        int startOffset = offset + direction;
                        charSequence = new AccessibleTextSequence(
                            startOffset,
                            startOffset + 1,
