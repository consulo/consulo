...
import consulo.desktop.awt.ui.impl.tabs.Centerizer;
...
public class TabLabel extends JPanel implements consulo.ui.ex.awt.internal.TabInfoHolder {
    ...
    private void handlePopup(MouseEvent e) {
        ...
        JBTabsImpl tabs = (JBTabsImpl) DataManager.getInstance().getDataContext(e.getComponent(), e.getX(), e.getY()).getData(JBTabsImpl.NAVIGATION_ACTIONS_KEY);
    ...
    public void setTabActions(@Nullable ActionGroup group) {
        ...
        myActionPanel = new ActionPanel(myTabs, myInfo, this);
    ...
    public CompletableFuture<Boolean> updateTabActions(UIAccess uiAccess) {
        ...
        return myActionPanel.updateAsync(uiAccess);
    }
