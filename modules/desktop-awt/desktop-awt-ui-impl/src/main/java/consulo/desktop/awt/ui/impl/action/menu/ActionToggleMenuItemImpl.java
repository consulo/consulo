 ...
 */
package consulo.desktop.awt.ui.impl.action.menu;
 ...
 * @since 2024-11-24
 */
public class ActionToggleMenuItemImpl extends JCheckBoxMenuItem implements ActionMenuItem {
    private ActionMenuItemEngine myEngine;

    public ActionToggleMenuItemImpl(AnAction action,
