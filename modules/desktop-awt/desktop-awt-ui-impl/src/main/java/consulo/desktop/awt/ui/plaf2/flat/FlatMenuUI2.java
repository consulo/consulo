 ...
 * @since 2025-09-13
 */
public class FlatMenuUI2 extends FlatMenuUI {
    private class FlatMenuRenderer2 extends FlatMenuRenderer {
        protected FlatMenuRenderer2(JMenuItem menuItem, Icon checkIcon, Icon arrowIcon, Font acceleratorFont, String acceleratorDelimiter) {
    ...
    public static ComponentUI createUI(JComponent c) {
        return new FlatMenuUI2();
    }

    @Override
    protected FlatMenuItemRenderer createRenderer() {
        return new FlatMenuRenderer2(menuItem, checkIcon, arrowIcon, acceleratorFont, acceleratorDelimiter);
    }
}
