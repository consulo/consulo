 ...
 */
package consulo.desktop.awt.ui.impl.plaf;
...
public final class LafManagerImpl implements LafManager, Disposable, PersistentStateComponent<Element> {
    ...
    /**
     * Laf class names as they were persisted in old settings - these are stored strings, not live classes, so they
     * must keep the pre-repackage names even though the classes themselves are long gone.
     */
    private static final Map<String, String> ourOldMapping = Map.of(
