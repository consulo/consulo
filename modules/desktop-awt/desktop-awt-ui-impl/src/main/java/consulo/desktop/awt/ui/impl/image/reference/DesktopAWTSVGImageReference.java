...
public class DesktopAWTSVGImageReference extends DesktopAWTImageReference {
  ...
  public void draw(JBUI.ScaleContext ctx,
    ...
    try {
      // typed null: a bare null makes javac weigh the JComponent overload against the Component one, and
      // modelling those signatures trips over jsvg's requires-static org.jetbrains.annotations
      javax.swing.JComponent component = null;
      target.render(component, graphics, new ViewBox(x, y, width, height));
    }
    catch (Exception e) {
