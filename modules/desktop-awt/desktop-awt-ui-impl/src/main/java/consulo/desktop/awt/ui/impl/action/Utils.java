...
import consulo.desktop.awt.ui.impl.action.menu.ActionMenuItem;
import consulo.desktop.awt.ui.impl.action.menu.ActionMenuItemImpl;
import consulo.desktop.awt.ui.impl.action.menu.ActionToggleMenuItemImpl;
...
public class Utils {
    ...
    /**
     * Whether the given completion failure is a cancellation (e.g. the expansion was superseded or the popup dismissed)
     * rather than a real error. Cancellation is normal control flow and must not be logged as an error.
     */
    public static boolean isProcessCanceled(Throwable error) {
        Throwable cause = error instanceof CompletionException && error.getCause() != null ? error.getCause() : error;
        return cause instanceof ControlFlowException || cause instanceof CancellationException;
    }
