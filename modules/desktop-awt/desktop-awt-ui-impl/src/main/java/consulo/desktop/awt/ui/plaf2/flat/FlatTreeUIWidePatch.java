 ...
 */
@Deprecated
@DeprecationInfo("Remove after FlatLaf release")
public class FlatTreeUIWidePatch
    extends BasicTreeUI
    implements StyleableUI {
    private static final String TREE_WIDE_CELL_RENDERER = "Tree.wideCellRenderer";
     ...
     */
    @Styleable
    protected boolean wideCellRenderer;
    @Styleable
