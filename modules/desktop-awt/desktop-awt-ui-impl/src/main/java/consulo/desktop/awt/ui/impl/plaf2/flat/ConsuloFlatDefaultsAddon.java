...
import consulo.desktop.awt.ui.impl.tabs.laf.FlatEditorTabsUI;
import consulo.desktop.awt.ui.impl.plaf2.BasicStripeButtonUI;

import com.formdev.flatlaf.FlatDefaultsAddon;
import consulo.desktop.awt.ui.impl.plaf.BasicStatusBarUI;
...
public class ConsuloFlatDefaultsAddon extends FlatDefaultsAddon {
    ...
    public void afterDefaultsLoading(LookAndFeel laf, UIDefaults uiDefaults) {
        ...
        uiDefaults.put("ComboBoxActionButtonUI", FlatComboBoxActionButtonUI.class.getName());
        uiDefaults.put("CaptionPanelUI", FlatCaptionPanelUI.class.getName());

        uiDefaults.put("ComboBoxUI", FlatComboTailBoxUI.class.getName());
        uiDefaults.put("TextFieldUI", FlatTextFieldUI2.class.getName());
