...
public class ComponentConfig {
  ...
  public void prepareClasses() {
    if (StringUtilRt.isEmpty(interfaceClass)) {
  ...
  public void setHeadlessImplementationClass(String headlessImplementationClass) {
    ...
    this.headlessImplementationClass = headlessImplementationClass == null ? null : StringUtilRt.isEmpty(headlessImplementationClass) ? "" : headlessImplementationClass;
  }
}
