...
public abstract class BundleBase {
  ...
  public static String messageOrDefault(@Nullable final ResourceBundle bundle, @Nonnull String key, @Nullable final String defaultValue, @Nonnull Object... params) {
