 ...
 * @since 2018.1
 */
public final class JavaVersionRt implements Comparable<JavaVersionRt> {
    /**
     * The major version.
    ...
    private JavaVersionRt(int feature, int minor, int update, int build, boolean ea) {
    ...
    @Override
    public int compareTo(JavaVersionRt o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JavaVersionRt)) {
            return false;
        }
        JavaVersionRt other = (JavaVersionRt) o;
     ...
     */
    public static JavaVersionRt compose(int feature, int minor, int update, int build, boolean ea) throws IllegalArgumentException {
        if (feature < 0) {
        ...
        return new JavaVersionRt(feature, minor, update, build, ea);
    }

    public static JavaVersionRt compose(int feature) {
        return compose(feature, 0, 0, 0, false);
    }

    private static @Nullable JavaVersionRt current = null;
     ...
     */
    public static JavaVersionRt current() {
        if (current == null) {
    ...
    private static JavaVersionRt parseVersion() {
        JavaVersionRt version = JavaVersionRt.tryParse(System.getProperty("java.version"));

        if (version == null) {
            version = JavaVersionRt.tryParse(System.getProperty("java.runtime.version"));
        }
    ...
    private static JavaVersionRt rtVersion() {
        ...
        return new JavaVersionRt(feature, interim, update, build, ea);
    }
     ...
     */
    public static JavaVersionRt parse(String versionString) throws IllegalArgumentException {
     ...
     */
    public static @Nullable JavaVersionRt tryParse(@Nullable String versionString) {
