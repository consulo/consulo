 ...
 * @since 2019-02-17
 */
public abstract class WebTwoComponentSplitLayoutBase<V extends WebSplitLayoutVaadinBase<?>> extends UIComponentWithVaadinComponent<V> implements TwoComponentSplitLayout {
  @Override
