...
/**
 * The faces bundled in consulo-ide-impl, listed for the browser the way {@code DesktopAWTFontRegistry} lists
 * them for the awt toolkit - by hand rather than by scanning the directory, a scan would keep the classpath
 * resource handles open.
 *
 * @author VISTALL
 * @since 2026-08-01
 */
public class WebFontRegistry {
     ...
     * @param family    css family carrying the whole weight range of the typeface
    ...
    /**
     * The rules that make the listed faces resolvable by family name in the browser.
     */
    ...
    private static void appendFontFace(StringBuilder css, BundledFont font, String family, int weight) {
        css.append("@font-face{")
            ...
            .append("src:url(\"").append(FONT_PATH).append(font.fileName()).append("\") format(\"truetype\");")
            .append('}');
    }
}
