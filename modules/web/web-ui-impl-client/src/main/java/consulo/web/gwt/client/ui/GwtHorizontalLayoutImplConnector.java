 ...
 * @since 11-Sep-17
 */
@Connect(canonicalName = "consulo.ui.web.internal.layout.WebHorizontalLayoutImpl.Vaadin")
public class GwtHorizontalLayoutImplConnector extends GwtLayoutConnector {
  ...
  @Override
  public GwtHorizontalLayoutImpl getWidget() {
    return (GwtHorizontalLayoutImpl)super.getWidget();
  }
}
