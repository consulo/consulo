...
public class VContextMenu extends VMenuBar {
  ...
  protected VOverlay createOverlay() {
    ...
    for (VMenuBar current = this; current != null; current = current.getParentMenu()) {
  ...
  public boolean handleNavigation(int keycode, boolean ctrl, boolean shift) {
    ...
    if (keycode == getNavigationLeftKey() && (getParentMenu() == null || getParentMenu().getParentMenu() == null)) {
      // do not close parent menu by left key
      return true;
    }
    if (keycode == getNavigationRightKey() && getSelected() != null && getSelected().getSubMenu() == null) {
  ...
  protected VMenuBar getRoot() {
    ...
    while (root.getParentMenu() != null && root.getParentMenu().getParentMenu() != null) {
