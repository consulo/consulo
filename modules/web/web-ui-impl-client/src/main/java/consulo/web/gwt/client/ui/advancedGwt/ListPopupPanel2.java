...
public class ListPopupPanel2 extends VOverlay implements AdvancedWidget, HasChangeHandlers {
  ...
  /** registration of the {@link ListPopupPanel2.ClickSpyHandler} */
   ...
   */
  protected ListPopupPanel2(WidgetComboBox selectionTextBox) {
    super(false, false);
   ...
   */
  protected WidgetComboBox getComboBox() {
    return comboBox;
  }
   ...
   * according to new coordinates of the {@link org.gwt.advanced.client.ui.widget.ComboBox}.
   */
