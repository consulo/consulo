...
@Singleton
@ServiceImpl
public class DesktopQtEditorFactoryImpl extends EditorFactoryImpl {
    @Inject
    public DesktopQtEditorFactoryImpl(Application application, DocumentFactory documentFactory) {
    ...
    protected RealEditor createEditorImpl(Document document, boolean isViewer, Project project, EditorKind kind) {
        return new DesktopQtEditorImpl(document, isViewer, project, kind);
    }
}
