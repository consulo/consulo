 ...
 * @since 2026-08-16
 */
public class DesktopQtCodeEditorSoftWrapModelImpl extends CodeEditorSoftWrapModelBase {
    public DesktopQtCodeEditorSoftWrapModelImpl(CodeEditorBase editor, FontPreferencesManager fontPreferencesManager) {
