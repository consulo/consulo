...
public class TargetAWTFacadeStub implements TargetAWTFacade {
  ...
  public Component to(consulo.ui.@Nullable Component component) {
    return component == null ? null : DesktopQtAwtBridgeComponent.of(component);
  }
  ...
  public consulo.ui.@Nullable Component from(@Nullable Component component) {
    return component instanceof DesktopQtAwtBridgeComponent bridge ? bridge.getUIComponent() : null;
  }
