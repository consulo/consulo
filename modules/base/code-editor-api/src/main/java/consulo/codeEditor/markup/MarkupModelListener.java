...
public interface MarkupModelListener extends EventListener {
    ...
    default void afterAdded(RangeHighlighterEx highlighter) {
    }

    default void beforeRemoved(RangeHighlighterEx highlighter) {
    }
     ...
     */
    default void afterRemoved(RangeHighlighterEx highlighter) {
    }

    default void attributesChanged(RangeHighlighterEx highlighter,
