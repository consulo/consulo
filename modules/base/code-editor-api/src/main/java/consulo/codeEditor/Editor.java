...
public interface Editor extends UserDataHolder {
     ...
     * <p>
     * See also {@link DocumentMarkupModel.forDocument(Document, Project, boolean)}
     * {@link EditorEx#getFilteredDocumentMarkupModel()}.
     *
     ...
     */
    default void addEditorMouseListener(EditorMouseListener listener, Disposable parentDisposable) {
    ...
    default int visualPositionToOffset(VisualPosition pos) {
