...
public class ImaginaryEditor extends UserDataHolderBase implements Editor {
    ...
    // the following state is only populated by the create(Editor) factory; otherwise it stays null
    private @Nullable EditorColorsScheme myColorsScheme;
    private @Nullable EditorHighlighter myHighlighter;
    private @Nullable EditorSettings mySettings;
    private @Nullable ImaginaryFoldingModel myFoldingModel;

    private @Nullable JComponent myContentComponent;

    private @Nullable EditorKind myEditorKind;

    public ImaginaryEditor(@Nullable Project project, Document document) {
        myProject = project;
        myDocument = document;
