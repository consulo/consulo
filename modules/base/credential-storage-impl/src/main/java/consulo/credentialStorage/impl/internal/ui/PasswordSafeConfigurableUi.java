...
public class PasswordSafeConfigurableUi implements IdeaConfigurableUi<PasswordSafeSettings> {
    ...
    public void reset(PasswordSafeSettings settings) {
        ...
        myProviderGroup.setValue(settings.getProviderType());
    ...
    public JComponent getComponent(Disposable disposable) {
        ...
        gearActionGroup.addAll(
            new ClearKeePassDatabaseAction(),
    ...
    private void createAndSaveKeePassDatabaseWithNewOptions(PasswordSafeSettings settings) throws ConfigurationException {
        ...
        try {
            KeePassFileManager manager =
                new KeePassFileManager(newDbFile, KeePassCredentialStore.getDefaultMainPasswordFile(), getEncryptionSpec(), secureRandom);
            manager.useExisting();
        }
    ...
    private class ClearKeePassDatabaseAction extends LegacyDumbAwareAction {
    ...
    private class ChangeKeePassDatabaseMasterPasswordAction extends LegacyDumbAwareAction {
        public ChangeKeePassDatabaseMasterPasswordAction() {
            super(
                new MainKeyFileStorage(KeePassCredentialStore.getDefaultMainPasswordFile()).isAutoGenerated()
