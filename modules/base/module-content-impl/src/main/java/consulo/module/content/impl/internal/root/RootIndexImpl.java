...
public class RootIndexImpl implements RootIndex {
    ...
    private static class RootInfo {
        ...
        @Nonnull
        final SequencedSet<VirtualFile> classAndSourceRoots = new LinkedHashSet<>();
        ...
        @Nonnull
        private SequencedSet<OrderEntry> getLibraryOrderEntries(
            @Nonnull List<VirtualFile> hierarchy,
            ...
            SequencedSet<OrderEntry> orderEntries = new LinkedHashSet<>();
            for (VirtualFile root : hierarchy) {
