...
public abstract class DeprecatedMasterDetailsComponent implements Configurable, MasterDetails {
  protected static final Logger LOG = Logger.getInstance(DeprecatedMasterDetailsComponent.class);
...

  {
    TREE_UPDATER = new Runnable() {
      ...
      public void run() {
        ...
        fireItemsChangedExternally(DeprecatedMasterDetailsComponent.this);
      }
    };
  }
  ...
  protected DeprecatedMasterDetailsComponent() {
    this(new MasterDetailsState());
  }

  protected DeprecatedMasterDetailsComponent(MasterDetailsState state) {
    myState = state;
  ...
  protected void reInitWholePanelIfNeeded() {
    ...
    myWholePanel = new JPanel(new BorderLayout()) {
      ...
      public void addNotify() {
        super.addNotify();
        DeprecatedMasterDetailsComponent.this.addNotify();
