...
public abstract class DeprecatedNamedItemsListEditor<T> extends DeprecatedMasterDetailsComponent {
  ...
  protected DeprecatedNamedItemsListEditor(Namer<T> namer, Supplier<T> factory, Cloner<T> cloner, HashingStrategy<T> comparer, List<T> items) {
    this(namer, factory, cloner, comparer, items, true);
  }

  protected DeprecatedNamedItemsListEditor(Namer<T> namer, Supplier<T> factory, Cloner<T> cloner, HashingStrategy<T> comparer, List<T> items, boolean initInConstructor) {
    myNamer = namer;
    myFactory = factory;
    myCloner = cloner;
    myComparer = comparer;
  ...
  private class ItemConfigurable extends DeprecatedNamedConfigurable {
    ...
    public void setDisplayName(String name) {
      DeprecatedNamedItemsListEditor.this.setDisplayName(myItem, name);
    }
