...
public class ByChar {
    public static FairDiffIterable compare(CharSequence text1, CharSequence text2, ProgressIndicator indicator) {
    ...
    public static FairDiffIterable compareTwoStep(CharSequence text1, CharSequence text2, ProgressIndicator indicator) {
        indicator.checkCanceled();
    ...
    public static DiffIterable compareIgnoreWhitespaces(CharSequence text1, CharSequence text2, ProgressIndicator indicator) {
        indicator.checkCanceled();
     ...
     */
    public static FairDiffIterable comparePunctuation(CharSequence text1, CharSequence text2, ProgressIndicator indicator) {
        indicator.checkCanceled();
    ...
    private static FairDiffIterable transfer(
        CharOffsets chars1,
        CharOffsets chars2,
        CharSequence text1,
        CharSequence text2,
     ...
     */
    private static FairDiffIterable matchAdjustmentSpaces(
        CharOffsets chars1,
        CharOffsets chars2,
        CharSequence text1,
        CharSequence text2,
     ...
     */
    private static DiffIterable matchAdjustmentSpacesIW(
        CharOffsets chars1,
        CharOffsets chars2,
        CharSequence text1,
        CharSequence text2,
     ...
     */
    private static int expandForwardW(
        CharOffsets chars1,
        CharOffsets chars2,
        CharSequence text1,
        CharSequence text2,
    ...
    private static int[] getAllChars(CharSequence text) {
    ...
    private static CharOffsets getNonSpaceChars(CharSequence text) {
    ...
    private static CharOffsets getPunctuationChars(CharSequence text) {
        IntList chars = IntLists.newArrayList(text.length());
        IntList offsets = IntLists.newArrayList(text.length());
