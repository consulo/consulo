...
public interface DiffColors {
  ...
  EditorColorKey DIFF_SEPARATORS_BACKGROUND = EditorColorKey.createColorKey("DIFF_SEPARATORS_BACKGROUND");
  EditorColorKey DIFF_SEPARATORS_TOP_BORDER = EditorColorKey.createColorKey("DIFF_SEPARATORS_TOP_BORDER");
  EditorColorKey DIFF_SEPARATORS_BOTTOM_BORDER = EditorColorKey.createColorKey("DIFF_SEPARATORS_BOTTOM_BORDER");
}
