...
package consulo.vcs.rollback;

import consulo.vcs.FilePath;
import consulo.vcs.VcsException;
import consulo.vcs.VcsProviderMarker;
...
public interface RollbackEnvironment extends VcsProviderMarker {
   ...
   * {@link consulo.ide.impl.idea.openapi.vcs.changes.ChangelistBuilder#processLocallyDeletedFile}.
   *
   ...
   * You do not need to implement this method if you never report such files to
   * {@link consulo.ide.impl.idea.openapi.vcs.changes.ChangelistBuilder#processModifiedWithoutCheckout}.
   *
