 ...
 *
 * @see consulo.ide.impl.idea.openapi.vcs.update.UpdateEnvironment#fillGroups
 * @see consulo.ide.impl.idea.openapi.vcs.update.UpdateEnvironment#updateDirectories
 */
