...
public abstract class BaseRefactoringProcessor implements Runnable {
  ...
  protected void previewRefactoring(@Nonnull UsageInfo[] usages) {
    ...
    final PsiElementUsageTarget[] targets = PsiElementUsageTargetFactory.getInstance().create(elements);
  ...
  private void showUsageView(@Nonnull UsageViewDescriptor viewDescriptor, @Nonnull Supplier<UsageSearcher> factory, @Nonnull UsageInfo[] usageInfos) {
