 ...
 */
package consulo.language.editor.refactoring.changeSignature.inplace;
...
public class InplaceChangeSignature implements DocumentListener {
    ...
    public InplaceChangeSignature(Project project, Editor editor, @Nonnull PsiElement element) {
        ...
        try {
            ...
            OpenFileDescriptorFactory.getInstance(project).newBuilder(virtualFile).offset(method.getTextOffset()).build().navigate(true);
            return;
        }
