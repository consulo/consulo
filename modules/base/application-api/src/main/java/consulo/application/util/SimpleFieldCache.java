...
public abstract class SimpleFieldCache<T, Owner> extends FieldCache<T, Owner, Object, Object> {
  ...
  protected final T compute(Owner owner, @Nullable Object p) {
    return compute(owner);
  }

  protected final @Nullable T getValue(Owner owner, @Nullable Object p) {
    return getValue(owner);
  }

  protected final void putValue(@Nullable T t, Owner owner, @Nullable Object p) {
    putValue(t, owner);
  }
