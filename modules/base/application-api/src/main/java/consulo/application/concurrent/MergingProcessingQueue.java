 ...
 * @since 2023-09-15
 */
public abstract class MergingProcessingQueue<K, V, P extends ComponentManager> {
    private final ApplicationConcurrency myApplicationConcurrency;
    private final P myProject;
    ...
    public MergingProcessingQueue(ApplicationConcurrency applicationConcurrency, P project, int tickInMillis) {
