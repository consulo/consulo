...
public class ApplicationUtil {
  ...
  public static @Nullable <T> T tryRunReadAction(Supplier<T> computable) throws CannotRunReadActionException {
   ...
   */
  public static @Nullable <T> T runWithCheckCanceled(Callable<T> callable, ProgressIndicator indicator) throws Exception {
