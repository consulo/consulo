 ...
 * @since 2025-12-06
 */
public class AbsentLocalizeValue implements LocalizeValue {
    public static final AbsentLocalizeValue VALUE = new AbsentLocalizeValue();
    ...
    @Nonnull
    @Override
    public LocalizeValue or(LocalizeValue defaultValue) {
        return defaultValue;
    }
