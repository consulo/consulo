...
import consulo.localization.internal.ConstantLocalizedValue;
...
public final class ConstantLocalizeValue extends ConstantLocalizedValue implements LocalizeValue {
    ...
    public ConstantLocalizeValue(@Nonnull String value) {
        super(value);
    }
}
