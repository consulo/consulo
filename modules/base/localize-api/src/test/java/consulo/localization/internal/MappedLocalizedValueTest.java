...
public class MappedLocalizedValueTest {
    ...
    void testValue() {
        ...
        LocalizedValue value = new MappedLocalizedValue(myManager, subValue, (localizeManager, string) -> string + "bar");
    ...
    void testEqualsAndHashCode() {
        ...
        BiFunction<LocalizeManager, String, String> mapper1 = (localizeManager, string) -> string + "bar";
        BiFunction<LocalizeManager, String, String> mapper2 = (localizeManager, string) -> string + "baz";
