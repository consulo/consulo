...
public class ConstantLocalizedValueTest {
    ...
    @Test
    void testCompareTo() {
        ConstantLocalizedValue value1 = new ConstantLocalizedValue("Foo");
        ConstantLocalizedValue value2 = new ConstantLocalizedValue("Foo");
        ConstantLocalizedValue value3 = new ConstantLocalizedValue("foo");
        ConstantLocalizedValue value4 = new ConstantLocalizedValue("Bar");
        ...
        assertThat(value1.compareToIgnoreCase(value2)).isEqualTo(0);
        assertThat(value1.compareToIgnoreCase(value3)).isEqualTo(0);
        assertThat(value1.compareToIgnoreCase(value4)).isGreaterThan(0);
    }
}
