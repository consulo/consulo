 ...
 * @since 2023-09-15
 */
public abstract class MergingProcessingQueueInUI<K, V> {
  ...
  public MergingProcessingQueueInUI(ApplicationConcurrency applicationConcurrency, Project project, int tickInMillis) {
