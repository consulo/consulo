...
public class DefaultBuildDescriptor implements BuildDescriptor {
    ...
    private @Nullable BuildProcessHandler myProcessHandler = null;
    private @Nullable Consumer<? super ConsoleView> myAttachedConsoleConsumer = null;
    private @Nullable ExecutionEnvironment myExecutionEnvironment = null;
    private @Nullable Supplier<? extends RunContentDescriptor> myContentDescriptorSupplier = null;

    public DefaultBuildDescriptor(Object id, LocalizeValue title, String workingDir, long startTime) {
        myId = id;
        myTitle = title;
    ...
    public DefaultBuildDescriptor(BuildDescriptor descriptor) {
    ...
    public @Nullable Consumer<? super ConsoleView> getAttachedConsoleConsumer() {
    ...
    public DefaultBuildDescriptor withProcessHandler(
