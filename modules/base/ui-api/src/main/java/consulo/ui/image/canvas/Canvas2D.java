...
public interface Canvas2D {
     ...
     * This method may add rendering overhead and should be used with care.
     *
     ...
     *
     * @param value Width of the stroke. The value should be multiplied by the current scale.
     */
