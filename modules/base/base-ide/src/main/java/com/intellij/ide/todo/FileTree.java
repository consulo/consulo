...
final class FileTree {
  ...
  private static List<VirtualFile> collectDirsToRemove(VirtualFile psiDirectory, List<VirtualFile> children, List<VirtualFile> dirsToBeRemoved, VirtualFile _directory) {
