...
public abstract class Language extends UserDataHolderBase {
  ...
  protected Language(@Nonnull final String ID, @Nonnull final String... mimeTypes) {
    this(null, ID, mimeTypes);
  }

  protected Language(@Nullable Language baseLanguage, @Nonnull final String ID, @Nonnull final String... mimeTypes) {
