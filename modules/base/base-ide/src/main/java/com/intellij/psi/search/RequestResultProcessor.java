...
public abstract class RequestResultProcessor {
   ...
   */
  public abstract boolean processTextOccurrence(@Nonnull PsiElement element, int offsetInElement, @Nonnull Processor<? super PsiReference> consumer);
  ...
  public abstract static class BulkResultProcessor extends RequestResultProcessor {
     ...
     * @return whether the consumer has returned false for any of the references (and thus stopped searching), false otherwise.
     */
    public abstract boolean processTextOccurrences(@Nonnull PsiElement scope, int[] offsetsInScope, @Nonnull Processor<? super PsiReference> consumer);
  }
}
