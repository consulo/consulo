 ...
 */
@ExtensionImpl
public class BuiltInServerManagerNotificationGroupContributor implements NotificationGroupContributor {
  @Override
  public void contribute(@Nonnull Consumer<NotificationGroup> registrator) {
    registrator.accept(BuiltInServerManagerImpl.NOTIFICATION_GROUP);
  }
}
