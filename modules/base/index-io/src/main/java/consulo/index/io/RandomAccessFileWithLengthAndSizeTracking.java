...
class RandomAccessFileWithLengthAndSizeTracking extends RandomAccessFile {
  private static final Logger LOG = LoggerFactory.getLogger(RandomAccessFileWithLengthAndSizeTracking.class);
  // SystemProperties.getBooleanProperty("idea.do.random.access.wrapper.assertions", false);
  // we can't use consulo.application.impl.internal.PrivilegedAction here due util module
