 ...
 * @author traff
 */
public class ProcessBackedConsoleExecuteActionHandler extends BaseConsoleExecuteActionHandler implements Predicate<LanguageConsoleView> {
  ...
  @Override
  public boolean test(LanguageConsoleView console) {
