...
public abstract class RuntimeConfigurationProducer implements Comparable<RuntimeConfigurationProducer>, Cloneable {
    public static final ExtensionPointName<RuntimeConfigurationProducer> RUNTIME_CONFIGURATION_PRODUCER =
        ExtensionPointName.create(RuntimeConfigurationProducer.class);
    ...
    private static class ProducerComparator implements Comparator<RuntimeConfigurationProducer> {
        ...
        public int compare(final RuntimeConfigurationProducer producer1, final RuntimeConfigurationProducer producer2) {
            ...
            if (doesContain(psiElement2, psiElement1)) {
                return PREFERED;
            }
    ...
    /**
     * @deprecated feel free to pass your configuration to SMTRunnerConsoleProperties directly
     * instead of wrapping in DelegatingRuntimeConfiguration
     */
