 ...
 */
package consulo.module.creation.internal;
 ...
 * @since 05.06.14
 */
@ExtensionImpl(id = "empty", order = "last")
public class EmptyNewModuleBuilder implements NewModuleBuilder {
    @Override
    public void setupContext(NewModuleContext context) {
        context.add(LocalizeValue.localizeTODO("Empty"), AllIcons.FileTypes.Any_type, NewModuleWizardContextBase::new);
    }
}
