...
public class ArtifactUtil {
  ...
  public static void copyChildren(CompositePackagingElement<?> oldParent, CompositePackagingElement<?> newParent, @Nonnull Project project) {
  ...
  public static <E extends PackagingElement<?>> boolean processPackagingElements(final PackagingElement<?> rootElement,
    ...
    return processElementRecursively(rootElement, type, processor, resolvingContext, processSubstitutions, artifactType, PackagingElementPath.EMPTY, new HashSet<PackagingElement<?>>());
  }
  ...
  public static void processRecursivelySkippingIncludedArtifacts(Artifact artifact, final Processor<PackagingElement<?>> processor, PackagingElementResolvingContext context) {
  ...
  @Nullable
  private static String getRelativePathInSources(@Nonnull VirtualFile file, final @Nonnull ModuleOutputPackagingElement moduleElement, @Nonnull PackagingElementResolvingContext context) {
  ...
  public static List<VirtualFile> findSourceFilesByOutputPath(CompositePackagingElement<?> parent,
    ...
    processElementsWithSubstitutions(parent.getChildren(), context, artifactType, PackagingElementPath.EMPTY, new PackagingElementProcessor<PackagingElement<?>>() {
      @Override
      public boolean process(@Nonnull PackagingElement<?> element, @Nonnull PackagingElementPath elementPath) {
  ...
  public static boolean processParents(@Nonnull Artifact artifact, @Nonnull PackagingElementResolvingContext context, @Nonnull ParentElementProcessor processor, int maxLevel) {
    return processParents(artifact, context, processor, FList.<Pair<Artifact, CompositePackagingElement<?>>>emptyList(), maxLevel, new HashSet<Artifact>());
  }
  ...
  public static void removeChildrenRecursively(@Nonnull CompositePackagingElement<?> element, @Nonnull Condition<PackagingElement<?>> condition) {
    List<PackagingElement<?>> toRemove = new ArrayList<PackagingElement<?>>();
  ...
  public static Set<Module> getModulesIncludedInArtifacts(final @Nonnull Collection<? extends Artifact> artifacts, final @Nonnull Project project) {
