...
/**
 * Application read-write lock based on {@link StampedLock} for non-AWT platforms.
 * <p>
 ...
 * <p>
 * Write-intent methods are aliased to plain write lock — non-AWT platforms have no separate
 * "write thread" stage, so {@code writeIntentLock} == {@code writeLock}.
 *
 * @author VISTALL
 * @since 2025-03-10
 */
