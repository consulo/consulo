 ...
 * @author Sara Swanson
 * @see javax.swing.text.html.HRuleView
 */
public class ColoredHRuleView extends View {
  ...
  private Color color = JBColor.black;
  private Color shadowColor = JBColor.lightGray;
   ...
   */
  public ColoredHRuleView(Element elem) {
    super(elem);
  ...
  protected void setPropertiesFromAttributes() {
    ...
    if (attr != null) {
      ...
      Object color = attr.getAttribute(CSS.getAttribute("color"));
      if (color != null) {
        String hex = color.toString();

        this.color = ColorUtil.fromHex(hex, JBColor.BLACK);
      }
  ...
  public void paint(Graphics g, Shape a) {
    ...
    if (noshade != null) {
      ...
      Color bottom = shadowColor, top = color;
