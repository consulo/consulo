...
public interface ChooseByNameInScopeItemProvider extends ChooseByNameWeightedItemProvider {
   ...
   */
  boolean filterElements(@Nonnull ChooseByNameBase base, @Nonnull FindSymbolParameters parameters, @Nonnull ProgressIndicator indicator, @Nonnull Processor<Object> consumer);
   ...
   */
  boolean filterElementsWithWeights(@Nonnull ChooseByNameBase base,
