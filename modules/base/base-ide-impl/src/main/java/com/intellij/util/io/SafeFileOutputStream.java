...
public class SafeFileOutputStream extends OutputStream {
  ...
  public SafeFileOutputStream(@Nonnull File target) {
    this(target.toPath(), DEFAULT_BACKUP_EXT);
  }

  public SafeFileOutputStream(@Nonnull File target, @Nonnull String backupExt) {
    this(target.toPath(), backupExt);
  }

  public SafeFileOutputStream(@Nonnull Path target) {
  ...
  private
  @Nullable
  Path waitForBackup() throws IOException {
