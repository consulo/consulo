...
class TypoTolerantMatcher extends MinusculeMatcher {
  ...
  @Nonnull
  private static FList<TextRange> prependRange(@Nonnull FList<TextRange> ranges, @Nonnull Range range) {
  ...
  private class Session {
     ...
     */
    @Nullable
    private FList<TextRange> matchWildcards(int patternIndex, int nameIndex, @Nonnull ErrorState errorState) {
      if (nameIndex < 0) {
        return null;
      }
     ...
     */
    @Nullable
    private FList<TextRange> matchSkippingWords(int patternIndex, int nameIndex, boolean allowSpecialChars, @Nonnull ErrorState errorState) {
    ...
    @Nullable
    private FList<TextRange> matchFragment(int patternIndex, int nameIndex, @Nonnull ErrorState errorState) {
    ...
    @Nullable
    private FList<TextRange> matchInsideFragment(int patternIndex, int nameIndex, @Nonnull Fragment fragment) {
    ...
    @Nullable
    private FList<TextRange> findLongestMatchingPrefix(int patternIndex, int nameIndex, int fragmentLength, int minFragment, @Nonnull ErrorState errorState) {
     ...
     */
    @Nullable
    private FList<TextRange> improveCamelHumps(int patternIndex, int nameIndex, int maxFragment, int minFragment, @Nonnull ErrorState errorState) {
