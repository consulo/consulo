...
public class VerticalFlowLayout implements Serializable, LayoutManager {
  ...
  public String toString() {
    ...
    return getClass().getSimpleName() + "[hgap=" + hGap + ",vgap=" + vGap + ",myVerticalFill=" + myVerticalFill + ",myHorizontalFill=" + myHorizontalFill + str + "]";
  }
}
