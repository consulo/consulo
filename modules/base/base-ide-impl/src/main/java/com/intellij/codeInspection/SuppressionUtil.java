...
public class SuppressionUtil {
  ...
  public static void replaceSuppressionComment(@Nonnull PsiElement comment, @Nonnull String id,
                                               boolean replaceOtherSuppressionIds, @Nonnull Language commentLanguage) {
