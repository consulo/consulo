...
public abstract class CustomFoldingBuilder extends FoldingBuilderEx implements PossiblyDumbAware {
   ...
   */
  @RequiredReadAction
  protected abstract void buildLanguageFoldRegions(@Nonnull List<FoldingDescriptor> descriptors, @Nonnull PsiElement root, @Nonnull Document document, boolean quick);

  @RequiredReadAction
  private void addCustomFoldingRegionsRecursively(@Nonnull FoldingStack foldingStack, @Nonnull ASTNode node, @Nonnull List<FoldingDescriptor> descriptors, int currDepth) {
