 ...
 */
package consulo.exection.impl.internal;
 ...
 */
@ExtensionImpl
public class ExecutionNotificationGroupContributor implements NotificationGroupContributor {
  @Override
  public void contribute(@Nonnull Consumer<NotificationGroup> registrator) {
    registrator.accept(ExecutionNotificationGroupHolder.EXECUTION_GROUP);
  }
}
