...
final class ServiceModel implements Disposable, InvokerSupplier {
  ...
  static final TreeTraversal NOT_LOADED_LAST_BFS = new TreeTraversal("NOT_LOADED_LAST_BFS") {
    @Nonnull
    @Override
    public <T> It<T> createIterator(@Nonnull Iterable<? extends T> roots,
  ...
  private JBIterable<ServiceViewItem> doFindItems(Predicate<? super ServiceViewItem> visitChildrenCondition,
                                                  Predicate<? super ServiceViewItem> condition,
                                                  boolean safe) {
    return JBTreeTraverser.from((Function<ServiceViewItem, List<ServiceViewItem>>)node ->
                            visitChildrenCondition.test(node) ? new ArrayList<>(node.getChildren()) : null)
                          .withRoots(myRoots)
  ...
  static final class ServiceNode extends ServiceViewItem {
    ...
    ServiceNode(@Nonnull Object service, @Nullable ServiceViewItem parent, @Nonnull ServiceViewContributor<?> contributor,
                @Nonnull ServiceViewDescriptor viewDescriptor,
                @Nonnull Project project, @Nullable ServiceViewContributor<?> providingContributor) {
  ...
  static final class ServiceGroupNode extends ServiceViewItem {
    ServiceGroupNode(@Nonnull Object group, @Nullable ServiceViewItem parent, @Nonnull ServiceViewContributor<?> contributor,
                     @Nonnull ServiceViewDescriptor viewDescriptor) {
