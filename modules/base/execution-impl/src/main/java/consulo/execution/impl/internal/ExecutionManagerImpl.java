    ...
    startRunnable = () -> {
      ...
      Consumer<Throwable> errorHandler = e -> {
        if (!(e instanceof ProcessCanceledException)) {
          ExecutionException error = e instanceof ExecutionException
            ? (ExecutionException)e : new ExecutionException(e);
                ...
                if (terminated) {
                  ...
                  listener.processTerminated(new ProcessEvent(
                    ...
                    processHandler.isStartNotified()
                      ? ObjectUtil.notNull(processHandler.getExitCode(), -1) : -1
                  ));
                }
              }
            }
