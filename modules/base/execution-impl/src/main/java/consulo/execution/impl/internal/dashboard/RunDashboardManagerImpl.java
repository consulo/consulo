...
//    }, myProject);
  ...
  private void initServiceContentListeners() {
    ...
    connection.subscribe(ExecutionListener.class, new ExecutionListener() {
      ...
      @Override
      public void processTerminated(@Nonnull String executorId,
  ...
  static @Nonnull List<RunDashboardCustomizer> getCustomizers(@Nonnull RunnerAndConfigurationSettings settings,
  ...
  private static final class RunDashboardServiceImpl implements RunDashboardService {
    ...
    RunDashboardServiceImpl(@Nonnull RunnerAndConfigurationSettings settings,
