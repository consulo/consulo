...
/**
 * Builds the console of whichever frontend is drawing, so nothing outside has to know which one that is.
 *
 * @author VISTALL
 * @since 2026-09-23
 */
...
public interface ConsoleViewFactory {
    static ConsoleViewFactory getInstance() {
        return Application.get().getInstance(ConsoleViewFactory.class);
    }
