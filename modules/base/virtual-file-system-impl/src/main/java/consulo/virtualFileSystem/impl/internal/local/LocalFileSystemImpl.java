...
public final class LocalFileSystemImpl extends LocalFileSystemBase implements RefreshableFileSystem, VirtualFilePointerCapableFileSystem, Disposable {
    ...
    public LocalFileSystemImpl(@Nonnull Application application,
        ...
        myWatcherFuture = applicationConcurrency.getScheduledExecutorService().scheduleWithFixedDelay(() -> {
