...
public class FileInfo {
  ...
  public FileAttributes toFileAttributes() {
    ...
    final boolean isDirectory = BitUtil.isSet(attributes, FILE_ATTRIBUTE_DIRECTORY);
    final boolean isSpecial = BitUtil.isSet(attributes, FILE_ATTRIBUTE_DEVICE);
    final boolean isSymlink = BitUtil.isSet(attributes, FILE_ATTRIBUTE_REPARSE_POINT);
    final boolean isHidden = BitUtil.isSet(attributes, FILE_ATTRIBUTE_HIDDEN);
    final boolean isWritable = !BitUtil.isSet(attributes, FILE_ATTRIBUTE_READONLY);
