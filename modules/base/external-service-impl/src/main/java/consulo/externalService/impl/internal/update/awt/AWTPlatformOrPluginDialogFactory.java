...
import consulo.externalService.impl.internal.update.PlatformOrPluginDialogFactory;
...
public class AWTPlatformOrPluginDialogFactory implements PlatformOrPluginDialogFactory {
    @Override
    @RequiredUIAccess
    public void showAsync(
        ...
        new PlatformOrPluginDialog(project, updateResult, greenStrategy, afterCallback, modalProgress).showAsync();
    }
}
