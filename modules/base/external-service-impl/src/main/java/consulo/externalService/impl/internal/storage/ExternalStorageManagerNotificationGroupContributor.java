 ...
 */
@ExtensionImpl
public class ExternalStorageManagerNotificationGroupContributor implements NotificationGroupContributor {
  @Override
  public void contribute(@Nonnull Consumer<NotificationGroup> registrator) {
    registrator.accept(ExternalStorageManager.GROUP);
  }
}
