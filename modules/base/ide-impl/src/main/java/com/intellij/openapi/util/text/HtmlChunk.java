...
public abstract class HtmlChunk {
  ...
  public static class Element extends HtmlChunk {
    ...
    public
    @Nonnull
    Element style(@NonNls String style) {
    ...
    public
    @Nonnull
    Element addText(@Nonnull @Nls String text) {
    ...
    public
    @Nonnull
    Element addRaw(@Nonnull @Nls String text) {
    ...
    public
    @Nonnull
    Element children(@Nonnull HtmlChunk... chunks) {
      if (myChildren.isEmpty()) {
    ...
    public
    @Nonnull
    Element children(@Nonnull List<HtmlChunk> chunks) {
      if (myChildren.isEmpty()) {
    ...
    public
    @Nonnull
    Element child(@Nonnull HtmlChunk chunk) {
      if (myChildren.isEmpty()) {
  ...
  public
  @Nonnull
  Element wrapWith(@Nonnull @NonNls String tagName) {
  ...
  public
  @Nonnull
  Element wrapWith(@Nonnull Element element) {
  ...
  public static
  @Nonnull
  Element tag(@Nonnull @NonNls String tagName) {
  ...
  public static
  @Nonnull
  Element div(@Nonnull @NonNls String style) {
  ...
  public static
  @Nonnull
  Element span(@NonNls @Nonnull String style) {
  ...
  public static
  @Nonnull
  Element styleTag(@NonNls @Nonnull String style) {
    return tag("style").addRaw(style); //NON-NLS
  }

  public static
  @Nonnull
  Element font(@NonNls @Nonnull String color) {
  ...
  public static
  @Nonnull
  HtmlChunk text(@Nonnull @Nls String text) {
  ...
  public static
  @Nonnull
  HtmlChunk raw(@Nonnull @Nls String rawHtml) {
  ...
  public static
  @Nonnull
  Element link(@Nonnull @NonNls String target, @Nonnull @Nls String text) {
  ...
  public static
  @Nonnull
  HtmlChunk htmlEntity(@Nonnull String htmlEntity) {
  ...
  public static
  @Nonnull
  Collector<HtmlChunk, ?, HtmlChunk> toFragment() {
  ...
  public static
  @Nonnull
  Collector<HtmlChunk, ?, HtmlChunk> toFragment(HtmlChunk separator) {
