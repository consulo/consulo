...
public final class FileBasedIndexImpl extends FileBasedIndex {
  ...
  // caller is responsible to ensure no concurrent same document processing
  void processRefreshedFile(@Nullable Project project, @Nonnull final com.intellij.ide.caches.FileContent fileContent) {
  ...
  private boolean doIndexFileContent(@Nullable Project project, @Nonnull final com.intellij.ide.caches.FileContent content) {
