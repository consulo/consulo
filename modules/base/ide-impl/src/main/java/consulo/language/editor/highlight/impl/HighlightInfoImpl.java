...
package consulo.language.editor.highlight.impl;
...
public class HighlightInfoImpl implements HighlightInfo {
  ...
  protected HighlightInfoImpl(@Nullable TextAttributes forcedTextAttributes,
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof HighlightInfoImpl)) return false;
  ...
  @Nonnull
  static HighlightInfoImpl fromAnnotation(@Nonnull Annotation annotation, boolean batchMode) {
  ...
  public static class IntentionActionDescriptor {
    ...
    IntentionActionDescriptor(@Nonnull IntentionAction action, @Nullable List<IntentionAction> options, @Nullable String displayName, @Nullable Image icon) {
