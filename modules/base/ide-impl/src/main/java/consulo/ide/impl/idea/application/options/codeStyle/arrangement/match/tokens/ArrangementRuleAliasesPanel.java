...
import consulo.ide.impl.idea.application.options.codeStyle.arrangement.util.TitleWithToolbar;
...
public class ArrangementRuleAliasesPanel extends JPanel implements DataProvider {
  ...
  public ArrangementRuleAliasesPanel(@Nonnull ArrangementStandardSettingsManagerImpl settingsManager,
