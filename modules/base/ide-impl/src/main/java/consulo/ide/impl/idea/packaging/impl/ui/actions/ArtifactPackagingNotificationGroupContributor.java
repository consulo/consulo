 ...
 */
@ExtensionImpl
public class ArtifactPackagingNotificationGroupContributor implements NotificationGroupContributor {
  @Override
  public void contribute(@Nonnull Consumer<NotificationGroup> registrator) {
    registrator.accept(PackageFileWorker.ARTIFACT_PACKAGING_GROUP);
  }
}
