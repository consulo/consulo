 ...
 * @author max
 *
 * @see consulo.ide.impl.idea.openapi.vcs.changes.ChangeListManager#addChangeListListener(ChangeListListener)
 * @see consulo.ide.impl.idea.openapi.vcs.changes.ChangeListManager#removeChangeListListener(ChangeListListener)
 */
