...
public class GithubTagInfo {
    ...
    public boolean equals(@Nullable Object o) {
        ...
        GithubTagInfo that = (GithubTagInfo) o;
        return myName.equals(that.myName) && myZipballUrl.equals(that.myZipballUrl);
    }

    @Override
    public int hashCode() {
        return 31 * myName.hashCode() + myZipballUrl.hashCode();
    }
    ...
    public static class Version implements Comparable<Version> {
        ...
        public Version(IntList intComponents, String label, int labelVersion) {
