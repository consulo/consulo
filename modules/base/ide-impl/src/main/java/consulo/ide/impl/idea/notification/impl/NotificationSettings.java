...
public final class NotificationSettings {
    ...
    public boolean equals(@Nullable Object o) {
        ...
        return o instanceof NotificationSettings that
            && myShouldLog == that.myShouldLog
            && myShouldReadAloud == that.myShouldReadAloud
            && myDisplayType == that.myDisplayType
    ...
    public int hashCode() {
        ...
        result = 31 * result + Boolean.hashCode(myShouldLog);
        result = 31 * result + Boolean.hashCode(myShouldReadAloud);
        return result;
    }
}
