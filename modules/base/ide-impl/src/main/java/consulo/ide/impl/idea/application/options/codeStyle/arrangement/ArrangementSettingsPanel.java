 ...
 */
package consulo.ide.impl.idea.application.options.codeStyle.arrangement;

import consulo.ide.impl.idea.application.options.CodeStyleAbstractPanel;
import consulo.ide.impl.idea.application.options.codeStyle.arrangement.additional.ForceArrangementPanel;
import consulo.language.codeStyle.arrangement.ArrangementColorsProvider;
import consulo.ide.impl.idea.application.options.codeStyle.arrangement.color.ArrangementColorsProviderImpl;
import consulo.ide.impl.idea.application.options.codeStyle.arrangement.group.ArrangementGroupingRulesPanel;
import consulo.ide.impl.idea.application.options.codeStyle.arrangement.match.ArrangementMatchingRulesPanel;
