...
public class ImplementationViewComponentImpl extends JPanel implements ImplementationViewComponent {
    ...
    @RequiredUIAccess
    public ImplementationViewComponentImpl(PsiElement[] elements, int index) {
