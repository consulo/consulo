...
public class AWTConsoleViewFactory implements ConsoleViewFactory {
    @Override
    public ConsoleView createConsoleView(
        ...
        return new ConsoleViewImpl(project, searchScope, viewer, initialState, usePredefinedMessageFilter);
    }
}
