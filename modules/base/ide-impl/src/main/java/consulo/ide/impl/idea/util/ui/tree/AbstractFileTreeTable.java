...
public abstract class AbstractFileTreeTable<T> extends TreeTable {
    ...
    public AbstractFileTreeTable(
        ...
        DefaultTreeExpander treeExpander = new DefaultTreeExpander(getTree());
        ...
        getTree().setCellRenderer(new DefaultTreeCellRenderer() {
            ...
            public Component getTreeCellRendererComponent(
                ...
                if (value instanceof ProjectRootNode) {
                    ...
                    setIcon(TargetAWT.to(PlatformIconGroup.nodesProject()));
                    return this;
                }
                ...
                consulo.ui.image.Image icon = file.isDirectory() ? PlatformIconGroup.nodesTreeclosed() : VfsIconUtil.getIcon(file, 0, null);
    ...
    @RequiredUIAccess
    public boolean clearSubdirectoriesOnDemandOrCancel(VirtualFile parent, String message, String title) {
    ...
    public void reset(@Nonnull Map<VirtualFile, T> mappings) {
        ...
        TreeNode root = (TreeNode) myModel.getRoot();
    ...
    public void select(@Nullable VirtualFile toSelect) {
        if (toSelect != null) {
            select(toSelect, (TreeNode) myModel.getRoot());
        }
    }

    private void select(@Nonnull VirtualFile toSelect, TreeNode root) {
    ...
    private static class MyModel<T> extends DefaultTreeModel implements TreeTableModel {
        ...
        public Object getValueAt(Object node, int column) {
            ...
            return switch (column) {
                case 0 -> file;
                case 1 -> myCurrentMapping.get(file);
                default -> throw new RuntimeException("invalid column " + column);
            };
        }
        ...
        public boolean isCellEditable(Object node, int column) {
            return switch (column) {
                ...
                case 1 -> {
                    Object userObject = ((DefaultMutableTreeNode) node).getUserObject();
                    yield !(userObject instanceof VirtualFile || userObject == null)
    ...
    public static class ProjectRootNode extends ConvenientNode<Project> {
        ...
        @Override
        protected void appendChildrenTo(@Nonnull Collection<ConvenientNode> children) {
    ...
    public abstract static class ConvenientNode<T> extends DefaultMutableTreeNode {
        ...
        private void init() {
            if (getUserObject() == null) {
                ...
                List<ConvenientNode> children = new ArrayList<>();
    ...
    public static class FileNode extends ConvenientNode<VirtualFile> {
        ...
        public FileNode(@Nonnull VirtualFile file, @Nonnull Project project) {
            this(file, project, VirtualFileFilter.ALL);
        }

        public FileNode(@Nonnull VirtualFile file, @Nonnull Project project, @Nonnull VirtualFileFilter filter) {
            super(file);
            myProject = project;
            myFilter = filter;
        }
