...
public class FreezeLoggerImpl extends FreezeLogger {
  ...
  public void runUnderPerformanceMonitor(@Nullable ComponentManager project, Runnable action) {
    ...
    ModalityState initial = ModalityState.nonModal();
  ...
  private static void dumpThreads(@Nullable ComponentManager project, ModalityState initialState) {
    ...
    ApplicationManager.getApplication().invokeLater(() -> {
      if (!initialState.equals(ModalityState.nonModal())) return;
