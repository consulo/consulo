...
@Singleton
@ServiceImpl
public class ApplicationExecutionSettingsImpl implements ApplicationExecutionSettings {
  private final GeneralSettings myGeneralSettings;

  @Inject
  public ApplicationExecutionSettingsImpl(GeneralSettings generalSettings) {
  ...
  public void setProcessCloseConfirmation(ProcessCloseConfirmation processCloseConfirmation) {
    myGeneralSettings.setProcessCloseConfirmation(processCloseConfirmation);
  }
}
