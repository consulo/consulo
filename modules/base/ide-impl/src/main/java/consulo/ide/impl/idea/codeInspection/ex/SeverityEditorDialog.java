...
public class SeverityEditorDialog extends DialogWrapper {
    ...
    public SeverityEditorDialog(Project project, HighlightSeverity severity, SeverityRegistrarImpl severityRegistrar) {
        ...
        disabled.add(
            button,
            new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, JBUI.emptyInsets(), 0, 0)
        );
    ...
    private void editColorsAndFonts() {
        ...
        if (optionsEditor != null) {
            ...
            SearchableConfigurable javaPage = colorAndFontOptions.findSubConfigurable(GeneralColorsPage.class);
            LOG.assertTrue(javaPage != null);
            ShowSettingsUtil.getInstance().editConfigurable(dataContext.getData(Project.KEY), javaPage)
    ...
    private void fillList(HighlightSeverity severity) {
        ...
        Collections.sort(
            ...
            (attributes1, attributes2) ->
                -mySeverityRegistrar.compare(attributes1.getSeverity(), attributes2.getSeverity())
        );
    ...
    private void apply(SeverityBasedTextAttributes info) {
        MyTextAttributesDescription description = new MyTextAttributesDescription(
            LocalizeValue.of(info.getType().toString()),
            LocalizeValue.empty(),
            new TextAttributes(),
    ...
    protected void doOKAction() {
        ...
        Collection<SeverityBasedTextAttributes> infoTypes =
