...
public class SelectTemplateDialog extends DialogWrapper {
    private JComboBox<FileTemplate> myCbxTemplates;
    ...
    public SelectTemplateDialog(Project project, PsiDirectory directory) {
        ...
        myProject = project;
        setTitle(IdeLocalize.titleSelectTemplate());
        init();
    }
    ...
    protected JComponent createCenterPanel() {
        ...
        JLabel selectTemplateLabel = new JLabel(IdeLocalize.labelName().get());

        centerPanel.add(
            selectTemplateLabel,
            new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0)
        );
        centerPanel.add(
            myCbxTemplates,
        ...
        centerPanel.add(
            editTemplatesButton,
            new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0)
        );
    ...
    private void loadCombo() {
        DefaultComboBoxModel<FileTemplate> model = new DefaultComboBoxModel<>();
