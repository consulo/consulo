...
class ScopeColorsPageFactory implements ColorAndFontPanelFactory, ConfigurableWeight {
    ...
    private static JPanel createChooseScopePanel() {
        ...
        Project contextProject = DataManager.getInstance().getDataContext().getData(Project.KEY);
        Project project = contextProject != null ? contextProject : projects[0];
        ...
        button.addActionListener(e -> {
            Settings optionsEditor = DataManager.getInstance().getDataContext().getData(Settings.KEY);
