...
public class LibraryProjectStructureElement extends ProjectStructureElement {
    ...
    private Library getSourceOrThis() {
        ...
        Library realLibrary =
            invocationHandler instanceof ModuleEditor.ProxyDelegateAccessor accessor ? (Library) accessor.getDelegate() : myLibrary;
        Library source = realLibrary instanceof LibraryImpl libImpl ? libImpl.getSource() : null;
