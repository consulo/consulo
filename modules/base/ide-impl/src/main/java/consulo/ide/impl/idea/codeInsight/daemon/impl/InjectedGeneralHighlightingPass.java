...
public class InjectedGeneralHighlightingPass extends GeneralHighlightingPass {
    ...
    @Nonnull
    @RequiredReadAction
    private Set<PsiFile> getInjectedPsiFiles(@Nonnull List<? extends PsiElement> elements1, @Nonnull List<? extends PsiElement> elements2, @Nonnull ProgressIndicator progress) {
    ...
    private boolean addInjectedPsiHighlights(@Nonnull Set<? extends PsiFile> injectedFiles, @Nonnull ProgressIndicator progress, @Nonnull Collection<? super HighlightInfo> outInfos) {
                ...
                for (consulo.util.lang.Pair<IntentionActionDescriptor, TextRange> pair : info.quickFixActionRanges) {
                    ...
                    for (TextRange editableRange : editableQF) {
                        ...
                        if (patched.quickFixActionRanges == null) {
                            patched.quickFixActionRanges = new ArrayList<>();
                        }
    ...
    private void highlightInjectedSyntax(@Nonnull InjectedLanguageManagerInternal injectedLanguageManager,
                                         @Nonnull PsiFile injectedPsi,
