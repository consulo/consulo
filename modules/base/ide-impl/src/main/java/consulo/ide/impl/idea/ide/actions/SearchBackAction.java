...
@ActionImpl(id = "FindPrevious")
public class SearchBackAction extends LegacyDumbAwareAction {
    public SearchBackAction() {
        super(ActionLocalize.actionFindpreviousText(), ActionLocalize.actionFindpreviousDescription());
