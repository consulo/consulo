            ...
            AnAction action = new DumbAwareAction(charset.displayName(), null, Image.empty(Image.DEFAULT_ICON_SIZE)) {
                ...
                public void update(@Nonnull AnActionEvent e) {
                    ...
                    if (virtualFile == null || virtualFile.isDirectory()) {
                        ...
                        NotNullLazyValue<CharSequence> myText =
                            VolatileNotNullLazyValue.createValue(() -> LoadTextUtil.loadText(virtualFile));
                        ...
                        defer = IconDeferrer.getInstance().defer(
                            null,
                            Pair.create(virtualFile, charset),
                            pair -> {
                                ...
                                return safeToReload == EncodingUtil.Magic8.ABSOLUTELY || safeToConvert == EncodingUtil.Magic8.ABSOLUTELY
                                    ? null
                                    : safeToReload == EncodingUtil.Magic8.WELL_IF_YOU_INSIST
                                    || safeToConvert == EncodingUtil.Magic8.WELL_IF_YOU_INSIST
