...
import consulo.ide.impl.idea.openapi.roots.ui.configuration.artifacts.actions.ArtifactEditorFindUsagesActionBase;
import consulo.ide.impl.idea.openapi.roots.ui.configuration.artifacts.nodes.ArtifactsTreeNode;
import consulo.ide.impl.idea.openapi.roots.ui.configuration.artifacts.sourceItems.SourceItemNode;
...
public class SourceItemFindUsagesAction extends ArtifactEditorFindUsagesActionBase {
  ...
  protected ProjectStructureElement getSelectedElement() {
    List<SourceItemNode> nodes = myTree.getSelectedSourceItemNodes();
