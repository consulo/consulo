...
public class RunIdeConsoleAction extends DumbAwareAction {
    ...
    public void actionPerformed(@Nonnull AnActionEvent e) {
        ...
        JBPopupFactory.getInstance()
            .createActionGroupPopup("Script Engine", actions, e.getDataContext(), JBPopupFactory.ActionSelectionAid.NUMBERING, false)
    ...
    protected void runConsole(@Nonnull AnActionEvent e, @Nonnull String language) {
        ...
        try {
            ...
            VirtualFile virtualFile =
                IdeConsoleRootType.getInstance().findFile(project, pathName, ScratchFileService.Option.create_if_missing);
            if (virtualFile != null) {
    ...
    private static class ConsoleWriter extends Writer {
        ...
        public void write(char[] cbuf, int off, int len) throws IOException {
            ...
            ConsoleViewImpl console =
                ObjectUtil.tryCast(descriptor != null ? descriptor.getExecutionConsole() : null, ConsoleViewImpl.class);
            if (console == null) {
                //TODO ignore ?
