...
/**
 * Similar to a list returned by {@link Lists#newLockFreeCopyOnWriteList} with additional methods that allow
...
public class DisposableWrapperList<E> extends AbstractList<E> {
    ...
    public boolean remove(@Nullable Object obj) {
        ...
        boolean result = myWrappedList.removeIf(disposableWrapper -> {
            if (disposableWrapper.delegate.equals(obj) && (removedWrappers.isEmpty() && disposableWrapper.makeUnique() || removedWrappers.contains(
                disposableWrapper))) {
