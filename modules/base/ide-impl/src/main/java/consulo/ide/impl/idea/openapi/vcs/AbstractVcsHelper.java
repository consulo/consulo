...
public abstract class AbstractVcsHelper {
  ...
  /**
   * {@link #showMergeDialog(java.util.List, consulo.ide.impl.idea.openapi.vcs.merge.MergeProvider)} without description.
   */
  @Nonnull
  ...
  /**
   * {@link #showMergeDialog(java.util.List, consulo.ide.impl.idea.openapi.vcs.merge.MergeProvider)} without description and with default merge provider
   * for the current VCS.
   */
  @Nonnull
