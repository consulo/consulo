...
import static consulo.ide.impl.idea.util.net.ssl.CertificateWrapper.CommonField.COMMON_NAME;
import static consulo.ide.impl.idea.util.net.ssl.CertificateWrapper.CommonField.ORGANIZATION;
