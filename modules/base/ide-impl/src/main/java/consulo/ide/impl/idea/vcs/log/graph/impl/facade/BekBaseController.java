...
import consulo.ide.impl.idea.vcs.log.graph.api.elements.GraphNodeType;
...
public class BekBaseController extends CascadeController {
  ...
  public static class BekLinearGraph implements LinearGraph {
    ...
    public int getNodeId(int nodeIndex) {
      // see consulo.ide.impl.idea.vcs.log.graph.impl.permanent.PermanentLinearGraphImpl.getNodeId
