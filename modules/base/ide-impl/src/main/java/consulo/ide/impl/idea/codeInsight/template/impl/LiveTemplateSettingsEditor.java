...
public class LiveTemplateSettingsEditor extends JPanel {
  ...
  public void focusKey() {
    ...
    //todo[peter,kirillk] without these invokeLaters this requestFocus conflicts with consulo.ide.impl.idea.openapi.ui.impl.DialogWrapperPeerImpl.MyDialog.MyWindowListener.windowOpened()
