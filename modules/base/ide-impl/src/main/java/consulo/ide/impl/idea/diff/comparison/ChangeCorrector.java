...
import static consulo.ide.impl.idea.diff.comparison.TrimUtil.expand;
import static consulo.ide.impl.idea.diff.comparison.iterables.DiffIterableUtil.diff;
