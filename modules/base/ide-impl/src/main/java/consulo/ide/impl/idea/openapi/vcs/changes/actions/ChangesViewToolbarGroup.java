...
public class ChangesViewToolbarGroup extends DefaultActionGroup implements DumbAware {
    public ChangesViewToolbarGroup() {
        super(ActionLocalize.groupChangesviewtoolbarText(), false);
    }
}
