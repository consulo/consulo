...
import consulo.ide.impl.idea.application.options.codeStyle.arrangement.component.ArrangementAndMatchConditionComponent;
import consulo.ide.impl.idea.application.options.codeStyle.arrangement.component.ArrangementAtomMatchConditionComponent;
...
public class ArrangementMatchNodeComponentFactory {
                                                       ...
                                                       ArrangementAnimationManager.Callback
  {
    ...
    @Override
    public void consume(@Nonnull ArrangementAtomMatchConditionComponent component) {
