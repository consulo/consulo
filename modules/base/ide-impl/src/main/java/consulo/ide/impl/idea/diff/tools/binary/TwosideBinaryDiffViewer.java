...
import consulo.ide.impl.idea.diff.tools.util.StatusPanel;
import consulo.ide.impl.idea.diff.tools.util.TransferableFileEditorStateSupport;
import consulo.ide.impl.idea.diff.tools.util.side.TwosideDiffViewer;
...
import static consulo.ide.impl.idea.diff.util.DiffUtil.getDiffSettings;
