...
public class LastRunReformatCodeOptionsProvider {
    ...
    public LastRunReformatCodeOptionsProvider(ApplicationPropertiesComponent applicationPropertiesComponent) {
        myPropertiesComponent = applicationPropertiesComponent;
    }
