...
@ActionImpl(
    ...
    children = {
        ...
        @ActionRef(type = AnSeparator.class),
        @ActionRef(type = IntelliSortChooserToggleAction.class),
        @ActionRef(type = CollapseGraphAction.class),
        @ActionRef(type = ExpandGraphAction.class),
        @ActionRef(type = ShowLongEdgesAction.class),
        @ActionRef(type = AnSeparator.class),
        @ActionRef(type = VcsLogQuickSettingsActions.class),
        @ActionRef(type = CompactReferencesViewAction.class),
        @ActionRef(type = ShowTagNamesAction.class),
        @ActionRef(type = ShowDetailsAction.class),
        @ActionRef(type = ShowRootsColumnAction.class),
        @ActionRef(type = AnSeparator.class),
        @ActionRef(type = RefreshLogAction.class),
        @ActionRef(type = OpenAnotherLogTabAction.class),
        @ActionRef(type = CloseLogTabAction.class)
    },
    parents = @ActionParentRef(@ActionRef(id = "Vcs.KeymapGroup"))
)
public class KeymapGroup extends DefaultActionGroup implements DumbAware {
    public KeymapGroup() {
        super(VersionControlSystemLogLocalize.groupKeymapText(), false);
    }
}
