...
public class EditorSmartKeysConfigurable extends SimpleConfigurable<EditorSmartKeysConfigurable.Panel> implements Configurable, ApplicationConfigurable {
  protected static class Panel implements Supplier<Component> {
    ...
    public Panel() {
      ...
      myWholeLayout.add(myCbSmartHome = CheckBox.create(ApplicationLocalize.checkboxSmartHome()));
      myWholeLayout.add(myCbSmartEnd = CheckBox.create(ApplicationLocalize.checkboxSmartEndOnBlankLine()));
      myWholeLayout.add(myCbInsertPairBracket = CheckBox.create(ApplicationLocalize.checkboxInsertPairBracket()));
      myWholeLayout.add(myCbInsertPairQuote = CheckBox.create(ApplicationLocalize.checkboxInsertPairQuote()));
      myWholeLayout.add(myCbReformatBlockOnTypingRBrace = CheckBox.create(ApplicationLocalize.checkboxReformatOnTypingRbrace()));
      myWholeLayout.add(myCbCamelWords = CheckBox.create(ApplicationLocalize.checkboxUseCamelhumpsWords()));
      myWholeLayout.add(myCbSurroundSelectionOnTyping = CheckBox.create(ApplicationLocalize.checkboxSurroundSelectionOnTypingQuoteOrBrace()));
      myWholeLayout.add(mySmartIndentPastedLinesCheckBox = CheckBox.create(ApplicationLocalize.checkboxIndentOnPaste()));
      ...
      enterLayout.add(myCbSmartIndentOnEnter = CheckBox.create(ApplicationLocalize.checkboxSmartIndent()));
      enterLayout.add(myCbInsertPairCurlyBraceOnEnter = CheckBox.create(ApplicationLocalize.checkboxInsertPairCurlyBrace()));
      enterLayout.add(myCbInsertJavadocStubOnEnter = CheckBox.create(ApplicationLocalize.checkboxJavadocStubAfterSlashStarStar()));
