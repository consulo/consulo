...
public abstract class TaskManager {
  ...
  @Deprecated // use {@code consulo.ide.impl.idea.tasks.TaskManager.addTaskListener(consulo.ide.impl.idea.tasks.TaskListener, consulo.ide.impl.idea.openapi.Disposable)}
