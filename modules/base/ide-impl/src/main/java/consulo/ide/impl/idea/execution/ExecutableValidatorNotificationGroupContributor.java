 ...
 */
@ExtensionImpl
public class ExecutableValidatorNotificationGroupContributor implements NotificationGroupContributor {
  @Override
  public void contribute(@Nonnull Consumer<NotificationGroup> registrator) {
    registrator.accept(ExecutableValidator.ourNotificationGroup);
  }
}
