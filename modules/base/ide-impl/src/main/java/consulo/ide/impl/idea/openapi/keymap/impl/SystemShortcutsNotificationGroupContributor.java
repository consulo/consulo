 ...
 */
@ExtensionImpl
public class SystemShortcutsNotificationGroupContributor implements NotificationGroupContributor {
  @Override
  public void contribute(@Nonnull Consumer<NotificationGroup> registrator) {
    registrator.accept(SystemShortcuts.SYSTEM_SHORTCUTS_CONFLICTS_GROUP);
  }
}
