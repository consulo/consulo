...
public class FileContentPattern extends ObjectPattern<FileContent, FileContentPattern> {
  ...
  public FileContentPattern withName(final String name) {
    return with(new PatternCondition<FileContent>("withName") {
      @Override
      public boolean accepts(FileContent fileContent, ProcessingContext context) {
  ...
  public FileContentPattern inDirectory(final String name) {
  ...
  public FileContentPattern xmlWithRootTag(final String rootTag) {
