...
public class DependencyValidationManagerImpl extends DependencyValidationManager implements Disposable {
    ...
    public Image getIcon() {
        return PlatformIconGroup.ideSharedscope();
    }
    ...
    public Element getState() {
        ...
        if (mySkipImportStatements || mySkipImportStatementsWasSpecified) {
            element.addContent(new Element("option").setAttribute("name", "SKIP_IMPORT_STATEMENTS")
                .setAttribute("value", Boolean.toString(mySkipImportStatements)));
        }
    ...
    private final List<Pair<NamedScope, NamedScopesHolder>> myScopes = Lists.newLockFreeCopyOnWriteList();
