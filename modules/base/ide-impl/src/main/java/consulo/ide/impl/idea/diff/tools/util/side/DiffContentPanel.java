...
import consulo.ide.impl.idea.diff.util.InvisibleWrapper;
...
class DiffContentPanel extends JPanel {
  ...
  DiffContentPanel(@Nonnull JComponent content) {
    myContent = content;
  ...
  private static class DiffContentLayout extends AbstractLayoutManager {
    ...
    DiffContentLayout(@Nonnull JComponent title, @Nonnull JComponent topBreadcrumbs, @Nonnull JComponent content, @Nonnull JComponent bottomBreadcrumbs) {
      myTitle = title;
