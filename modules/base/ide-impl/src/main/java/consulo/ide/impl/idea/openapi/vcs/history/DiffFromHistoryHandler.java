...
public interface DiffFromHistoryHandler {
   ...
   * @param previousRevision the previous revision in the list displayed file history panel, may be {@link consulo.ide.impl.idea.openapi.vcs.history.VcsFileRevision#NULL}.
