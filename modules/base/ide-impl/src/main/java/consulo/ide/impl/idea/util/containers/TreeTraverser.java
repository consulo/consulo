...
public class TreeTraverser<T> {
    ...
    public final JBIterable<T> preOrderDfsTraversal(Iterable<? extends T> roots) {
    ...
    public final JBIterable<T> postOrderDfsTraversal(Iterable<? extends T> roots) {
        return new JBIterable<>() {
            @Override
    ...
    public final JBIterable<T> leavesOnlyDfsTraversal(Iterable<? extends T> roots) {
        return new JBIterable<>() {
            @Override
            public Iterator<T> iterator() {
    ...
    public final JBIterable<T> bfsTraversal(Iterable<? extends T> roots) {
        return new JBIterable<>() {
            @Override
            public Iterator<T> iterator() {
    ...
    public final JBIterable<T> tracingBfsTraversal(Iterable<? extends T> roots) {
        return new JBIterable<>() {
            @Override
            public TracingIt<T> iterator() {
    ...
    public final JBIterable<T> leavesOnlyBfsTraversal(Iterable<? extends T> roots) {
        return new JBIterable<>() {
            @Override
            public Iterator<T> iterator() {
    ...
    private final class TracingBfsIt extends TracingIt<T> {
        ...
        TracingBfsIt(Iterable<? extends T> roots) {
            JBIterable.from(roots).addAllTo(queue);
        }
