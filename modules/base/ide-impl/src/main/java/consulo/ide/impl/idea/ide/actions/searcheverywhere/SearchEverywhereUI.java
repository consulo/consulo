...
public class SearchEverywhereUI extends BigPopupUI implements UiDataProvider, QuickSearchComponent {
    ...
    private class CompositeCellRenderer implements ListCellRenderer<Object> {
        ...
        public Component getListCellRendererComponent(
            ...
            if (component == null) {
                component =
                    (JComponent) contributor.getElementsRenderer().getListCellRendererComponent(list, value, index, isSelected, true);
            }
    ...
    public static class SearchListModel extends AbstractListModel<Object> {
        ...
        public void addElements(List<? extends SearchEverywhereFoundElementInfo> items) {
            ...
            items.forEach(info -> {
                List<SearchEverywhereFoundElementInfo> list =
                    itemsMap.computeIfAbsent(info.getContributor(), contributor -> new ArrayList<>());
                list.add(info);
            });
            itemsMap.forEach(
                (contributor, list) -> Collections.sort(
                    list,
                    Comparator.comparingInt(SearchEverywhereFoundElementInfo::getPriority).reversed()
                )
            );
        ...
        public void removeElement(Object item, SearchEverywhereContributor contributor) {
    ...
    private class ShowInFindToolWindowAction extends DumbAwareAction {
        ...
        ShowInFindToolWindowAction() {
            super(
                ...
                PlatformIconGroup.generalPin_tab()
            );
        }
        ...
        public void actionPerformed(AnActionEvent e) {
            ...
            presentation.setTargetsNodeText(IdeLocalize.searcheverywhereFoundTargetsTitle());
    ...
    static class FiltersAction extends ShowFilterAction {
        ...
        FiltersAction(PersistentSearchEverywhereContributorFilter<?> filter, Runnable rebuildRunnable) {
            this.filter = filter;
