...
public class LineTooltipRenderer extends ComparableObject.Impl implements TooltipRenderer {
    ...
    public LineTooltipRenderer(@Nullable String text, Object[] comparable) {
        this(text, 0, comparable);
    }

    public LineTooltipRenderer(@Nullable String text, int width, Object[] comparable) {
        super(comparable);
    ...
    public LightweightHintImpl createHint(
        ...
        JEditorPane editorPane =
            IdeTooltipManagerImpl.initPane(new Html(textToDisplay).setKeepFont(true), hintHint, layeredPane, limitWidthToScreen);
    ...
    private void reloadFor(
        ...
        TooltipController.getInstance()
            .showTooltip(editor, point, createRenderer(myText, expand ? pane.getWidth() : 0), alignToRight, group, hintHint);
    }
    ...
    private static boolean handle(String ref, Editor editor) {
    ...
    private static Dimension correctLocation(
        Editor editor,
        Point p,
        boolean alignToRight,
        boolean expanded,
    ...
    private static void locateOutsideMouseCursor(
        Editor editor,
    ...
    protected static boolean isActiveHtml(String html) {
