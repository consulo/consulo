...
public class CommandMerger {
  ...
  CommandMerger(UndoManagerImpl manager) {
    myManager = manager;
  }

  CommandMerger(UndoManagerImpl manager, boolean isTransparent) {
    myManager = manager;
  ...
  void addAdditionalAffectedDocuments(Collection<DocumentReference> refs) {
