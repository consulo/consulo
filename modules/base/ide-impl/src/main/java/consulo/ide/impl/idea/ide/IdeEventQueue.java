...
public class IdeEventQueue extends EventQueue {
  ...
  private final consulo.ide.impl.idea.util.EventDispatcher<PostEventHook> myPostEventListeners = consulo.ide.impl.idea.util.EventDispatcher.create(PostEventHook.class);
