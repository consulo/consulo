...
import consulo.ide.impl.idea.openapi.util.ThreadLocalCachedByteArray;
...
public class PersistentHashMapValueStorage {
  ...
  public static class CreationTimeOptions {
    ...
    static CreationTimeOptions threadLocalOptions() {
      return new CreationTimeOptions(EXCEPTIONAL_IO_CANCELLATION.get(), READONLY.get() == Boolean.TRUE, COMPACT_CHUNKS_WITH_VALUE_DESERIALIZATION.get() == Boolean.TRUE, HAS_NO_CHUNKS.get() == Boolean.TRUE,
