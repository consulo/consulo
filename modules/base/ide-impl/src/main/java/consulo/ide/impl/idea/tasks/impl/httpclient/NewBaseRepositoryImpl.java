package consulo.ide.impl.idea.tasks.impl.httpclient;
...
import consulo.ide.impl.idea.tasks.impl.RequestFailedException;
import consulo.ide.impl.idea.tasks.impl.TaskUtil;
import consulo.ide.impl.idea.util.net.IdeHttpClientHelpers;
...
/**
 * This alternative base implementation of {@link consulo.ide.impl.idea.tasks.impl.BaseRepository} should be used
...
public abstract class NewBaseRepositoryImpl extends BaseRepository {
  ...
  protected HttpClient getHttpClient() {
    HttpClientBuilder builder = HttpClients.custom().setDefaultRequestConfig(createRequestConfig()).setSslcontext(CertificateManager.getInstance().getSslContext())
            ...
            .setHostnameVerifier((X509HostnameVerifier)CertificateManager.HOSTNAME_VERIFIER).setDefaultCredentialsProvider(createCredentialsProvider()).addInterceptorFirst(PREEMPTIVE_BASIC_AUTH)
