...
public final class SyntaxInfoBuilder {
    ...
    static MyMarkupIterator createMarkupIterator(
        ...
        CompositeRangeIterator iterator =
            new CompositeRangeIterator(schemeToUse, new HighlighterRangeIterator(highlighter, startOffsetToUse, endOffset),
    ...
    private static class MarkupModelRangeIterator implements RangeIterator {
        ...
        private void findNextSuitableRange() {
            ...
            while (myIterator.hasNext()) {
                ...
                if (info != null) {
                    TextAttributesKey key = info.myForcedTextAttributesKey;
                    if (key == null) {
                        HighlightInfoType type = info.getType();
    ...
    static class Context {
        ...
        Context(@Nonnull CharSequence charSequence, @Nonnull EditorColorsScheme scheme, int indentSymbolsToStrip) {
            ...
            float fontSize = Platform.current().os().isMac() || Application.get().isHeadlessEnvironment()
                ? javaFontSize
