...
import consulo.ide.impl.idea.diff.*;
import consulo.ide.impl.idea.diff.FrameDiffTool.DiffViewer;
import consulo.ide.impl.idea.diff.actions.impl.*;
...
import consulo.ide.impl.idea.diff.tools.util.PrevNextDifferenceIterable;
