 ...
 *
 * @see consulo.ide.impl.idea.openapi.vcs.AbstractVcs#getUpdateEnvironment()
 * @see consulo.ide.impl.idea.openapi.vcs.AbstractVcs#getIntegrateEnvironment()
 * @see consulo.ide.impl.idea.openapi.vcs.AbstractVcs#getStatusEnvironment()
 */
