...
public class Jsr223IdeScriptEngineManagerImpl extends IdeScriptEngineManager {
    ...
    public IdeScriptEngine getEngineForLanguage(@Nonnull String language, @Nullable ClassLoader loader) {
        ...
        return ClassLoaderUtil.runWithClassLoader(
            l,
            (Supplier<IdeScriptEngine>) () -> createIdeScriptEngine(getScriptEngineManager().getEngineByName(language))
        );
    }
    ...
    public IdeScriptEngine getEngineForFileExtension(@Nonnull String extension, @Nullable ClassLoader loader) {
        ...
        return ClassLoaderUtil.runWithClassLoader(
            l,
            (Supplier<IdeScriptEngine>) () -> createIdeScriptEngine(getScriptEngineManager().getEngineByExtension(extension))
        );
    }
