...
public class ProjectInspectionToolsConfigurableProvider extends ErrorsConfigurableProvider {
  ...
  public ErrorsConfigurable createConfigurable() {
    return new ProjectInspectionToolsConfigurable(myProfileManager, (consulo.ide.impl.idea.profile.codeInspection.InspectionProjectProfileManager)myProjectProfileManager);
  }
}
