...
public class InspectionResultsViewComparator implements Comparator {
    ...
    public int compare(Object o1, Object o2) {
        ...
        if (node1 instanceof OfflineRefElementNode && node2 instanceof OfflineRefElementNode ||
            ...
            if (userObject1 instanceof OfflineProblemDescriptor descriptor1
                && userObject2 instanceof OfflineProblemDescriptor descriptor2) {
        ...
        if (node1 instanceof RefElementNode refElementNode1 && node2 instanceof RefElementNode refElementNode2) {
        ...
        if (node1 instanceof ProblemDescriptionNode descriptionNode1 && node2 instanceof ProblemDescriptionNode descriptionNode2) {
            ...
            if (descriptor1 != null && descriptor2 != null) {
                return descriptor1.getDescriptionTemplate().compareTo(descriptor2.getDescriptionTemplate());
            }
            if (descriptor1 == null) {
    ...
    private static int compareEntities(RefEntity entity1, RefEntity entity2) {
        if (entity1 instanceof RefElement ref1 && entity2 instanceof RefElement ref2) {
            return PsiUtilCore.compareElementsByPosition(ref1.getPsiElement(), ref2.getPsiElement());
        }
