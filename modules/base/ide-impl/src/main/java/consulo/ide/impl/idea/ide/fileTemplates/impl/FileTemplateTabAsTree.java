    ...
    protected static class FileTemplateNode extends DefaultMutableTreeNode {
        ...
        FileTemplateNode(FileTemplateDescriptor descriptor) {
            this(
                ...
                TargetAWT.to(descriptor.getIcon()),
                descriptor instanceof FileTemplateGroupDescriptor fileTemplateGroupDescriptor
                    ? ContainerUtil.map2List(fileTemplateGroupDescriptor.getTemplates(), FileTemplateNode::new)
