...
public class LayoutProjectCodeDialog extends DialogWrapper implements ReformatFilesOptions {
    ...
    public LayoutProjectCodeDialog(Project project, String title, String text, boolean enableOnlyVCSChangedTextCb) {
        super(project, false);
        myText = text;
        myProject = project;
    ...
    protected JComponent createCenterPanel() {
        ...
        myMaskWarningLabel.setIcon(TargetAWT.to(PlatformIconGroup.generalWarning()));
    ...
    private void initScopeFilter() {
        ...
        myUseScopeFilteringCb.addActionListener(e -> myScopeCombo.setEnabled(myUseScopeFilteringCb.isSelected()));
    }

    private void initFileTypeFilter() {
        FindInProjectUtil.initFileFilter(myFileFilter, myEnableFileNameFilterCb);
        myEnableFileNameFilterCb.addActionListener(e -> updateMaskWarning());
    ...
    private void $$$setupUI$$$() {
        ...
        myWholePanel.setLayout(new GridLayoutManager(5, 1, JBUI.emptyInsets(), -1, -1));
        ...
        myOptionsPanel.setLayout(new GridLayoutManager(5, 1, JBUI.emptyInsets(), -1, -1));
        ...
        myFiltersPanel.setLayout(new GridLayoutManager(4, 2, JBUI.emptyInsets(), -1, -1));
