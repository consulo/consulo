...
public class NewErrorTreeViewPanelImpl extends JPanel implements UiDataProvider, NewErrorTreeViewPanel, CopyProvider {
    ...
    public void selectFirstMessage() {
        ...
        if (firstError != null) {
            ...
            if (firstWarning == null) {
                firstWarning = myErrorViewStructure.getFirstMessage(ErrorTreeElementKind.NOTE);
            }
    ...
    @Override
    public void addMessage(int type, String[] text, @Nullable VirtualFile file, int line, int column, @Nullable Object data) {
        addMessage(type, text, null, file, line, column, data);
    }

    @Override
    public void addMessage(int type, String[] text, @Nullable VirtualFile underFileGroup, @Nullable VirtualFile file, int line, int column, @Nullable Object data) {
        if (myIsDisposed) {
            return;
        }
    ...
    public static String createExportPrefix(int line) {
        return NewErrorTreeViewPanel.createExportPrefix(line);
    }

    @Deprecated
    public static String createRendererPrefix(int line, int column) {
        return NewErrorTreeViewPanel.createRendererPrefix(line, column);
    }
