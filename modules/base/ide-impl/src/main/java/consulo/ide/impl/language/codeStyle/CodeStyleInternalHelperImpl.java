...
import consulo.language.codeStyle.impl.internal.FormattingDocumentModelImpl;
...
public class CodeStyleInternalHelperImpl implements CodeStyleInternalHelper {
    ...
    private static ASTNode findPreviousWhiteSpace(ASTNode leafElement, IElementType whiteSpaceTokenType) {
        ...
        PsiElement psiElement = leafElement.getPsi();
        if (psiElement == null) {
            return null;
        }
    ...
    private static void addWhiteSpace(ASTNode treePrev, ASTNode whiteSpaceElement) {
    ...
    @RequiredUIAccess
    @Override
    public void showDetectIndentSettings(@Nullable Project project) {
