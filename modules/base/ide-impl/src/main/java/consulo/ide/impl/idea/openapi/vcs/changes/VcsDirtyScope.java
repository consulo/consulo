 ...
 * is passed to implementers of the {@link consulo.ide.impl.idea.openapi.vcs.changes.ChangeProvider}
...
public abstract class VcsDirtyScope {
   ...
   * @see #getDirtyFiles()
   * @see consulo.ide.impl.idea.openapi.vcs.ProjectLevelVcsManager#getVcsRootFor(consulo.ide.impl.idea.openapi.vcs.FilePath)
   */
