...
public class ShowExpressionTypeHandler implements CodeInsightActionHandler {
    ...
    public void invoke(@Nonnull Project project, @Nonnull Editor editor, @Nonnull PsiFile file) {
        ...
        @RequiredReadAction
        Consumer<PsiElement> callback = expression -> {
    ...
    private static Map<PsiElement, ExpressionTypeProvider> getExpressions(
        ...
        int offset =
            !range.isEmpty() ? range.getStartOffset() : TargetElementUtil.adjustOffset(file, editor.getDocument(), range.getStartOffset());
    ...
    public static Set<ExpressionTypeProvider> getHandlers(Project project, Language... languages) {
        ...
        return JBIterable.of(languages)
            .flatten(language -> dumbService.filterByDumbAwareness(ExpressionTypeProvider.forLanguage(language)))
