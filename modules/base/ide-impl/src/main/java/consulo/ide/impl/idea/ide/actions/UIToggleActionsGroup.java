...
public class UIToggleActionsGroup extends DefaultActionGroup implements DumbAware {
    public UIToggleActionsGroup() {
        super(ActionLocalize.groupUitoggleactionsText(), false);
    }
}
