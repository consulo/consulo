 ...
 */
@ExtensionImpl
public class ApproveRemovedMappingsNotificationGroupContributor implements NotificationGroupContributor {
  @Override
  public void contribute(@Nonnull Consumer<NotificationGroup> registrator) {
    registrator.accept(ApproveRemovedMappingsActivity.GROUP);
  }
}
