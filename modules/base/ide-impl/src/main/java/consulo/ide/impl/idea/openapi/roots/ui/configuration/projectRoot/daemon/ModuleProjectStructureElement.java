        ...
        if (moduleEditor != null) {
            for (OrderEntry entry : moduleEditor.getOrderEntries()) {
                if (entry instanceof ModuleOrderEntry moduleOrderEntry) {
                    ...
                    if (module != null) {
                        usages.add(new UsageInModuleClasspath(
                            myModulesConfigurator,
                            this,
                            new ModuleProjectStructureElement(myModulesConfigurator, module),
                            moduleOrderEntry.getScope()
                        ));
                    }
                }
                    ...
                    if (library != null) {
                        usages.add(new UsageInModuleClasspath(
                            myModulesConfigurator,
                            this,
                            new LibraryProjectStructureElement(library),
                            libraryOrderEntry.getScope()
                        ));
                    }
                }
                else if (entry instanceof ModuleExtensionWithSdkOrderEntry orderEntry) {
                    Sdk jdk = orderEntry.getSdk();
                    if (jdk != null) {
