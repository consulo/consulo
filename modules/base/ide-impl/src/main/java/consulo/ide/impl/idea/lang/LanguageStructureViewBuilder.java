...
public class LanguageStructureViewBuilder extends OldLanguageExtension<PsiStructureViewFactory> {
  ...
  private LanguageStructureViewBuilder() {
    super(PluginIds.CONSULO_BASE + ".lang.psiStructureViewFactory");
  }
