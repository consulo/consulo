...
@FunctionalInterface
public interface EditorFloatingToolbarFactory {
    @RequiredUIAccess
    FloatingToolbarComponent createToolbar(FloatingToolbarProvider provider, DataContext dataContext, Disposable providerDisposable);
}
