...
public interface Unmappable {
     ...
     * Generally, it is much safer to call {@link java.io.Closeable#close()} without unmap -- in which case JVM/GC is
     * responsible to keep buffers mapped until at least someone uses them.
     */
