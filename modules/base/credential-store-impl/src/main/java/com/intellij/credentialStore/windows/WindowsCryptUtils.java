...
public class WindowsCryptUtils {
   ...
   */
  private static final Map<String, Object> UNICODE_OPTIONS =
          ContainerUtil.newHashMap(pair(Library.OPTION_TYPE_MAPPER, W32APITypeMapper.UNICODE), pair(Library.OPTION_FUNCTION_MAPPER, W32APIFunctionMapper.UNICODE));
  ...
  public interface Crypt32 extends StdCallLibrary {
    ...
    boolean CryptProtectData(DATA_BLOB pDataIn, String szDataDescr, Pointer pOptionalEntropy, Pointer pvReserved, Pointer pPromptStruct, WinDef.DWORD dwFlags, DATA_BLOB pDataOut);

    boolean CryptUnprotectData(DATA_BLOB pDataIn, Pointer ppszDataDescr, Pointer pOptionalEntropy, Pointer pvReserved, Pointer pPromptStruct, WinDef.DWORD dwFlags, DATA_BLOB pDataOut);
