  ...
  private void createUIComponents() {
    ...
    if (MacOsKeychainLibraryKt.isMacOsCredentialStoreSupported()) {
      ...
      if (SystemInfo.isMacIntel64) {
        ...
        subNote = "your OS is not supported, please <a href=\"https://youtrack.jetbrains.com/newIssue?project=IDEA&clearDraft=true&c=Assignee+develar&c=Subsystem+Password+Safe\">file issue</a>";
      }
