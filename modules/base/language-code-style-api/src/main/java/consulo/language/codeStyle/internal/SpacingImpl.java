...
public class SpacingImpl extends Spacing {
    ...
    public void init(
        ...
        myFlags = (isReadOnly ? READ_ONLY_MASK : 0)
            | (safe ? SAFE_MASK : 0)
            | (shouldKeepLineBreaks ? SHOULD_KEEP_LINE_BREAKS_MASK : 0)
    ...
    public boolean equals(@Nullable Object o) {
        ...
        return o instanceof SpacingImpl that
            && myFlags == that.myFlags
            && myMinSpaces == that.myMinSpaces
            && myMaxSpaces == that.myMaxSpaces
            && myMinLineFeeds == that.myMinLineFeeds
            && myPrefLineFeeds == that.myPrefLineFeeds
            && myKeepBlankLines == that.myKeepBlankLines;
    }
