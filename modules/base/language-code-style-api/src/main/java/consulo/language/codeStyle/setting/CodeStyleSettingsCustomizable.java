...
public interface CodeStyleSettingsCustomizable {
  ...
  String SPACES_BEFORE_KEYWORD = CodeStyleBundle.message("group.spaces.after.right.brace");
  String SPACES_WITHIN = CodeStyleBundle.message("group.spaces.within");
  String SPACES_IN_TERNARY_OPERATOR = CodeStyleBundle.message("group.spaces.in.ternary.operator");
  String SPACES_WITHIN_TYPE_ARGUMENTS = CodeStyleBundle.message("group.spaces.in.type.arguments");
  String SPACES_IN_TYPE_ARGUMENTS = CodeStyleBundle.message("group.spaces.in.type.arguments.block");
  String SPACES_IN_TYPE_PARAMETERS = CodeStyleBundle.message("group.spaces.in.type.parameters.block");
  String SPACES_OTHER = CodeStyleBundle.message("group.spaces.other");

  String BLANK_LINES_KEEP = CodeStyleBundle.message("title.keep.blank.lines");
  String BLANK_LINES = CodeStyleBundle.message("title.minimum.blank.lines");

  String WRAPPING_KEEP = CodeStyleBundle.message("wrapping.keep.when.reformatting");
  String WRAPPING_BRACES = CodeStyleBundle.message("wrapping.brace.placement");
  String WRAPPING_COMMENTS = CodeStyleBundle.message("wrapping.comments");
  String WRAPPING_METHOD_PARAMETERS = CodeStyleBundle.message("wrapping.method.parameters");
  String WRAPPING_METHOD_PARENTHESES = CodeStyleBundle.message("wrapping.method.parentheses");
  String WRAPPING_METHOD_ARGUMENTS_WRAPPING = CodeStyleBundle.message("wrapping.method.arguments");
  String WRAPPING_CALL_CHAIN = CodeStyleBundle.message("wrapping.chained.method.calls");
  String WRAPPING_IF_STATEMENT = CodeStyleBundle.message("wrapping.if.statement");
  String WRAPPING_FOR_STATEMENT = CodeStyleBundle.message("wrapping.for.statement");
  String WRAPPING_WHILE_STATEMENT = CodeStyleBundle.message("wrapping.while.statement");
  String WRAPPING_DOWHILE_STATEMENT = CodeStyleBundle.message("wrapping.dowhile.statement");
  String WRAPPING_SWITCH_STATEMENT = CodeStyleBundle.message("wrapping.switch.statement");
  String WRAPPING_TRY_STATEMENT = CodeStyleBundle.message("wrapping.try.statement");
  String WRAPPING_TRY_RESOURCE_LIST = CodeStyleBundle.message("wrapping.try.resources");
  String WRAPPING_BINARY_OPERATION = CodeStyleBundle.message("wrapping.binary.operations");
  String WRAPPING_EXTENDS_LIST = CodeStyleBundle.message("wrapping.extends.implements.list");
  String WRAPPING_EXTENDS_KEYWORD = CodeStyleBundle.message("wrapping.extends.implements.keyword");
  String WRAPPING_THROWS_LIST = CodeStyleBundle.message("wrapping.throws.list");
  String WRAPPING_THROWS_KEYWORD = CodeStyleBundle.message("wrapping.throws.keyword");
  String WRAPPING_TERNARY_OPERATION = CodeStyleBundle.message("wrapping.ternary.operation");
  String WRAPPING_ASSIGNMENT = CodeStyleBundle.message("wrapping.assignment.statement");
  String WRAPPING_FIELDS_VARIABLES_GROUPS = CodeStyleBundle.message("checkbox.align.multiline.fields.groups");
  String WRAPPING_ARRAY_INITIALIZER = CodeStyleBundle.message("wrapping.array.initializer");
  String WRAPPING_MODIFIER_LIST = CodeStyleBundle.message("wrapping.modifier.list");
  String WRAPPING_ASSERT_STATEMENT = CodeStyleBundle.message("wrapping.assert.statement");

  String[] WRAP_OPTIONS = {CodeStyleBundle.message("wrapping.do.not.wrap"), CodeStyleBundle.message("wrapping.wrap.if.long"), CodeStyleBundle.message("wrapping.chop.down.if.long"),
          CodeStyleBundle.message("wrapping.wrap.always")};
  String[] WRAP_OPTIONS_FOR_SINGLETON = {CodeStyleBundle.message("wrapping.do.not.wrap"), CodeStyleBundle.message("wrapping.wrap.if.long"), CodeStyleBundle.message("wrapping.wrap.always")};
  ...
  String[] BRACE_OPTIONS =
          {CodeStyleBundle.message("wrapping.force.braces.do.not.force"), CodeStyleBundle.message("wrapping.force.braces.when.multiline"), CodeStyleBundle.message("wrapping.force.braces.always")};
  ...
  String[] BRACE_PLACEMENT_OPTIONS = {CodeStyleBundle.message("wrapping.brace.placement.end.of.line"), CodeStyleBundle.message("wrapping.brace.placement.next.line.if.wrapped"),
          CodeStyleBundle.message("wrapping.brace.placement.next.line"), CodeStyleBundle.message("wrapping.brace.placement.next.line.shifted"),
          CodeStyleBundle.message("wrapping.brace.placement.next.line.each.shifted")};
  ...
  String[] WRAP_ON_TYPING_OPTIONS =
          {CodeStyleBundle.message("wrapping.wrap.on.typing.no.wrap"), CodeStyleBundle.message("wrapping.wrap.on.typing.wrap"), CodeStyleBundle.message("wrapping.wrap.on.typing.default")};
