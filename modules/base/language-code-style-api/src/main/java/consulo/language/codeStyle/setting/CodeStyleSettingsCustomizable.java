...
public interface CodeStyleSettingsCustomizable {
    ...
    LocalizeValue SPACES_AROUND_OPERATORS = CodeStyleLocalize.groupSpacesAroundOperators();
    LocalizeValue SPACES_BEFORE_PARENTHESES = CodeStyleLocalize.groupSpacesBeforeParentheses();
    LocalizeValue SPACES_BEFORE_LEFT_BRACE = CodeStyleLocalize.groupSpacesBeforeLeftBrace();
    LocalizeValue SPACES_BEFORE_KEYWORD = CodeStyleLocalize.groupSpacesAfterRightBrace();
    LocalizeValue SPACES_WITHIN = CodeStyleLocalize.groupSpacesWithin();
    LocalizeValue SPACES_IN_TERNARY_OPERATOR = CodeStyleLocalize.groupSpacesInTernaryOperator();
    LocalizeValue SPACES_WITHIN_TYPE_ARGUMENTS = CodeStyleLocalize.groupSpacesInTypeArguments();
    LocalizeValue SPACES_IN_TYPE_ARGUMENTS = CodeStyleLocalize.groupSpacesInTypeArgumentsBlock();
    LocalizeValue SPACES_IN_TYPE_PARAMETERS = CodeStyleLocalize.groupSpacesInTypeParametersBlock();
    LocalizeValue SPACES_OTHER = CodeStyleLocalize.groupSpacesOther();

    LocalizeValue BLANK_LINES_KEEP = CodeStyleLocalize.titleKeepBlankLines();
    LocalizeValue BLANK_LINES = CodeStyleLocalize.titleMinimumBlankLines();

    LocalizeValue WRAPPING_KEEP = CodeStyleLocalize.wrappingKeepWhenReformatting();
    LocalizeValue WRAPPING_BRACES = CodeStyleLocalize.wrappingBracePlacement();
    LocalizeValue WRAPPING_COMMENTS = CodeStyleLocalize.wrappingComments();
    LocalizeValue WRAPPING_METHOD_PARAMETERS = CodeStyleLocalize.wrappingMethodParameters();
    LocalizeValue WRAPPING_METHOD_PARENTHESES = CodeStyleLocalize.wrappingMethodParentheses();
    LocalizeValue WRAPPING_METHOD_ARGUMENTS_WRAPPING = CodeStyleLocalize.wrappingMethodArguments();
    LocalizeValue WRAPPING_CALL_CHAIN = CodeStyleLocalize.wrappingChainedMethodCalls();
    LocalizeValue WRAPPING_IF_STATEMENT = CodeStyleLocalize.wrappingIfStatement();
    LocalizeValue WRAPPING_FOR_STATEMENT = CodeStyleLocalize.wrappingForStatement();
    LocalizeValue WRAPPING_WHILE_STATEMENT = CodeStyleLocalize.wrappingWhileStatement();
    LocalizeValue WRAPPING_DOWHILE_STATEMENT = CodeStyleLocalize.wrappingDowhileStatement();
    LocalizeValue WRAPPING_SWITCH_STATEMENT = CodeStyleLocalize.wrappingSwitchStatement();
    LocalizeValue WRAPPING_TRY_STATEMENT = CodeStyleLocalize.wrappingTryStatement();
    LocalizeValue WRAPPING_TRY_RESOURCE_LIST = CodeStyleLocalize.wrappingTryResources();
    LocalizeValue WRAPPING_BINARY_OPERATION = CodeStyleLocalize.wrappingBinaryOperations();
    LocalizeValue WRAPPING_EXTENDS_LIST = CodeStyleLocalize.wrappingExtendsImplementsList();
    LocalizeValue WRAPPING_EXTENDS_KEYWORD = CodeStyleLocalize.wrappingExtendsImplementsKeyword();
    LocalizeValue WRAPPING_THROWS_LIST = CodeStyleLocalize.wrappingThrowsList();
    LocalizeValue WRAPPING_THROWS_KEYWORD = CodeStyleLocalize.wrappingThrowsKeyword();
    LocalizeValue WRAPPING_TERNARY_OPERATION = CodeStyleLocalize.wrappingTernaryOperation();
    LocalizeValue WRAPPING_ASSIGNMENT = CodeStyleLocalize.wrappingAssignmentStatement();
    LocalizeValue WRAPPING_FIELDS_VARIABLES_GROUPS = CodeStyleLocalize.checkboxAlignMultilineFieldsGroups();
    LocalizeValue WRAPPING_ARRAY_INITIALIZER = CodeStyleLocalize.wrappingArrayInitializer();
    LocalizeValue WRAPPING_MODIFIER_LIST = CodeStyleLocalize.wrappingModifierList();
    LocalizeValue WRAPPING_ASSERT_STATEMENT = CodeStyleLocalize.wrappingAssertStatement();

    LocalizeValue[] WRAP_OPTIONS = {
    ...
    LocalizeValue[] BRACE_PLACEMENT_OPTIONS = {
        ...
        CodeStyleLocalize.wrappingBracePlacementNextLine(),
        CodeStyleLocalize.wrappingBracePlacementNextLineShifted(),
        CodeStyleLocalize.wrappingBracePlacementNextLineEachShifted()
    };
    ...
    default void renameStandardOption(String fieldName, LocalizeValue newTitle) {
    }
     ...
     */
    default void moveStandardOption(String fieldName, LocalizeValue newGroup) {
    }
}
