...
public class CodeStyleSettingPresentation {
  ...
  static {
    ...
    result.put(new SettingsGroup(BLANK_LINES_KEEP), List.of(new CodeStyleSettingPresentation("KEEP_BLANK_LINES_IN_DECLARATIONS", ApplicationBundle.message("editbox.keep.blanklines.in.declarations")),
    ...
    result.put(new SettingsGroup(BLANK_LINES), List.of(new CodeStyleSettingPresentation("BLANK_LINES_BEFORE_PACKAGE", ApplicationBundle.message("editbox.blanklines.before.package.statement")),
    ...
    result.put(new SettingsGroup(SPACES_BEFORE_PARENTHESES),
               List.of(new CodeStyleSettingPresentation("SPACE_BEFORE_METHOD_PARENTHESES", ApplicationBundle.message("checkbox.spaces.method.declaration.parentheses")),
    ...
    result.put(new SettingsGroup(SPACES_AROUND_OPERATORS),
               List.of(new CodeStyleSettingPresentation("SPACE_AROUND_ASSIGNMENT_OPERATORS", ApplicationBundle.message("checkbox.spaces.assignment.operators")),
    ...
    result.put(new SettingsGroup(SPACES_BEFORE_LEFT_BRACE), List.of(new CodeStyleSettingPresentation("SPACE_BEFORE_CLASS_LBRACE", ApplicationBundle.message("checkbox.spaces.class.left.brace")),
                                                                    ...
                                                                    new CodeStyleSettingPresentation("SPACE_BEFORE_FINALLY_LBRACE", ApplicationBundle.message("checkbox.spaces.finally.left.brace")),
    ...
    result.put(new SettingsGroup(SPACES_BEFORE_KEYWORD), List.of(new CodeStyleSettingPresentation("SPACE_BEFORE_ELSE_KEYWORD", ApplicationBundle.message("checkbox.spaces.else.keyword")),
    ...
    result.put(new SettingsGroup(SPACES_WITHIN), List.of(new CodeStyleSettingPresentation("SPACE_WITHIN_BRACES", ApplicationBundle.message("checkbox.spaces.within.braces")),
    ...
    result.put(new SettingsGroup(SPACES_IN_TERNARY_OPERATOR), List.of(new CodeStyleSettingPresentation("SPACE_BEFORE_QUEST", ApplicationBundle.message("checkbox.spaces.before.question")),
    ...
    result.put(new SettingsGroup(SPACES_WITHIN_TYPE_ARGUMENTS),
               List.of(new CodeStyleSettingPresentation("SPACE_AFTER_COMMA_IN_TYPE_ARGUMENTS", ApplicationBundle.message("checkbox.spaces.after.comma"))));

    result.put(new SettingsGroup(SPACES_IN_TYPE_ARGUMENTS),
               List.of(new CodeStyleSettingPresentation("SPACE_BEFORE_TYPE_PARAMETER_LIST", ApplicationBundle.message("checkbox.spaces.before.opening.angle.bracket"))));

    result.put(new SettingsGroup(SPACES_IN_TYPE_PARAMETERS), List.of());

    result.put(new SettingsGroup(SPACES_OTHER), List.of(new CodeStyleSettingPresentation("SPACE_BEFORE_COMMA", ApplicationBundle.message("checkbox.spaces.before.comma")),
    ...
    result = new LinkedHashMap<>();
    result.put(new SettingsGroup(null), List.of(new CodeStyleBoundedIntegerSettingPresentation("RIGHT_MARGIN", ApplicationBundle.message("editbox.right.margin.columns"), 0, 999, -1,
                                                ...
                                                new CodeStyleSelectSettingPresentation("WRAP_ON_TYPING", ApplicationBundle.message("wrapping.wrap.on.typing"), WRAP_ON_TYPING_VALUES,
                                                                                       WRAP_ON_TYPING_OPTIONS), new CodeStyleSoftMarginsPresentation()));

    result.put(new SettingsGroup(WRAPPING_KEEP), List.of(new CodeStyleSettingPresentation("KEEP_LINE_BREAKS", ApplicationBundle.message("wrapping.keep.line.breaks")),
    ...
    result.put(new SettingsGroup(null), List.of(new CodeStyleSettingPresentation("WRAP_LONG_LINES", ApplicationBundle.message("wrapping.long.lines"))));

    result.put(new SettingsGroup(WRAPPING_COMMENTS), List.of(new CodeStyleSettingPresentation("WRAP_COMMENTS", ApplicationBundle.message("wrapping.comments.wrap.at.right.margin"))));

    result.put(new SettingsGroup(WRAPPING_BRACES),
               List.of(new CodeStyleSelectSettingPresentation("CLASS_BRACE_STYLE", ApplicationBundle.message("wrapping.brace.placement.class.declaration"), BRACE_PLACEMENT_VALUES,
                                                              BRACE_PLACEMENT_OPTIONS),
                       new CodeStyleSelectSettingPresentation("METHOD_BRACE_STYLE", ApplicationBundle.message("wrapping.brace.placement.method.declaration"), BRACE_PLACEMENT_VALUES,
                                                              BRACE_PLACEMENT_OPTIONS),
    ...
    result.put(new SettingsGroup(WRAPPING_EXTENDS_LIST), List.of(new CodeStyleSettingPresentation("ALIGN_MULTILINE_EXTENDS_LIST", ApplicationBundle.message("wrapping.align.when.multiline"))));
    ...
    result.put(new SettingsGroup(WRAPPING_THROWS_LIST), List.of(new CodeStyleSettingPresentation("ALIGN_MULTILINE_THROWS_LIST", ApplicationBundle.message("wrapping.align.when.multiline")),
    ...
    result.put(new SettingsGroup(WRAPPING_METHOD_PARAMETERS), List.of(new CodeStyleSettingPresentation("ALIGN_MULTILINE_PARAMETERS", ApplicationBundle.message("wrapping.align.when.multiline")),
    ...
    result.put(new SettingsGroup(WRAPPING_METHOD_ARGUMENTS_WRAPPING),
               List.of(new CodeStyleSettingPresentation("ALIGN_MULTILINE_PARAMETERS_IN_CALLS", ApplicationBundle.message("wrapping.align.when.multiline")),
    ...
    result.put(new SettingsGroup(WRAPPING_METHOD_PARENTHESES),
               List.of(new CodeStyleSettingPresentation("ALIGN_MULTILINE_METHOD_BRACKETS", ApplicationBundle.message("wrapping.align.when.multiline"))));

    putGroupTop(result, "METHOD_CALL_CHAIN_WRAP", WRAPPING_CALL_CHAIN, WRAP_VALUES, WRAP_OPTIONS);
    result.put(new SettingsGroup(WRAPPING_CALL_CHAIN),
               List.of(new CodeStyleSettingPresentation("WRAP_FIRST_METHOD_IN_CALL_CHAIN", ApplicationBundle.message("wrapping.chained.method.call.first.on.new.line")),
                       new CodeStyleSettingPresentation("ALIGN_MULTILINE_CHAINED_METHODS", ApplicationBundle.message("wrapping.align.when.multiline"))));

    result.put(new SettingsGroup(WRAPPING_IF_STATEMENT),
               List.of(new CodeStyleSelectSettingPresentation("IF_BRACE_FORCE", ApplicationBundle.message("wrapping.force.braces"), BRACE_VALUES, BRACE_OPTIONS),
    ...
    result.put(new SettingsGroup(WRAPPING_FOR_STATEMENT), List.of(new CodeStyleSettingPresentation("ALIGN_MULTILINE_FOR", ApplicationBundle.message("wrapping.align.when.multiline")),
                                                                  new CodeStyleSettingPresentation("FOR_STATEMENT_LPAREN_ON_NEXT_LINE", ApplicationBundle.message("wrapping.new.line.after.lpar")),
    ...
    result.put(new SettingsGroup(WRAPPING_WHILE_STATEMENT),
               List.of(new CodeStyleSelectSettingPresentation("WHILE_BRACE_FORCE", ApplicationBundle.message("wrapping.force.braces"), BRACE_VALUES, BRACE_OPTIONS)));

    result.put(new SettingsGroup(WRAPPING_DOWHILE_STATEMENT),
               List.of(new CodeStyleSelectSettingPresentation("DOWHILE_BRACE_FORCE", ApplicationBundle.message("wrapping.force.braces"), BRACE_VALUES, BRACE_OPTIONS),
                       new CodeStyleSettingPresentation("WHILE_ON_NEW_LINE", ApplicationBundle.message("wrapping.while.on.new.line"))));

    result.put(new SettingsGroup(WRAPPING_SWITCH_STATEMENT), List.of(new CodeStyleSettingPresentation("INDENT_CASE_FROM_SWITCH", ApplicationBundle.message("wrapping.indent.case.from.switch")),
                                                                     new CodeStyleSettingPresentation("INDENT_BREAK_FROM_CASE", ApplicationBundle.message("wrapping.indent.break.from.case")),
                                                                     new CodeStyleSettingPresentation("CASE_STATEMENT_ON_NEW_LINE",
                                                                                                      ApplicationBundle.message("wrapping.case.statements.on.one.line"))));

    putGroupTop(result, "RESOURCE_LIST_WRAP", WRAPPING_TRY_RESOURCE_LIST, WRAP_VALUES, WRAP_OPTIONS);
    result.put(new SettingsGroup(WRAPPING_TRY_RESOURCE_LIST), List.of(new CodeStyleSettingPresentation("ALIGN_MULTILINE_RESOURCES", ApplicationBundle.message("wrapping.align.when.multiline")),
                                                                      new CodeStyleSettingPresentation("RESOURCE_LIST_LPAREN_ON_NEXT_LINE", ApplicationBundle.message("wrapping.new.line.after.lpar")),
                                                                      new CodeStyleSettingPresentation("RESOURCE_LIST_RPAREN_ON_NEXT_LINE", ApplicationBundle.message("wrapping.rpar.on.new.line"))));

    result.put(new SettingsGroup(WRAPPING_TRY_STATEMENT), List.of(new CodeStyleSettingPresentation("CATCH_ON_NEW_LINE", ApplicationBundle.message("wrapping.catch.on.new.line")),
    ...
    result.put(new SettingsGroup(WRAPPING_BINARY_OPERATION), List.of(new CodeStyleSettingPresentation("ALIGN_MULTILINE_BINARY_OPERATION", ApplicationBundle.message("wrapping.align.when.multiline")),
    ...
    result.put(new SettingsGroup(WRAPPING_ASSIGNMENT), List.of(new CodeStyleSettingPresentation("ALIGN_MULTILINE_ASSIGNMENT", ApplicationBundle.message("wrapping.align.when.multiline")),
    ...
    result.put(new SettingsGroup(WRAPPING_FIELDS_VARIABLES_GROUPS),
               List.of(new CodeStyleSettingPresentation("ALIGN_GROUP_FIELD_DECLARATIONS", ApplicationBundle.message("wrapping.align.fields.in.columns")),
    ...
    result.put(new SettingsGroup(WRAPPING_TERNARY_OPERATION), List.of(new CodeStyleSettingPresentation("ALIGN_MULTILINE_TERNARY_OPERATION", ApplicationBundle.message("wrapping.align.when.multiline")),
    ...
    result.put(new SettingsGroup(WRAPPING_ARRAY_INITIALIZER),
               List.of(new CodeStyleSettingPresentation("ALIGN_MULTILINE_ARRAY_INITIALIZER_EXPRESSION", ApplicationBundle.message("wrapping.align.when.multiline")),
    ...
    result.put(new SettingsGroup(WRAPPING_MODIFIER_LIST), List.of(new CodeStyleSettingPresentation("MODIFIER_LIST_WRAP", ApplicationBundle.message("wrapping.after.modifier.list"))));
    ...
    result.put(new SettingsGroup(WRAPPING_ASSERT_STATEMENT),
               List.of(new CodeStyleSettingPresentation("ASSERT_STATEMENT_COLON_ON_NEXT_LINE", ApplicationBundle.message("wrapping.colon.signs.on.next.line"))));
    ...
    result = new LinkedHashMap<>();
    result.put(new SettingsGroup(null), List.of(new CodeStyleSettingPresentation("INDENT_SIZE", ApplicationBundle.message("editbox.indent.indent"))));
    result.put(new SettingsGroup(null), List.of(new CodeStyleSettingPresentation("CONTINUATION_INDENT_SIZE", ApplicationBundle.message("editbox.indent.continuation.indent"))));
    result.put(new SettingsGroup(null), List.of(new CodeStyleSettingPresentation("TAB_SIZE", ApplicationBundle.message("editbox.indent.tab.size"))));
