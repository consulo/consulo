...
public abstract class TaskCompletionTest extends LightPlatformCodeInsightFixtureTestCase
{
	...
	{
		configureFile("<caret>");
		configureRepository(new LocalTaskImpl("TEST-002", "Test task 2"), new LocalTaskImpl("TEST-003", "Test task 1"), new LocalTaskImpl("TEST-001", "Test task 1"), new LocalTaskImpl("TEST-004",
				"Test task 1"));
