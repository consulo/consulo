...
public final class EnvironmentUtil {
    ...
    public static boolean isValidName(@Nullable String name) {
        return name != null && !name.isEmpty() && name.indexOf('\0') == -1 && name.indexOf(
            '=',
            Platform.current().os().isWindows() ? 1 : 0
        ) == -1;
    }
    ...
    public static class ShellEnvReader {
        ...
        public final Map<String, String> readShellEnv(@Nullable Path file, @Nullable Map<String, String> additionalEnvironment)
            throws IOException {
         ...
         */
        protected final Map.Entry<String, Map<String, String>> runProcessAndReadOutputAndEnvs(
            List<String> command,
