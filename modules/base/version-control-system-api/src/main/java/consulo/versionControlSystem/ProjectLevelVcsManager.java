...
public abstract class ProjectLevelVcsManager {
    ...
    public abstract void iterateVfUnderVcsRoot(VirtualFile file, Predicate<VirtualFile> processor);
    ...
    public static ProjectLevelVcsManager getInstance(Project project) {
        return project.getInstance(ProjectLevelVcsManager.class);
    }
    ...
    public static ProjectLevelVcsManager getInstanceChecked(Project project) {
        return project.getApplication().runReadAction((Supplier<ProjectLevelVcsManager>) () -> {
    ...
    public abstract void iterateVcsRoot(VirtualFile root, Predicate<FilePath> iterator);

    public abstract void iterateVcsRoot(
        VirtualFile root,
        Predicate<FilePath> iterator,
