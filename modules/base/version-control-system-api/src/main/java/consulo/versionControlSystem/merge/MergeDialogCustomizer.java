...
public class MergeDialogCustomizer {
    ...
    public @Nullable String getMergeWindowTitle(VirtualFile file) {
        return VcsLocalize.multipleFileMergeRequestTitle(FileUtil.toSystemDependentName(file.getPresentableUrl())).get();
    }
    ...
    public @Nullable String getLeftPanelTitle(VirtualFile file) {
        return VcsLocalize.mergeVersionTitleLocalChanges().get();
    }
    ...
    public @Nullable String getCenterPanelTitle(VirtualFile file) {
        return VcsLocalize.mergeVersionTitleMergeResult().get();
    }
    ...
    public @Nullable String getRightPanelTitle(VirtualFile file, VcsRevisionNumber lastRevisionNumber) {
        return lastRevisionNumber != null
            ? VcsLocalize.mergeVersionTitleLastVersionNumber(lastRevisionNumber.asString()).get()
            : VcsLocalize.mergeVersionTitleLastVersion().get();
    }
    ...
    public String getMultipleFileDialogTitle() {
        return VcsLocalize.multipleFileMergeTitle().get();
    }
}
