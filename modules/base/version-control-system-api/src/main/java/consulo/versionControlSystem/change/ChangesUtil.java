...
public class ChangesUtil {
    ...
    public static List<VirtualFile> getAfterRevisionsFiles(Stream<Change> changes) {
        return getAfterRevisionsFiles(changes, false);
    }

    public static List<VirtualFile> getAfterRevisionsFiles(Stream<Change> changes, boolean refresh) {
    ...
    public static FilePath getLocalPath(Project project, FilePath filePath) {
        // check if the file has just been renamed (IDEADEV-15494)
        ThrowableSupplier<Change, RuntimeException> action = () -> {
