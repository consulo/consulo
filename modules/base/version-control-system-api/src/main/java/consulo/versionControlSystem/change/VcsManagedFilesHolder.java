...
public interface VcsManagedFilesHolder extends FilePathHolder {
  ExtensionPointName<VcsUnversionedFilesHolderProvider> VCS_UNVERSIONED_FILES_HOLDER_EP = ExtensionPointName.create(VcsUnversionedFilesHolderProvider.class);

  ExtensionPointName<VcsIgnoredFilesHolderProvider> VCS_IGNORED_FILES_HOLDER_EP = new ExtensionPointName<>(VcsIgnoredFilesHolderProvider.class);
