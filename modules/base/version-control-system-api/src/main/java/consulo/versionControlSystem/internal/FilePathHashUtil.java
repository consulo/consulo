...
public class FilePathHashUtil {
  public static int pathHashCode(boolean caseSensitive, String path) {
    return pathHashCode(caseSensitive, path, 0, path.length(), 0);
  }

  public static int pathHashCode(boolean caseSensitive, String path, int offset1, int offset2, int prefixHash) {
    if (caseSensitive) {
