...
public class VcsRange {
  ...
  public VcsRange(int line1, int line2, int vcsLine1, int vcsLine2) {
    this(line1, line2, vcsLine1, vcsLine2, null);
  }

  public VcsRange(int line1, int line2, int vcsLine1, int vcsLine2, @Nullable List<InnerRange> innerRanges) {
