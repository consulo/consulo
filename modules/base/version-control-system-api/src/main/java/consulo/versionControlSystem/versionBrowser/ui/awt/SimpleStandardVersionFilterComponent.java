 ...
 * @since 27-Jul-24
 */
public class SimpleStandardVersionFilterComponent extends StandardVersionFilterComponent<ChangeBrowserSettings> {
  public SimpleStandardVersionFilterComponent(boolean showDateFilter) {
