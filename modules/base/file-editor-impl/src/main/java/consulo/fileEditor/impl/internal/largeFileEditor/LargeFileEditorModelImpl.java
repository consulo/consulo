...
import consulo.fileEditor.internal.largeFileEditor.LargeFileEditorModel;
import consulo.fileEditor.internal.largeFileEditor.Page;
import consulo.fileEditor.internal.largeFileEditor.ReadingPageResultHandler;
...
public final class LargeFileEditorModelImpl implements LargeFileEditorModel {
    private static final Logger LOG = Logger.getInstance(LargeFileEditorModelImpl.class);
    ...
    private static Editor createSpecialEditor(Document document, Project project) {
        ...
        editor.putUserData(StatusBarWidgetKeys.POSITION_DISABLER, new Object());
