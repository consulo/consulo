...
@ExtensionImpl
public final class FileDocumentAsyncFileListener implements AsyncFileListener {
    private final FileDocumentManagerImpl myFileDocumentManager;

    private final FileTypeRegistry myFileTypeRegistry;

    @Inject
    FileDocumentAsyncFileListener(FileTypeRegistry fileTypeRegistry, FileDocumentManager fileDocumentManager) {
        myFileTypeRegistry = fileTypeRegistry;
        myFileDocumentManager = (FileDocumentManagerImpl) fileDocumentManager;
    }
