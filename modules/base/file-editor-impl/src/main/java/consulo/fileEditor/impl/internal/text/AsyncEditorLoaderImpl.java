 ...
 */
public class AsyncEditorLoaderImpl implements AsyncEditorLoader {
        ...
        ReadAction.nonBlocking(() -> {
            ...
            Runnable runnable = ProgressManager.getInstance().computePrioritized(() -> {
                try {
                    ...
                    Logger.getInstance(AsyncEditorLoaderImpl.class).error("Error during async editor loading", e);
                    return null;
                }
            });
