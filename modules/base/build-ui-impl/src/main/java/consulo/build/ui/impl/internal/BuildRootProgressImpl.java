...
public class BuildRootProgressImpl extends BuildProgressImpl {
  ...
  public BuildProgress<BuildProgressDescriptor> finish(
    ...
    assertStarted();
    FinishEvent event =
      new FinishBuildEventImpl(getId(), null, timeStamp, message, new SuccessResultImpl(isUpToDate));
  ...
  public BuildRootProgressImpl fail(long timeStamp, @Nonnull @BuildEventsNls.Message String message) {
    ...
    FinishBuildEvent event =
      new FinishBuildEventImpl(getId(), null, timeStamp, message, new FailureResultImpl());
    myListener.onEvent(getBuildId(), event);
    return this;
  }
  ...
  public BuildRootProgressImpl cancel(long timeStamp, @Nonnull String message) {
    assertStarted();
    FinishBuildEventImpl event =
      new FinishBuildEventImpl(getId(), null, timeStamp, message, new SkippedResultImpl());
    myListener.onEvent(getBuildId(), event);
    return this;
  }
}
