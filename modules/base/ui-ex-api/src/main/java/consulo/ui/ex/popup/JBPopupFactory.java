 ...
 * <ul>
 * <li>
 * <p>{@link Balloon} interface (implemented in {@link consulo.ide.impl.idea.ui.BalloonImpl BalloonImpl})</p>
 ...
 * </li>
 * <li>
 * <p>{@link consulo.ide.impl.idea.ide.IdeTooltip IdeTooltip} and {@link consulo.ide.impl.idea.ide.IdeTooltipManager IdeTooltipManager}</p>
 ...
 * <ul>
 * <li>
 * <p>{@link consulo.ide.impl.idea.ui.Hint Hint} interface (implemented in {@link consulo.ide.impl.idea.ui.LightweightHint LightweightHint})</p>
 * <p>By default, if content fits the layered pane, tries to use lightweight components to display it (either using
 * {@link consulo.ide.impl.idea.ide.IdeTooltipManager IdeTooltipManager}, or by directly adding content to the layered pane).
 ...
 * <p>Mostly used for showing hints in editor (works via {@link consulo.ide.impl.idea.ui.LightweightHint LightweightHint}), but also has a method to show a hint at arbitrary
...
public abstract class JBPopupFactory {
  ...
  @Nonnull
  public abstract BalloonBuilder createHtmlTextBalloonBuilder(@Nonnull String htmlContent, NotificationType messageType, @Nullable HyperlinkListener listener);
