...
public class SimpleColoredText implements ColoredTextContainer {
    private final List<String> myTexts = new ArrayList<>(3);
    private final List<SimpleTextAttributes> myAttributes = new ArrayList<>(3);
    ...
    public List<SimpleTextAttributes> getAttributes() {
