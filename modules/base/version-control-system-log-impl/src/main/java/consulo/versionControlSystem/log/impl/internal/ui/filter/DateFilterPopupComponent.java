...
import consulo.versionControlSystem.log.impl.internal.data.VcsLogDateFilterImpl;
...
class DateFilterPopupComponent extends FilterPopupComponent<VcsLogDateFilter> {
    ...
    @Override
    protected String getText(VcsLogDateFilter filter) {
        ...
        if (after != null && before != null) {
            ...
            return FilterPopupComponent.ALL;
        }
    }
    ...
    private class SelectAction extends DumbAwareAction {
        ...
        public void actionPerformed(AnActionEvent e) {
            ...
            if (DialogWrapper.OK_EXIT_CODE == db.show()) {
                ...
                VcsLogDateFilter filter =
                    new VcsLogDateFilterImpl(after > 0 ? new Date(after) : null, before > 0 ? new Date(before) : null);
