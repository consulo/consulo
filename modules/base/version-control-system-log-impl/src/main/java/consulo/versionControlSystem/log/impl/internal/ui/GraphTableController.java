...
import consulo.versionControlSystem.log.impl.internal.paint.PositionUtil;
import consulo.versionControlSystem.log.impl.internal.ui.render.GraphCommitCellRenderer;
import consulo.versionControlSystem.log.impl.internal.ui.render.SimpleColoredComponentLinkMouseListener;
...
public class GraphTableController {
    ...
    public void handleGraphAnswer(@Nullable GraphAnswer<Integer> answer,
        ...
        if (answer.getCommitToJump() != null) {
            ...
            if (e != null) {
                showToolTip(getArrowTooltipText(answer.getCommitToJump(), row), e);
            }
        }
    }
    ...
    private boolean showTooltip(int row, int column, @Nonnull Point point, boolean now) {
        ...
        if (tipComponent != null) {
            ...
            VersionControlSystemLogInternal.getInstance().showToolTip(myTable, point, tipComponent, now);
            return true;
        }
        return false;
    }
