...
import consulo.versionControlSystem.internal.TreeModelBuilderUtil;
...
public class VirtualFileListCellRenderer extends ColoredListCellRenderer {
  ...
  protected void customizeCellRenderer(JList list, Object value, int index, boolean selected, boolean hasFocus) {
    FilePath path = TreeModelBuilderUtil.getPathForObject(value);
    renderIcon(path);
    FileStatus fileStatus = myIgnoreFileStatus ? FileStatus.NOT_CHANGED : getStatus(value, path);
