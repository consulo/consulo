...
public class TranslationCompilerFilesMonitorVfsListener implements AsyncFileListener {
  ...
  @Inject
  TranslationCompilerFilesMonitorVfsListener(Provider<TranslatingCompilerFilesMonitor> monitorProvider,
        ...
        try {
          ...
          if (outputInfo != null) {
            ...
            if (srcFile != null) {
              ...
              if (srcInfo != null) {
                final boolean srcWillBeDeleted = VirtualFileUtil.isAncestor(eventFile, srcFile, false);
          ...
          if (srcInfo != null) {
            final Set<Integer> projects = srcInfo.getProjectIds();
            if (!projects.isEmpty()) {
              final TranslatingCompilerFilesMonitorImpl.ScheduleOutputsForDeletionProc deletionProc =
