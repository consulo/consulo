...
public abstract class ShowSettingsUtil implements ProjectStructureSettingsUtil {
    ...
    @RequiredUIAccess
    public abstract <T extends UnnamedConfigurable> CompletableFuture<Void> showAndSelect(
    ...
    @RequiredUIAccess
    public abstract CompletableFuture<Void> showProjectStructureDialog(
        Project project,
        @RequiredUIAccess Consumer<ProjectStructureSelector> consumer
    );
    ...
    @DeprecationInfo("Show #showAndSelect()")
    @RequiredUIAccess
    public abstract CompletableFuture<Void> editConfigurable(
