...
public class FontPreferencesImpl implements ModifiableFontPreferences {
    ...
    public FontPreferencesImpl(FontPreferencesManager fontPreferencesManager) {
     ...
     * {@link FontPreferencesManager#getFallbackName(String, int, EditorColorsScheme) a font family unavailable at current environment}
    ...
    public void register(String fontFamily, int size) {
        String fallbackFontFamily = myFontPreferencesManager.getFallbackName(fontFamily, size, null);
    ...
    public void addFontFamily(String fontFamily) {
        String fallbackFontFamily = myFontPreferencesManager.getFallbackName(fontFamily, FontPreferences.DEFAULT_FONT_SIZE, null);
        if (!myRealFontFamilies.contains(fontFamily)) {
            myRealFontFamilies.add(fontFamily);
        }
        String effectiveFontFamily = fallbackFontFamily == null ? fontFamily : fallbackFontFamily;
    ...
    public boolean equals(Object o) {
        ...
        if (!myRealFontFamilies.equals(that.myRealFontFamilies)) {
            return false;
        }
        for (String fontFamily : myRealFontFamilies) {
