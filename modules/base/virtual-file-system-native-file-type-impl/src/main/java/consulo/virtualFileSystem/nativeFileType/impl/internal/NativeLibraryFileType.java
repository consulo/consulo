 ...
 * @since 2026-03-31
 */
public class NativeLibraryFileType implements FileType {
    public static final NativeLibraryFileType INSTANCE = new NativeLibraryFileType();
    ...
    public LocalizeValue getDisplayName() {
        return FileTypeLocalize.nativeFileTypeLibrary();
    }
