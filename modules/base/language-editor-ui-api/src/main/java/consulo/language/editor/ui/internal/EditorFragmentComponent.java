...
public class EditorFragmentComponent extends JPanel {
    ...
    private void doInit(Component anchorComponent, EditorEx editor, int startLine, int endLine, boolean showFolding, boolean showGutter) {
        ...
        try {
            ...
            int widthAdjustment = newRendering ? CodeEditorInternalHelper.getInstance().getSpaceWidth(editor) : 0;
            ...
            DesktopAntialiasingTypeUtil.setupAntialiasing(textGraphics);
            ...
            if (showGutter) {
                ...
                DesktopAntialiasingTypeUtil.setupAntialiasing(markerGraphics);
    ...
    public static LightweightHint showEditorFragmentHintAt(
        ...
        LightweightHint hint = Application.get().getInstance(LightweightHintFactory.class).create(fragmentComponent);
        hint.setForceLightweightPopup(true);
        hint.setAsyncHide(true);
