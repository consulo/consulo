...
public class OrderRootsEnumeratorImpl implements OrderRootsEnumerator {
    private static final BiFunction<ContentEntry, Predicate<ContentFolderTypeProvider>, VirtualFile[]> ourSourcesToFileFunc =
        new BiFunction<>() {
            @Nonnull
            @Override
        ...
        if (type.equals(SourcesOrderRootType.getInstance())) {
            if (includeProduction) {
                Predicate<ContentFolderTypeProvider> predicate =
                    includeTests ? LanguageContentFolderScopes.productionAndTest() : LanguageContentFolderScopes.production();
                ...
                if (rootsProcessor != null) {
                    rootsProcessor.processFiles(
                        rootModel,
                        LanguageContentFolderScopes.test(),
