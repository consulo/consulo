...
public class AllIcons {
  ...
  public static class Ide {
    ...
    public static class Notification {
      ...
      public static final Image ErrorEvents = PlatformIconGroup.ideNotificationErrorEvents(); // 16x16
  ...
  public static class Nodes {
    ...
    public static final Image AbstractStruct = PlatformIconGroup.nodesAbstractStruct(); // 16x16
    public static final Image Advice = PlatformIconGroup.nodesAdvice(); // 16x16
    ...
    public static final Image Aspect = PlatformIconGroup.nodesAspect(); // 14x14
    ...
    public static final Image Cvs_roots = PlatformIconGroup.nodesCvs_roots(); // 16x16
    public static final Image DataColumn = PlatformIconGroup.nodesDataColumn(); // 16x16
    public static final Image DataSchema = PlatformIconGroup.nodesDataSchema(); // 16x16
    public static final Image DataSource = PlatformIconGroup.nodesDataSource(); // 16x16
    public static final Image DataTables = PlatformIconGroup.nodesDataTables(); // 16x16
    public static final Image DataView = PlatformIconGroup.nodesDataView(); // 16x16
    ...
    public static final Image Ejb = PlatformIconGroup.nodesEjb(); // 16x16
    public static final Image EjbBusinessMethod = PlatformIconGroup.nodesEjbBusinessMethod(); // 16x16
    public static final Image EjbCmpField = PlatformIconGroup.nodesEjbCmpField(); // 16x16
    public static final Image EjbCmrField = PlatformIconGroup.nodesEjbCmrField(); // 16x16
    public static final Image EjbCreateMethod = PlatformIconGroup.nodesEjbCreateMethod(); // 16x16
    public static final Image EjbFinderMethod = PlatformIconGroup.nodesEjbFinderMethod(); // 16x16
    public static final Image EjbPrimaryKeyClass = PlatformIconGroup.nodesEjbPrimaryKeyClass(); // 16x16
    public static final Image EjbReference = PlatformIconGroup.nodesEjbReference(); // 16x16
    ...
    public static final Image FieldPK = PlatformIconGroup.nodesFieldPK(); // 16x16
