...
public interface MultiHostRegistrar {
   ...
   */
  @Nonnull /*this*/
  default MultiHostRegistrar startInjecting(@Nonnull Language language) {
  ...
  @Nonnull
  default /*this*/
  MultiHostRegistrar startInjecting(@Nonnull Language language, @Nullable String extension) {
