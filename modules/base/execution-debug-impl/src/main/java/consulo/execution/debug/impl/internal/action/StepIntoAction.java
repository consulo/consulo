 ...
 * @author nik
 */
@ActionImpl(id = XDebuggerActions.STEP_INTO)
public class StepIntoAction extends XDebuggerActionBase {
    ...
    public StepIntoAction() {
        super(
            XDebuggerLocalize.actionStepIntoText(),
            XDebuggerLocalize.actionStepIntoDescription(),
            ExecutionDebugIconGroup.actionTraceinto()
        );
    }
