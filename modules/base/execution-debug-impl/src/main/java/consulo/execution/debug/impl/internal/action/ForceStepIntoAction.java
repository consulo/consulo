 ...
 * @author nik
 */
@ActionImpl(id = XDebuggerActions.FORCE_STEP_INTO)
public class ForceStepIntoAction extends XDebuggerActionBase {
    ...
    public ForceStepIntoAction() {
        super(
            XDebuggerLocalize.actionForceStepIntoText(),
            XDebuggerLocalize.actionForceStepIntoDescription(),
            ExecutionDebugIconGroup.actionForcestepinto()
        );
    }
