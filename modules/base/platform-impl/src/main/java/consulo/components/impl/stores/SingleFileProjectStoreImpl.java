 ...
 * @since 25/12/2021
 */
public abstract class SingleFileProjectStoreImpl extends ProjectStoreImpl {
  @Inject
  public SingleFileProjectStoreImpl(@Nonnull Project project, @Nonnull ProjectPathMacroManager pathMacroManager, @Nonnull Provider<ApplicationDefaultStoreCache> applicationDefaultStoreCache) {
  ...
  @Override
  @Nonnull
  protected SingleFileProjectImpl getProject() {
    return (SingleFileProjectImpl)super.getProject();
  }

  @Nonnull
  @Override
  protected StateStorageManager createStateStorageManager() {
    final XmlElementStorage storage = new XmlElementStorage("", RoamingType.DISABLED, myPathMacroManager.createTrackingSubstitutor(), getRootTagName(), null) {
      @Override
      @Nullable
