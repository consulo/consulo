...
public class DesktopEditorErrorPanel extends JComponent implements UISettingsListener {
  ...
  public DesktopEditorErrorPanel(DesktopEditorImpl editor, DesktopEditorMarkupModelImpl markupModel) {
    myEditor = editor;
  ...
  public void recalcEditorDimensions() {
    ...
    myEditorScrollbarTop = renderer == null ? 0 : renderer.getSquareSize();
  ...
  public void mouseMoved(MouseEvent e) {
    ...
    ErrorStripeRenderer renderer = myMarkupModel.getErrorStripeRenderer();
    if (renderer != null && e.getY() < renderer.getSquareSize()) {
  ...
  private void showTrafficLightTooltip(MouseEvent e) {
    if (myTrafficTooltipRenderer == null) {
      myTrafficTooltipRenderer = myMarkupModel.getErrorStripTooltipRendererProvider().createTrafficTooltipRenderer(() -> {
