...
public abstract class Invoker implements Disposable {
  ...
  @Nonnull
  public static Invoker forEventDispatchThread(@Nonnull Disposable parent) {
    return new EDT(parent);
  }

  @Nonnull
  public static Invoker forBackgroundPoolWithReadAction(@Nonnull Disposable parent) {
    return new Background(parent, ThreeState.YES, 8);
  }

  @Nonnull
  public static Invoker forBackgroundThreadWithReadAction(@Nonnull Disposable parent) {
    return new Background(parent, ThreeState.YES, 1);
  }

  @Nonnull
  public static Invoker forBackgroundThreadWithoutReadAction(@Nonnull Disposable parent) {
