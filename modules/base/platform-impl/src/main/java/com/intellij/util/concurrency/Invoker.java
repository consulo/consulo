...
public abstract class Invoker implements Disposable {
   ...
   */
  @Deprecated
  public final void invokeLaterIfNeeded(@Nonnull Runnable task) {
   ...
   * @param attempt an attempt to run the specified task
   */
  private void offerRestart(@Nonnull Runnable task, @Nonnull AsyncPromise<?> promise, int attempt) {
   ...
   */
  private boolean canRestart(@Nonnull Runnable task, @Nonnull AsyncPromise<?> promise, int attempt) {
   ...
   * or if the specified task is obsolete
   */
  private boolean canInvoke(@Nonnull Runnable task, @Nonnull AsyncPromise<?> promise) {
    if (promise.isDone()) {
