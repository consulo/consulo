...
public abstract class BuildableRootsChangeRescanningInfo {
    ...
    public abstract BuildableRootsChangeRescanningInfo addModule(Module module);

    public abstract BuildableRootsChangeRescanningInfo addInheritedSdk();

    public abstract BuildableRootsChangeRescanningInfo addSdk(Sdk sdk);

    public abstract BuildableRootsChangeRescanningInfo addLibrary(Library library);

    public abstract BuildableRootsChangeRescanningInfo addOrderEntry(OrderEntry orderEntry);
