...
public abstract class GroupedElementsRenderer {
    ...
    protected final JComponent configureComponent(String text,
                                                  String tooltip,
                                                  Image icon,
                                                  Image disabledIcon,
                                                  boolean isSelected,
        ...
        myRendererComponent.setBackground(isSelected ? getSelectionBackground() : getBackground());
    ...
    protected class MyComponent extends JPanel {
