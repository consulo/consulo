...
public class EmptyIcon extends JBUI.CachingScalableJBIcon<EmptyIcon> {
    ...
    static {
        JBUI.addPropertyChangeListener(JBUI.USER_SCALE_FACTOR_PROPERTY, evt -> cache.clear());
    }
    ...
    public boolean equals(Object o) {
        return this == o
            || o instanceof EmptyIcon that
            && scaleVal(height, JBUI.ScaleType.PIX_SCALE) == that.scaleVal(that.height, JBUI.ScaleType.PIX_SCALE)
            && scaleVal(width, JBUI.ScaleType.PIX_SCALE) == that.scaleVal(that.width, JBUI.ScaleType.PIX_SCALE);
    }
