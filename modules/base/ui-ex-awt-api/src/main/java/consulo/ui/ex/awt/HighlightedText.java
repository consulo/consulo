...
public class HighlightedText {
    ...
    public boolean equals(Object o) {
        ...
        if (!myBuffer.equals(highlightedText.myBuffer)) {
            return false;
        }
        if (!myHighlightedRegions.equals(highlightedText.myHighlightedRegions)) {
            return false;
        }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(myBuffer, myHighlightedRegions);
    }
