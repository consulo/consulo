...
public class WelcomeProjectStoreImpl extends ProjectStoreImpl {
    ...
    @Inject
    public WelcomeProjectStoreImpl(@Nonnull Project project,
                                   @Nonnull Provider<ProjectPathMacroManager> pathMacroManager,
                                   @Nonnull Provider<ApplicationDefaultStoreCache> applicationDefaultStoreCache) {
    ...
    protected StateStorageManager createStateStorageManager() {
        ...
        return new StateStorageManager() {
            ...
            @Nonnull
            @Override
            public String buildFileSpec(@Nonnull Storage storage1) {
