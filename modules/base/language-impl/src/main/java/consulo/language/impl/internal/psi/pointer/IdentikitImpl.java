...
public abstract class IdentikitImpl implements Identikit {
  ...
  @Nonnull
  static ByTypeImpl fromTypes(@Nonnull Class<? extends PsiElement> elementClass, @Nullable IElementType elementType, @Nonnull Language fileLanguage) {
  ...
  public static class ByTypeImpl extends IdentikitImpl implements Identikit.ByType {
    ...
    private ByTypeImpl(@Nonnull Class<? extends PsiElement> elementClass, @Nullable IElementType elementType, @Nonnull Language fileLanguage) {
