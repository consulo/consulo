...
public enum ShortNameType {
  LASTNAME("lastname", "Last Name"), FIRSTNAME("firstname", "First Name"), NONE("full", "Full name");
  ...
  boolean isSet() {
    return myId.equals(ApplicationPropertiesComponent.getInstance().getValue(KEY));
  }
