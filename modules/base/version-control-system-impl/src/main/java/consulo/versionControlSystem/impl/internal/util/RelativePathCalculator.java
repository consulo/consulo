...
public class RelativePathCalculator {
    ...
    public static LocalizeValue getMovedString(String beforeName, String afterName) {
        if (beforeName != null && afterName != null && !stringEqual(beforeName, afterName)) {
            ...
            return calculator.isRename()
                ? VcsLocalize.changeFileRenamedToText(calculator.getResult())
                : VcsLocalize.changeFileMovedToText(calculator.getResult());
        }
