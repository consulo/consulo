...
public class BaseRevisionTextPatchEP implements PatchEP {
  public final static Key<Boolean> ourPutBaseRevisionTextKey = Key.create("BaseRevisionTextPatchEP.ourPutBaseRevisionTextKey");
  public static final Key<List<FilePath>> ourBaseRevisionPaths = Key.create("BaseRevisionTextPatchEP.ourBaseRevisionPaths");
  public static final Key<Map<String, String>> ourStoredTexts = Key.create("BaseRevisionTextPatchEP.ourStoredTexts");
  ...
  public CharSequence provideContent(@Nonnull String path, CommitContext commitContext) {
    ...
    if (Boolean.TRUE.equals(commitContext.getUserData(ourPutBaseRevisionTextKey))) {
      ...
      FilePath filePathOn = VcsContextFactory.getInstance().createFilePathOn(file);
