...
public abstract class AbstractShowDiffAction extends AbstractVcsAction {
    ...
    public static void updateDiffAction(Presentation presentation, VcsContext vcsContext, VcsBackgroundableActions actionKey) {
    ...
    protected static AbstractVcs isEnabled(VcsContext vcsContext, @Nullable VcsBackgroundableActions actionKey) {
        ...
        if (actionKey != null) {
            BackgroundableActionEnabledHandler handler =
                ((ProjectLevelVcsManagerImpl) vcsManager).getBackgroundableActionHandler(actionKey);
