...
import consulo.language.editor.ui.internal.ComboEditorCompletionContributor;
    ...
    public ChangeListChooserPanel(Project project, @Nonnull Consumer<String> okEnabledListener) {
        ...
        myListPanel = new NewEditChangelistPanel(myProject) {
            ...
            protected void nameChanged(String errorMessage) {
                ...
                application.invokeLater(() -> updateDescription(), application.getCurrentModalityState());
        ...
        public MyEditorComboBox(Project project) {
            ...
            setEditor(new StringComboboxEditor(project, PlainTextFileType.INSTANCE, this) {
                ...
                protected void onEditorCreate(EditorEx editor) {
                    ...
                    getDocument().putUserData(ComboEditorCompletionContributor.CONTINUE_RUN_COMPLETION, true);
                }
            });
        }
