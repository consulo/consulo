...
public class VcsDirtyScopeVfsListener implements AsyncVfsEventsListener, Disposable {
  ...
  @Inject
  public VcsDirtyScopeVfsListener(@Nonnull Project project, @Nonnull AsyncVfsEventsPostProcessor asyncVfsEventsPostProcessor) {
    myProject = project;
    asyncVfsEventsPostProcessor.addListener(this, this);
  }
