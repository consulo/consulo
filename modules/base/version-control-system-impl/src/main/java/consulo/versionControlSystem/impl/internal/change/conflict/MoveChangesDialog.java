...
public class MoveChangesDialog extends DialogWrapper {
  ...
  public MoveChangesDialog(final Project project, Collection<Change> selected, final Set<ChangeList> changeLists, VirtualFile current) {
    ...
    boolean selectCurrent = ApplicationPropertiesComponent.getInstance().getBoolean(MOVE_CHANGES_CURRENT_ONLY);
  ...
  private void setSelected(boolean selected) {
    ...
    ApplicationPropertiesComponent.getInstance().setValue(MOVE_CHANGES_CURRENT_ONLY, selected);
  }
