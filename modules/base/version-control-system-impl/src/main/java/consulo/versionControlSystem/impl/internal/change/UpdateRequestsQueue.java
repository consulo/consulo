...
public final class UpdateRequestsQueue {
  ...
  public UpdateRequestsQueue(@Nonnull Project project,
                             ...
                             @Nonnull BooleanSupplier refreshDelegate,
                             @Nonnull BooleanSupplier fastTrackDelegate) {
    myProject = project;
  ...
  private void debug(@Nonnull String text, @Nonnull Runnable runnable) {
    if (LOG.isDebugEnabled()) {
      LOG.debug(String.format("%s. Runnable: %s, Project: %s", text, runnable, myProject));
    }
  }

  private void debug(@Nonnull String text) {
    if (LOG.isDebugEnabled()) {
