...
import consulo.versionControlSystem.impl.internal.change.shelf.RestoreShelvedChange;
 ...
 */
@ActionImpl(
    id = "Shelve.KeymapGroup",
    children = {
        @ActionRef(type = ShelveChangesAction.class),
        @ActionRef(id = "ShelveChanges.UnshelveWithDialog"),
        @ActionRef(type = RestoreShelvedChange.class),
        @ActionRef(type = ImportIntoShelfAction.class),
        @ActionRef(type = AnSeparator.class),
        @ActionRef(type = RenameShelvedChangeListAction.class),
        @ActionRef(type = AnSeparator.class),
        @ActionRef(type = DiffShelvedChangesAction.class),
    ...
    parents = @ActionParentRef(
        value = @ActionRef(id = "Vcs.KeymapGroup"),
        anchor = ActionRefAnchor.FIRST
    )
)
public class ShelveKeymapGroup extends DefaultActionGroup implements DumbAware {
    public ShelveKeymapGroup() {
        super(ActionLocalize.groupShelveKeymapgroupText(), false);
    }
}
