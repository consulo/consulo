...
public class InternalMultipleChangeListBrowser extends InternalChangesBrowserBase<Object> {
            ...
            new AnActionListener() {
                ...
                public void afterActionPerformed(AnAction action, DataContext dataContext, AnActionEvent event) {
                    if (moveAction.equals(action) || myMoveActionWithCustomShortcut != null && myMoveActionWithCustomShortcut.equals(action)) {
                        ...
                        UnversionedViewDialog.refreshChanges(myProject, InternalMultipleChangeListBrowser.this);
                    }
                }
            },
            this
    ...
    private void updateListsInChooser() {
        ...
        if (SwingUtilities.isEventDispatchThread()) {
            ...
            myProject.getApplication().invokeLater(runnable, Application.get().getModalityStateForComponent(this));
        }
    }
