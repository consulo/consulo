...
import consulo.versionControlSystem.contentAnnotation.ContentAnnotationCache;
...
public class ContentAnnotationCacheImpl implements ContentAnnotationCache {
  ...
  public void register(VirtualFile vf, VcsKey vcsKey, VcsRevisionNumber number, FileAnnotation fa) {
    ...
    long absoluteLimit = System.currentTimeMillis() - VcsContentAnnotationSettingsState.ourAbsoluteLimit;
