...
public abstract class BaseToolsPanel<T extends Tool> extends JPanel {
    ...
    protected BaseToolsPanel() {
        ...
        add(ToolbarDecorator.createDecorator(myTree).setPanelBorder(new EmptyBorder(0, 0, 0, 0)).setAddAction(new AnActionButtonRunnable() {
            @Override
            public void run(AnActionButton button) {
                ToolEditorDialog dlg = createToolEditorDialog(ExternalToolLocalize.toolsAddTitle());
                Tool tool = new Tool();
            ...
            public void actionPerformed(AnActionEvent e) {
                ...
                if (originalTool != null) {
                    ToolEditorDialog dlg = createToolEditorDialog(ExternalToolLocalize.toolsCopyTitle());
    ...
    private CheckedTreeNode findGroupNode(String group) {
        for (int i = 0; i < getTreeRoot().getChildCount(); i++) {
            ...
            if (Comparing.equal(group, g.getName())) {
                return node;
            }
        }
    ...
    private @Nullable Tool getSelectedTool() {
    ...
    private void removeSelected() {
        ...
        if (node != null) {
            int result = Messages.showYesNoDialog(
                this,
                ExternalToolLocalize.toolsDeleteConfirmation().get(),
    ...
    private void editSelected() {
        ...
        if (node != null && node.getUserObject() instanceof Tool) {
            ...
            if (selected != null) {
                ...
                ToolEditorDialog dlg = createToolEditorDialog(ExternalToolLocalize.toolsEditTitle());
    ...
    protected ToolEditorDialog createToolEditorDialog(LocalizeValue title) {
