...
public interface SMTestLocator {
   ...
   */
  @Nonnull
  default List<Location> getLocation(@Nonnull String protocol, @Nonnull String path, @Nullable String metainfo, @Nonnull Project project, @Nonnull GlobalSearchScope scope) {
