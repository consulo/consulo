...
public class TestsLocationProviderUtil {
   ...
   * @return
   */
  public static List<VirtualFile> findFilesClosestToTarget(@Nonnull final List<String> targetParentFolders, final List<FileInfo> candidates, final int minProximityThreshold) {
