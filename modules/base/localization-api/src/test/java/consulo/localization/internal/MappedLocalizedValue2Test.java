...
public class MappedLocalizedValue2Test {
    ...
    void testEqualsAndHashCode() {
        ...
        BiFunction<LocalizationManager, String, String> mapper1 = (manager, string) -> string + "bar";
        BiFunction<LocalizationManager, String, String> mapper2 = (manager, string) -> string + "baz";

        LocalizedValue value01 = new MappedLocalizedValue2(myManager, subValue0, mapper1);
        LocalizedValue value02 = new MappedLocalizedValue2(myManager, subValue0, mapper2);
        LocalizedValue value11 = new MappedLocalizedValue2(myManager, subValue1, mapper1);
        LocalizedValue value12 = new MappedLocalizedValue2(myManager, subValue1, mapper2);
        LocalizedValue value21 = new MappedLocalizedValue2(myManager, subValue2, mapper1);
        LocalizedValue value22 = new MappedLocalizedValue2(myManager, subValue2, mapper2);
