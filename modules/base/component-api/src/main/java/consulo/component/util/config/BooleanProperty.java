...
public class BooleanProperty extends ValueProperty<Boolean> {
  ...
  public boolean value(AbstractProperty.AbstractPropertyContainer container) {
    return get(container).booleanValue();
  }

  public void primSet(AbstractProperty.AbstractPropertyContainer container, boolean value) {
