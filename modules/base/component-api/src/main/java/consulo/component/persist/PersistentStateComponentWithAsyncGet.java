 ...
 * <p>
 * Only the save side is asynchronous here - {@link #loadState(Object)} is still invoked synchronously by the
 * store. Prefer {@link PersistentStateComponentAsync} for new code, which makes both directions asynchronous.
 *
 * @author VISTALL
 * @since 2026-03-02
 */
public interface PersistentStateComponentWithAsyncGet<T> extends PersistentStateComponent<T> {
