...
public class GlobalInspectionContextBase extends UserDataHolderBase implements GlobalInspectionContext {
  ...
  public boolean isToCheckMember(@Nonnull RefElement owner, @Nonnull InspectionProfileEntry tool) {
  ...
  public void initializeTools(@Nonnull List<Tools> outGlobalTools,
  ...
  protected List<Tools> getUsedTools() {
    ...
    Set<Tools> set = Sets.newHashSet(TOOLS_HASHING_STRATEGY);
    set.addAll(tools);
