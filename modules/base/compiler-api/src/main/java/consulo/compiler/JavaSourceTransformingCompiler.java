...
public interface JavaSourceTransformingCompiler extends Compiler {
     ...
     * @param file         a copy of original file to be transformed. If there are more than one transformer registered,
     *                     this copy may already contain transformations made by other transformers which were called before this one
