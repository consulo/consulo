 ...
 */
@ExtensionImpl
public class SdkTypeExtensionPreviewRecorder implements ExtensionPreviewRecorder<SdkType> {
  private final Application myApplication;

  @Inject
  public SdkTypeExtensionPreviewRecorder(Application application) {
