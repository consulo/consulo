...
public abstract class TaskRepository {
  ...
  public boolean equals(Object o) {
    ...
    if (!Comparing.equal(myType, that.myType)) {
      return false;
    }
  ...
  public boolean isSupported(@MagicConstant(flags = {NO_FEATURES, BASIC_HTTP_AUTHORIZATION, LOGIN_ANONYMOUSLY, STATE_UPDATING, TIME_MANAGEMENT, NATIVE_SEARCH}) int feature) {
    return (getFeatures() & feature) != 0;
  }

  @MagicConstant(flags = {NO_FEATURES, BASIC_HTTP_AUTHORIZATION, LOGIN_ANONYMOUSLY, STATE_UPDATING, TIME_MANAGEMENT, NATIVE_SEARCH})
