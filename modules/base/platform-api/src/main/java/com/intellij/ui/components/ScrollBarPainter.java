...
public abstract class ScrollBarPainter implements RegionPainter<Float> {
   ...
   */
  public static final EditorColorKey THUMB_OPAQUE_FOREGROUND = SystemInfo.isMac ? key(0x33000000, 0x59262626, "ScrollBar.Mac.thumbBorderColor") : key(0x33595959, 0x47383838, "ScrollBar.thumbBorderColor");
  /**
  ...
  private static final List<EditorColorKey> CONTRAST_ELEMENTS_KEYS =
          Arrays.asList(THUMB_OPAQUE_FOREGROUND, THUMB_OPAQUE_BACKGROUND, THUMB_OPAQUE_HOVERED_FOREGROUND, THUMB_OPAQUE_HOVERED_BACKGROUND, THUMB_FOREGROUND, THUMB_BACKGROUND, THUMB_HOVERED_FOREGROUND,
  ...
  static final class Track extends ScrollBarPainter {
    ...
    Track(@Nonnull Supplier<? extends Component> supplier) {
      super(supplier);
  ...
  static final class Thumb extends ScrollBarPainter {
    ...
    Thumb(@Nonnull Supplier<? extends Component> supplier, boolean opaque) {
      super(supplier);
