...
module consulo.language.api {
  ...
  exports consulo.language.psi.internal to consulo.ide.impl, consulo.language.impl, consulo.file.editor.impl;
  ...
  exports consulo.language.internal.custom to consulo.ide.impl, consulo.language.editor.impl;

  exports consulo.language.psi.util;

  // cache value impl visitor
  opens consulo.language.psi.stub to consulo.application.impl;
