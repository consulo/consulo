 ...
 * {@link #start(CharSequence, int, int, int, TokenIterator)} implementation helps
 * quickly retrieve information from preceding part of the file to restore lexer properly.
...
public interface RestartableLexer {
     ...
     * Iteration starts from current token and goes in reverse order.
     * This iterable can be used for getting some additional data needed for context dependent restart.
     *
