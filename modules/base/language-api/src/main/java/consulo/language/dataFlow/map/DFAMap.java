...
public class DFAMap<V> {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!(obj instanceof DFAMap<?> rhs)) {
            return false;
        }
        if (myAll != null || rhs.myAll != null) {
            return Objects.equals(myAll, rhs.myAll);
        }
        return Objects.equals(myK, rhs.myK) && Objects.equals(myV, rhs.myV);
    }
