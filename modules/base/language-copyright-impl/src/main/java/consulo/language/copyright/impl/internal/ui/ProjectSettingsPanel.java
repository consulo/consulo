...
public class ProjectSettingsPanel {
    ...
    public ProjectSettingsPanel(Project project, CopyrightProfilesPanel profilesModel) {
        ...
        myProfilesModel.addItemsChangeListener(new Runnable() {
            @Override
            public void run() {
                Object selectedItem = myProfilesComboBox.getSelectedItem();
                reloadCopyrightProfiles();
                myProfilesComboBox.setSelectedItem(selectedItem);
                List<ScopeSetting> toRemove = new ArrayList<>();
        ...
        myScopesLink.addHyperlinkListener(e -> {
    ...
    public void reloadCopyrightProfiles() {
        DefaultComboBoxModel boxModel = (DefaultComboBoxModel) myProfilesComboBox.getModel();
    ...
    public JComponent getMainComponent() {
        ...
        LabeledComponent<JComboBox> component = new LabeledComponent<>();
        ...
        ElementProducer<ScopeSetting> producer = new ElementProducer<>() {
            ...
            public ScopeSetting createElement() {
                return new ScopeSetting(
                    AllScopeHolder.getInstance().getAllScope(),
    ...
    public boolean isModified() {
        ...
        Map<String, String> map = myManager.getCopyrightsMapping();
    ...
    public void apply() {
        ...
        List<ScopeSetting> settingList = myScopeMappingModel.getItems();
    ...
    public void reset() {
        ...
        List<ScopeSetting> mappings = new ArrayList<>();
        Map<String, String> copyrights = myManager.getCopyrightsMapping();
        DependencyValidationManager manager = DependencyValidationManager.getInstance(myProject);
        Set<String> scopes2Unmap = new HashSet<>();
        ...
        public TableCellRenderer getRenderer(final ScopeSetting scopeSetting) {
            return new DefaultTableCellRenderer() {
                ...
                public Component getTableCellRendererComponent(
                    ...
                    if (!isSelected) {
                        CopyrightProfile profile = myProfilesModel.getAllProfiles().get(scopeSetting.getProfileName());
        ...
        public TableCellEditor getEditor(final ScopeSetting scopeSetting) {
            return new AbstractTableCellEditor() {
                ...
                public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
                    List<CopyrightProfile> copyrights = new ArrayList<>(myProfilesModel.getAllProfiles().values());
    ...
    private class ScopeColumn extends MyColumnInfo<NamedScope> {
            ...
            return new DefaultTableCellRenderer() {
                ...
                public Component getTableCellRendererComponent(
                    ...
                    if (value == null) {
                        ...
                        if (!isSelected) {
                            NamedScope scope = NamedScopesHolder.getScope(myProject, scopeName);
                            if (scope == null) {
        ...
        public TableCellEditor getEditor(ScopeSetting mapping) {
            return new AbstractTableCellEditor() {
                ...
                public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
                    myScopeChooser =
                        new ReadOnlyPackageSetChooserCombo(myProject, value == null ? null : ((NamedScope) value).getName(), false) {
                            @Override
                            protected NamedScope[] createModel() {
                                NamedScope[] model = super.createModel();
                                List<NamedScope> filteredScopes = new ArrayList<>(Arrays.asList(model));
