...
public abstract class NamedConfigurable<T> implements Configurable, MasterDetailsConfigurable<T> {
    ...
    protected NamedConfigurable(boolean isNameEditable, @Nullable Runnable updateTree) {
        ...
        if (myNameEditable) {
            myNameField.addValueListener(event -> {
                setDisplayName(myNameField.getValue());
                if (updateTree != null) {
                    updateTree.run();
                }
            });
    ...
    protected @Nullable JComponent createTopRightComponent(TextBox nameField) {
        return null;
    }
    ...
    public void updateName() {
        myNameField.setValue(getDisplayName().get());
    }
    ...
    private void $$$setupUI$$$() {
        ...
        myWholePanel.setLayout(new GridLayoutManager(2, 1, JBUI.emptyInsets(), -1, -1));
        ...
        myNamePanel.setLayout(new GridLayoutManager(1, 3, JBUI.emptyInsets(), -1, -1));
        ...
        Label label1 = Label.create(CommonLocalize.nameLabelText());
        myNamePanel.add(TargetAWT.to(label1), new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        myNameField = TextBox.create();
        myNamePanel.add(TargetAWT.to(myNameField), new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
