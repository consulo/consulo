...
public class CachedIntentions {
  ...
  @Nonnull
  public static CachedIntentions create(@Nonnull Project project, @Nonnull PsiFile file, @Nullable Editor editor, @Nonnull ShowIntentionsPass.IntentionsInfo intentions) {
  ...
  @Nonnull
  public static CachedIntentions createAndUpdateActions(@Nonnull Project project, @Nonnull PsiFile file, @Nullable Editor editor, @Nonnull ShowIntentionsPass.IntentionsInfo intentions) {
    CachedIntentions res = new CachedIntentions(project, file, editor);
  ...
  public boolean wrapAndUpdateActions(@Nonnull ShowIntentionsPass.IntentionsInfo newInfo, boolean callUpdate) {
  ...
  public boolean addActions(@Nonnull ShowIntentionsPass.IntentionsInfo info) {
  ...
  private boolean wrapActionsTo(@Nonnull List<? extends HighlightInfo.IntentionActionDescriptor> newDescriptors,
    ...
    if (shouldCallIsAvailable) {
      for (Iterator<IntentionActionWithTextCaching> iterator = cachedActions.iterator(); iterator.hasNext(); ) {
        ...
        Pair<PsiFile, Editor> applicableIn = ShowIntentionActionsHandler.chooseBetweenHostAndInjected(myFile, myEditor, injectedFile, (f, e) -> ShowIntentionActionsHandler.availableFor(f, e, action));
    ...
    Set<IntentionActionWithTextCaching> wrappedNew = new HashSet<>(newDescriptors.size(), ACTION_TEXT_AND_CLASS_EQUALS);
    for (HighlightInfo.IntentionActionDescriptor descriptor : newDescriptors) {
