...
public class BreadcrumbsWrapper extends JComponent implements Disposable {
  ...
  private final static Logger LOG = Logger.getInstance(BreadcrumbsWrapper.class);
  ...
  private static Iterable<PsiCrumb> getPresentableLineElements(@Nonnull final LogicalPosition position,
    ...
    Collection<Pair<PsiElement, BreadcrumbsProvider>> pairs = getLineElements(editor.logicalPositionToOffset(position), file, project, defaultInfoProvider);
  ...
  @Nullable
  private static Collection<Pair<PsiElement, BreadcrumbsProvider>> getLineElements(int offset, VirtualFile file, Project project, BreadcrumbsProvider defaultInfoProvider) {
  ...
  @Nullable
  private static PsiElement findFirstBreadcrumbedElement(final int offset, final VirtualFile file, final Project project, final BreadcrumbsProvider defaultInfoProvider) {
  ...
  private static class MyUpdate extends Update {
    private final BreadcrumbsWrapper myBreadcrumbsComponent;

    public MyUpdate(@NonNls final BreadcrumbsWrapper c) {
      super(c);
