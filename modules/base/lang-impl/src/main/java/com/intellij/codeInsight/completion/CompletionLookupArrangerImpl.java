...
public class CompletionLookupArrangerImpl extends LookupArranger implements CompletionLookupArranger {
  ...
  public Map<LookupElement, List<Pair<String, Object>>> getRelevanceObjects(@Nonnull Iterable<LookupElement> items, boolean hideSingleValued) {
    ...
    for (CompletionSorterImpl sorter : inputBySorter.keySet()) {
      ...
      while (classifier != null) {
        final HashSet<LookupElement> itemSet = ContainerUtil.newIdentityTroveSet(thisSorterItems);
  ...
  @Override
  public void addElement(@Nonnull LookupElement element, @Nonnull CompletionSorter sorter, @Nonnull PrefixMatcher prefixMatcher, @Nonnull LookupElementPresentation presentation) {
  ...
  private List<LookupElement> fillModelByRelevance(LookupElementListPresenter lookup,
    ...
    Iterator<? extends LookupElement> byRelevance = myFinalSorter.sort(sortedElements, Objects.requireNonNull(myProcess.getParameters())).iterator();
