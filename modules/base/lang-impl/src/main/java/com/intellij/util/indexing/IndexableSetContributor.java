...
public abstract class IndexableSetContributor {
  ...
  public static final ExtensionPointName<IndexableSetContributor> EP_NAME =
          new ExtensionPointName<IndexableSetContributor>("com.intellij.indexedRootsContributor");
