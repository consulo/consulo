    ...
    public static void registerInjection(Language language, List<Trinity<PsiLanguageInjectionHost, InjectedLanguage, TextRange>> list, PsiFile containingFile, MultiHostRegistrar registrar) {
        ...
        if (parser == null && injector != null) {
            for (Trinity<PsiLanguageInjectionHost, InjectedLanguage, TextRange> trinity : list) {
                ...
                InjectedLanguageManagerInternal manager = (InjectedLanguageManagerInternal) InjectedLanguageManager.getInstance(containingFile.getProject());

                manager.injectReference(registrar, language, prefix, suffix, host, textRange);
                return;
            }
            return;
        }
