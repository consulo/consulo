...
public interface TraceableDisposable {
  void kill(@NonNls @Nullable String msg);

  void killExceptionally(@Nonnull Throwable throwable);

  void throwObjectNotDisposedError(@NonNls @Nonnull final String msg);

  void throwDisposalError(@NonNls String msg) throws RuntimeException;
