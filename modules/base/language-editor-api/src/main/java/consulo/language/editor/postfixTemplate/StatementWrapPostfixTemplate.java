...
public abstract class StatementWrapPostfixTemplate extends TypedPostfixTemplate {
  ...
  protected StatementWrapPostfixTemplate(@Nonnull String name, @Nonnull String descr, @Nonnull PostfixTemplatePsiInfo psiInfo) {
    super(name, descr, psiInfo, element -> true);
  }

  protected StatementWrapPostfixTemplate(@Nonnull String name, @Nonnull String descr, @Nonnull PostfixTemplatePsiInfo psiInfo, @Nonnull Predicate<PsiElement> typeChecker) {
