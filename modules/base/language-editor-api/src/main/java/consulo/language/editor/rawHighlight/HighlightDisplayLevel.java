...
public class HighlightDisplayLevel {
    ...
    public static final HighlightDisplayLevel GENERIC_SERVER_ERROR_OR_WARNING = new HighlightDisplayLevel(
        HighlightSeverity.GENERIC_SERVER_ERROR_OR_WARNING,
        createBoxIcon(CodeInsightColors.GENERIC_SERVER_ERROR_OR_WARNING)
    );
    ...
    public static final HighlightDisplayLevel WARNING =
        new HighlightDisplayLevel(HighlightSeverity.WARNING, createWarningIcon(CodeInsightColors.WARNINGS_ATTRIBUTES));
    ...
    public static final HighlightDisplayLevel WEAK_WARNING =
        new HighlightDisplayLevel(HighlightSeverity.WEAK_WARNING, createWarningIcon(CodeInsightColors.WEAK_WARNING_ATTRIBUTES));
