...
public abstract class BaseTemplateContextType implements TemplateContextType {
    ...
    protected BaseTemplateContextType(
        String id,
        ...
        myBaseContextType = ClearableLazyValue.nullable(
            (Supplier<? extends TemplateContextType>) () -> baseContextType == null
                ? null
                : Application.get().getExtensionPoint(TemplateContextType.class).findExtensionOrFail(baseContextType)
        );
    }
