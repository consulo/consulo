...
public abstract class HierarchyTreeStructure extends AbstractTreeStructure {
    ...
    protected SearchScope getSearchScope(HierarchyScope scope, PsiElement thisClass) {
        return scope.getSearchScope(thisClass);
    }

    protected boolean isInScope(PsiElement baseClass, PsiElement srcElement, HierarchyScope scope) {
        return scope.isInScope(baseClass, srcElement);
    }
