 ...
 */
package consulo.language.editor.inspection.internal;
...
public class InspectionToolsRegistrarCore {
  ...
  public static Object instantiateTool(@Nonnull Class<?> toolClass) {
    try {
    ...
    catch (SecurityException | InvocationTargetException | IllegalArgumentException | IllegalAccessException | InstantiationException | NoSuchMethodException e) {
      LOG.error(e);
    }
