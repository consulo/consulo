...
public final class NameUtil {
  ...
  /**
   * @deprecated use {@link consulo.language.editor.internal.matcher.Matcher}
   */
  @Deprecated
  ...
  public static consulo.language.editor.internal.matcher.Matcher buildMatcher(@Nonnull String pattern, int exactPrefixLen, boolean allowToUpper, boolean allowToLower) {
  ...
  @Deprecated
  @Nonnull
  public static consulo.language.editor.internal.matcher.Matcher buildMatcher(@Nonnull String pattern,
                                                                              int exactPrefixLen,
