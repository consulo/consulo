...
class ImmutableSameTypeAttributeList implements List<Attribute> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof List list) || size() != list.size()) {
            return false;
        }
        if (size() == 0) {
            return true;
        ...
        List<Attribute> l = (List<Attribute>) list;
        for (int i = 0; i < myNameValues.length; i += 2) {
            ...
            if (!Objects.equals(name, a2.getName())
                ...
                || !Objects.equals(myType, a2.getAttributeType())
                || !Objects.equals(myNs, a2.getNamespace())
            ) {
                return false;
            }
        }
