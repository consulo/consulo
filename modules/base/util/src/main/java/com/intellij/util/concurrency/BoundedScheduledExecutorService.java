...
class BoundedScheduledExecutorService extends SchedulingWrapper {
  BoundedScheduledExecutorService(@Nonnull @Nls(capitalization = Nls.Capitalization.Title) String name, @Nonnull ExecutorService backendExecutor, int maxThreads) {
