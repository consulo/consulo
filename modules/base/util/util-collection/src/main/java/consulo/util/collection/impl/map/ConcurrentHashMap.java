 ...
 * operations that, unlike most {@link java.util.stream.Stream} methods, are designed
 ...
 */
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, HashingStrategy<K> {
  ...
  static class Node<K extends @Nullable Object, V extends @Nullable Object> implements Map.Entry<K, V> {
    ...
    public final int hashCode() {
      return hashingStrategy.hashCode(key) ^ (val == null ? 0 : val.hashCode());
    }
    ...
    @Nullable Node<K, V> find(int h, Object k) {
      ...
      if (k != null) {
        do {
          K ek;
          if (e.hash == h && ((ek = e.key) == k || ek != null && hashingStrategy.equals((K)k, ek))) {
            return e;
          }
        }
        while ((e = e.next) != null);
  ...
  static int compareComparables(Class<?> kc, Object k, @Nullable Object x) {
   ...
   */
  transient volatile Node<K, V> @Nullable [] table = null;

  /**
   * The next table to use; non-null only while resizing.
   */
  private transient volatile Node<K, V> @Nullable[] nextTable = null;
  ...
  public @Nullable V get(Object key) {
    ...
    if ((tab = table) != null && (n = tab.length) > 0 && (e = tabAt(tab, (n - 1) & h)) != null) {
      if ((eh = e.hash) == h) {
        if ((ek = e.key) == key || (ek != null && isEqual((K)key, ek))) return e.val;
      }
      else if (eh < 0) return (p = e.find(h, key)) != null ? p.val : null;
      while ((e = e.next) != null) {
        if (e.hash == h && ((ek = e.key) == key || (ek != null && isEqual((K)key, ek)))) return e.val;
      }
    }
    return null;
  }
          ...
          if (tabAt(tab, i) == f) {
            if (fh >= 0) {
              ...
              for (Node<K, V> e = f; ; ++binCount) {
                K ek;
                if (e.hash == hash && ((ek = e.key) == key || (ek != null && isEqual(key, ek)))) {
                  oldVal = e.val;
          ...
          if (tabAt(tab, i) == f) {
            if (fh >= 0) {
              ...
              for (Node<K, V> e = f, pred = null; ; ) {
                K ek;
                if (e.hash == hash && ((ek = e.key) == key || (ek != null && isEqual((K)key, ek)))) {
                  V ev = e.val;
  ...
  public void replaceAll(BiFunction<? super K, ? super V, ? extends V> function) {
    ...
    if ((t = table) != null) {
      ...
      for (Node<K, V> p; (p = it.advance()) != null; ) {
        V oldValue = p.val;
        for (K key = Objects.requireNonNull(p.key); ; ) {
  ...
  boolean removeEntryIf(Predicate<? super Entry<K, V>> function) {
    ...
    if ((t = table) != null) {
      Traverser<K, V> it = new Traverser<K, V>(t, t.length, 0, t.length);
      for (Node<K, V> p; (p = it.advance()) != null; ) {
        K k = Objects.requireNonNull(p.key);
        V v = Objects.requireNonNull(p.val);
        Map.Entry<K, V> e = new AbstractMap.SimpleImmutableEntry<>(k, v);
        if (function.test(e) && replaceNode(k, null, v) != null) removed = true;
      }
    }
    return removed;
  }
  ...
  boolean removeValueIf(Predicate<? super V> function) {
    ...
    if ((t = table) != null) {
      ...
      for (Node<K, V> p; (p = it.advance()) != null; ) {
        K k = Objects.requireNonNull(p.key);
        V v = p.val;
        if (function.test(v) && replaceNode(k, null, v) != null) removed = true;
      }
    }
    return removed;
  }
      ...
      if (tab == null || (n = tab.length) == 0) tab = initTable();
        ...
        synchronized (r) {
          if (casTabAt(tab, i, null, r)) {
            ...
            Node<K, V> node = null;
            try {
              if ((val = mappingFunction.apply(key)) != null) node = new Node<K, V>(h, key, val, hashingStrategy);
            }
            finally {
              setTabAt(tab, i, node);
            }
        ...
        synchronized (f) {
          if (tabAt(tab, i) == f) {
            if (fh >= 0) {
              ...
              for (Node<K, V> e = f; ; ++binCount) {
                K ek;
                if (e.hash == h && ((ek = e.key) == key || (ek != null && isEqual(key, ek)))) {
                  val = e.val;
                  break;
                }
                Node<K, V> pred = e;
                if ((e = e.next) == null) {
                  if ((val = mappingFunction.apply(key)) != null) {
                    if (pred.next != null) throw new IllegalStateException("Recursive update");
                    added = true;
    ...
    @Nullable Node<K, V> find(int h, Object k) {
      ...
      for (Node<K, V>[] tab = nextTable; ; ) {
        ...
        for (; ; ) {
          int eh;
          K ek;
          if ((eh = e.hash) == h && ((ek = e.key) == k || (ek != null && isEqual((K)k, ek, hashingStrategy)))) return e;
          if (eh < 0) {
   ...
   */
  final Node<K, V> @Nullable [] helpTransfer(Node<K, V>[] tab, Node<K, V> f) {
    Node<K, V>[] nextTab;
    int sc;
   ...
   */
  private final void transfer(Node<K, V>[] tab, Node<K, V> @Nullable [] nextTab) {
    ...
    for (int i = 0, bound = 0; ; ) {
      ...
      else if ((fh = Objects.requireNonNull(f).hash) == MOVED) advance = true; // already processed
      else {
        synchronized (f) {
          if (tabAt(tab, i) == f) {
            Node<K, V> ln, hn;
            if (fh >= 0) {
              ...
              for (Node<K, V> p = f; p != lastRun; p = p.next) {
                ...
                K pk = p.key;
                V pv = p.val;
                if ((ph & n) == 0) ln = new Node<K, V>(ph, pk, pv, ln, hashingStrategy);
                else hn = new Node<K, V>(ph, pk, pv, hn, hashingStrategy);
              }
              ...
              for (Node<K, V> e = t.first; e != null; e = e.next) {
                int h = e.hash;
                TreeNode<K, V> p = new TreeNode<K, V>(h, e.key, e.val, null, null, hashingStrategy);
                if ((h & n) == 0) {
                  p.prev = loTail;
                  if (loTail == null) lo = p;
                  else loTail.next = p;
              ...
              ln = (lc <= UNTREEIFY_THRESHOLD) ? untreeify(lo) : (hc != 0) ? new TreeBin<K, V>(lo, hashingStrategy) : t;
              hn = (hc <= UNTREEIFY_THRESHOLD) ? untreeify(hi) : (lc != 0) ? new TreeBin<K, V>(hi, hashingStrategy) : t;
              setTabAt(nextTab, i, ln);
              setTabAt(nextTab, i + n, hn);
              setTabAt(tab, i, fwd);
              advance = true;
   ...
   */
  //@sun.misc.Contended not avaliable in jdk9+
   ...
   */
  private final void treeifyBin(Node<K, V> @Nullable [] tab, int index) {
    Node<K, V> b;
    int n;
    if (tab != null) {
        ...
        synchronized (b) {
          if (tabAt(tab, index) == b) {
            ...
            for (Node<K, V> e = b; e != null; e = e.next) {
              TreeNode<K, V> p = new TreeNode<K, V>(e.hash, e.key, e.val, null, null, hashingStrategy);
              p.prev = tl;
              if (tl == null) hd = p;
              else tl.next = p;
              tl = p;
  ...
  static final class TreeBin<K, V> extends Node<K, V> {
    ...
    static int tieBreakOrder(@Nullable Object a, @Nullable Object b) {
      ...
      if (a == null || b == null || (d = a.getClass().getName().
              compareTo(b.getClass().getName())) == 0) d = (System.identityHashCode(a) <= System.identityHashCode(b) ? -1 : 1);
      return d;
    }
    ...
    TreeBin(@Nullable TreeNode<K, V> b, HashingStrategy<K> hashingStrategy) {
      ...
      for (TreeNode<K, V> x = b, next; x != null; x = next) {
        ...
        if (r == null) {
          ...
          K k = Objects.requireNonNull(x.key);
          int h = x.hash;
          Class<?> kc = null;
    ...
    final @Nullable TreeNode<K, V> putTreeVal(int h, K k, V v) {
      ...
      for (TreeNode<K, V> p = root; ; ) {
        ...
        else if ((pk = p.key) == k || (pk != null && isEqual(k, pk, hashingStrategy))) return p;
        else if ((kc == null && (kc = comparableClassFor(k)) == null) || (dir = compareComparables(kc, k, pk)) == 0) {
          if (!searched) {
            TreeNode<K, V> q, ch;
            searched = true;
    ...
    static <K, V> TreeNode<K, V> balanceInsertion(@Nullable TreeNode<K, V> root, TreeNode<K, V> x) {
      x.red = true;
      for (TreeNode<K, V> xp, xpp, xppl, xppr; ; ) {
        ...
        else if (!xp.red || (xpp = xp.parent) == null) return Objects.requireNonNull(root);
        if (xp == (xppl = xpp.left)) {
          if ((xppr = xpp.right) != null && xppr.red) {
            ...
            if (x == xp.right) {
              root = rotateLeft(Objects.requireNonNull(root), x = xp);
            ...
            if (xp != null) {
              ...
              if (xpp != null) {
                xpp.red = true;
                root = rotateRight(Objects.requireNonNull(root), xpp);
              }
            }
          }
        }
          ...
          if (xppl != null && xppl.red) {
            ...
            if (x == xp.left) {
              root = rotateRight(Objects.requireNonNull(root), x = xp);
              xpp = (xp = x.parent) == null ? null : xp.parent;
            }
            if (xp != null) {
              xp.red = false;
              if (xpp != null) {
                xpp.red = true;
                root = rotateLeft(Objects.requireNonNull(root), xpp);
              }
            }
          }
        }
  ...
  static class Traverser<K, V> {
    ...
    Traverser(Node<K, V> @Nullable [] tab, int size, int index, int limit) {
      this.tab = tab;
      this.baseSize = size;
  ...
  static final class KeyIterator<K, V> extends BaseIterator<K, V> implements Iterator<K>, Enumeration<K> {
    KeyIterator(Node<K, V> @Nullable [] tab, int size, int index, int limit, ConcurrentHashMap<K, V> map) {
  ...
  static final class ValueIterator<K, V> extends BaseIterator<K, V> implements Iterator<V>, Enumeration<V> {
    ValueIterator(Node<K, V> @Nullable [] tab, int size, int index, int limit, ConcurrentHashMap<K, V> map) {
      super(tab, size, index, limit, map);
    }
  ...
  static final class EntryIterator<K, V> extends BaseIterator<K, V> implements Iterator<Map.Entry<K, V>> {
    EntryIterator(Node<K, V> @Nullable [] tab, int size, int index, int limit, ConcurrentHashMap<K, V> map) {
      super(tab, size, index, limit, map);
    }
  ...
  static final class KeySpliterator<K, V> extends Traverser<K, V> implements Spliterator<K> {
    ...
    KeySpliterator(Node<K, V> @Nullable [] tab, int size, int index, int limit, long est) {
      super(tab, size, index, limit);
      this.est = est;
    }

    public @Nullable KeySpliterator<K, V> trySplit() {
      int i, f, h = ((i = baseIndex) + (f = baseLimit)) >>> 1;
      return h <= i ? null : new KeySpliterator<K, V>(tab, baseSize, baseLimit = h, f, est >>>= 1);
    }
  ...
  static final class ValueSpliterator<K, V> extends Traverser<K, V> implements Spliterator<V> {
    ...
    ValueSpliterator(Node<K, V> @Nullable [] tab, int size, int index, int limit, long est) {
      super(tab, size, index, limit);
      this.est = est;
    }
    ...
    public @Nullable ValueSpliterator<K, V> trySplit() {
      int i, f, h = ((i = baseIndex) + (f = baseLimit)) >>> 1;
      return h <= i ? null : new ValueSpliterator<K, V>(tab, baseSize, baseLimit = h, f, est >>>= 1);
    }
  ...
  static final class EntrySpliterator<K, V> extends Traverser<K, V> implements Spliterator<Map.Entry<K, V>> {
    ...
    EntrySpliterator(Node<K, V> @Nullable [] tab, int size, int index, int limit, long est, ConcurrentHashMap<K, V> map) {
      super(tab, size, index, limit);
      this.map = map;
      this.est = est;
    }
    ...
    public @Nullable EntrySpliterator<K, V> trySplit() {
      int i, f, h = ((i = baseIndex) + (f = baseLimit)) >>> 1;
      return h <= i ? null : new EntrySpliterator<K, V>(tab, baseSize, baseLimit = h, f, est >>>= 1, map);
    }
  ...
  public <U> U search(long parallelismThreshold, BiFunction<? super K, ? super V, ? extends U> searchFunction) {
    ...
    return new SearchMappingsTask<K, V, U>(
      ...
      table,
      searchFunction,
      new AtomicReference<@Nullable U>()
    ).invoke();
  }
  ...
  public double reduceToDouble(
    ...
    if (transformer == null || reducer == null) throw new NullPointerException();
    return new MapReduceMappingsToDoubleTask<K, V>(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer)
        .invoke();
  }
  ...
  public long reduceToLong(
    ...
    if (transformer == null || reducer == null) throw new NullPointerException();
    return new MapReduceMappingsToLongTask<K, V>(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer)
      .invoke();
  }
  ...
  public int reduceToInt(
    ...
    if (transformer == null || reducer == null) throw new NullPointerException();
    return new MapReduceMappingsToIntTask<K, V>(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer)
      .invoke();
  }
  ...
  public double reduceKeysToDouble(
    ...
    if (transformer == null || reducer == null) throw new NullPointerException();
    return new MapReduceKeysToDoubleTask<K, V>(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer)
      .invoke();
  }
  ...
  public double reduceValuesToDouble(
    ...
    if (transformer == null || reducer == null) throw new NullPointerException();
    return new MapReduceValuesToDoubleTask<K, V>(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer)
      .invoke();
  }
  ...
  public long reduceValuesToLong(long parallelismThreshold, ToLongFunction<? super V> transformer, long basis, LongBinaryOperator reducer) {
    if (transformer == null || reducer == null) throw new NullPointerException();
    return new MapReduceValuesToLongTask<K, V>(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer)
      .invoke();
  }
  ...
  public int reduceValuesToInt(long parallelismThreshold, ToIntFunction<? super V> transformer, int basis, IntBinaryOperator reducer) {
    if (transformer == null || reducer == null) throw new NullPointerException();
    return new MapReduceValuesToIntTask<K, V>(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer)
      .invoke();
  }
  ...
  public double reduceEntriesToDouble(
    ...
    if (transformer == null || reducer == null) throw new NullPointerException();
    return new MapReduceEntriesToDoubleTask<K, V>(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer)
        .invoke();
  }
  ...
  public long reduceEntriesToLong(
    ...
    if (transformer == null || reducer == null) throw new NullPointerException();
    return new MapReduceEntriesToLongTask<K, V>(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer)
      .invoke();
  }
  ...
  public int reduceEntriesToInt(
    ...
    if (transformer == null || reducer == null) throw new NullPointerException();
    return new MapReduceEntriesToIntTask<K, V>(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer)
      .invoke();
  }
  ...
  abstract static class CollectionView<K, V, E> implements Collection<E>, java.io.Serializable {
    ...
    public final Object[] toArray() {
      ...
      for (E e : this) {
        if (i == n) {
          if (n >= MAX_ARRAY_SIZE) throw new OutOfMemoryError(OOME_MSG);
  ...
  static final class EntrySetView<K, V> extends CollectionView<K, V, Map.Entry<K, V>>
    ...
    public boolean remove(Object o) {
      Object k, v;
      return o instanceof Map.Entry e && (k = e.getKey()) != null && (v = e.getValue()) != null && map.remove(k, v);
    }
  ...
  abstract static class BulkTask<K, V, R> extends CountedCompleter<R> {
    ...
    BulkTask(@Nullable BulkTask<K, V, ?> par, int b, int i, int f, Node<K, V> @Nullable [] t) {
      super(par);
      this.batch = b;
      this.index = this.baseIndex = i;
      this.tab = t;
      if (t == null) this.baseSize = this.baseLimit = 0;
    ...
    private void recoverState(int n) {
      TableStack<K, V> s = stack;
      int len;
      while (s != null && (index += (len = s.length)) >= n) {
        n = len;
        index = s.index;
        tab = s.tab;
        s.tab = null;
  ...
  static final class ForEachKeyTask<K, V> extends BulkTask<K, V, Void> {
    ...
    ForEachKeyTask(@Nullable BulkTask<K, V, ?> p, int b, int i, int f, Node<K, V> @Nullable [] t, Consumer<? super K> action) {
      super(p, b, i, f, t);
      this.action = action;
    }
  ...
  static final class ForEachValueTask<K, V> extends BulkTask<K, V, Void> {
    ...
    ForEachValueTask(@Nullable BulkTask<K, V, ?> p, int b, int i, int f, Node<K, V> @Nullable [] t, Consumer<? super V> action) {
      super(p, b, i, f, t);
      this.action = action;
    }
  ...
  static final class ForEachEntryTask<K, V> extends BulkTask<K, V, Void> {
    ...
    ForEachEntryTask(@Nullable BulkTask<K, V, ?> p, int b, int i, int f, Node<K, V> @Nullable [] t, Consumer<? super Entry<K, V>> action) {
      super(p, b, i, f, t);
      this.action = action;
    }
  ...
  static final class ReduceKeysTask<K, V> extends BulkTask<K, V, K> {
    ...
    ReduceKeysTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable ReduceKeysTask<K, V> nextRight,
    ...
    public final void compute() {
      ...
      if ((reducer = this.reducer) != null) {
        ...
        for (c = firstComplete(); c != null; c = c.nextComplete()) {
          ...
          while (s != null) {
            K tr, sr = s.result;
            if (sr != null) t.result = (((tr = t.result) == null) ? sr : reducer.apply(tr, sr));
  ...
  static final class ReduceValuesTask<K, V> extends BulkTask<K, V, V> {
    ...
    ReduceValuesTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable ReduceValuesTask<K, V> nextRight,
  ...
  static final class ReduceEntriesTask<K, V> extends BulkTask<K, V, Map.Entry<K, V>> {
    ...
    ReduceEntriesTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable ReduceEntriesTask<K, V> nextRight,
    ...
    public final Map.@Nullable Entry<K, V> getRawResult() {
      return result;
    }

    public final void compute() {
      final BiFunction<Map.Entry<K, V>, Map.Entry<K, V>, ? extends Map.Entry<K, V>> reducer = this.reducer;
      if (reducer != null) {
        for (int i = baseIndex, f, h; batch > 0 && (h = ((f = baseLimit) + i) >>> 1) > i; ) {
          addToPendingCount(1);
  ...
  static final class MapReduceKeysTask<K, V, U> extends BulkTask<K, V, U> {
    ...
    MapReduceKeysTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceKeysTask<K, V, U> nextRight,
        Function<? super K, ? extends U> transformer,
        BiFunction<? super U, ? super U, ? extends U> reducer
    ) {
      super(p, b, i, f, t);
  ...
  static final class MapReduceValuesTask<K, V, U> extends BulkTask<K, V, U> {
    ...
    MapReduceValuesTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceValuesTask<K, V, U> nextRight,
        Function<? super V, ? extends U> transformer,
        BiFunction<? super U, ? super U, ? extends U> reducer
    ) {
      super(p, b, i, f, t);
  ...
  static final class MapReduceEntriesTask<K, V, U> extends BulkTask<K, V, U> {
    ...
    MapReduceEntriesTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceEntriesTask<K, V, U> nextRight,
        Function<Map.Entry<K, V>, ? extends U> transformer,
        BiFunction<? super U, ? super U, ? extends U> reducer
    ) {
      super(p, b, i, f, t);
  ...
  static final class MapReduceMappingsTask<K, V, U> extends BulkTask<K, V, U> {
    ...
    MapReduceMappingsTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceMappingsTask<K, V, U> nextRight,
        BiFunction<? super K, ? super V, ? extends U> transformer,
        BiFunction<? super U, ? super U, ? extends U> reducer
    ) {
      super(p, b, i, f, t);
  ...
  static final class MapReduceKeysToDoubleTask<K, V> extends BulkTask<K, V, Double> {
    ...
    MapReduceKeysToDoubleTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceKeysToDoubleTask<K, V> nextRight,
        ToDoubleFunction<? super K> transformer,
        double basis,
        DoubleBinaryOperator reducer
    ) {
  ...
  static final class MapReduceValuesToDoubleTask<K, V> extends BulkTask<K, V, Double> {
    ...
    MapReduceValuesToDoubleTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceValuesToDoubleTask<K, V> nextRight,
        ToDoubleFunction<? super V> transformer,
        double basis,
        DoubleBinaryOperator reducer
    ) {
  ...
  static final class MapReduceEntriesToDoubleTask<K, V> extends BulkTask<K, V, Double> {
    ...
    MapReduceEntriesToDoubleTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceEntriesToDoubleTask<K, V> nextRight,
        ToDoubleFunction<Map.Entry<K, V>> transformer,
        double basis,
        DoubleBinaryOperator reducer
    ) {
  ...
  static final class MapReduceMappingsToDoubleTask<K, V> extends BulkTask<K, V, Double> {
    ...
    MapReduceMappingsToDoubleTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceMappingsToDoubleTask<K, V> nextRight,
        ToDoubleBiFunction<? super K, ? super V> transformer,
        double basis,
        DoubleBinaryOperator reducer
    ) {
  ...
  static final class MapReduceKeysToLongTask<K, V> extends BulkTask<K, V, Long> {
    ...
    MapReduceKeysToLongTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceKeysToLongTask<K, V> nextRight,
  ...
  static final class MapReduceValuesToLongTask<K, V> extends BulkTask<K, V, Long> {
    ...
    MapReduceValuesToLongTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceValuesToLongTask<K, V> nextRight,
  ...
  static final class MapReduceEntriesToLongTask<K, V> extends BulkTask<K, V, Long> {
    ...
    MapReduceEntriesToLongTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceEntriesToLongTask<K, V> nextRight,
        ToLongFunction<Map.Entry<K, V>> transformer,
        long basis,
        LongBinaryOperator reducer
    ) {
  ...
  static final class MapReduceMappingsToLongTask<K, V> extends BulkTask<K, V, Long> {
    ...
    MapReduceMappingsToLongTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceMappingsToLongTask<K, V> nextRight,
        ToLongBiFunction<? super K, ? super V> transformer,
        long basis,
        LongBinaryOperator reducer
    ) {
  ...
  static final class MapReduceKeysToIntTask<K, V> extends BulkTask<K, V, Integer> {
    ...
    MapReduceKeysToIntTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceKeysToIntTask<K, V> nextRight,
  ...
  static final class MapReduceValuesToIntTask<K, V> extends BulkTask<K, V, Integer> {
    ...
    MapReduceValuesToIntTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceValuesToIntTask<K, V> nextRight,
  ...
  static final class MapReduceEntriesToIntTask<K, V> extends BulkTask<K, V, Integer> {
    ...
    MapReduceEntriesToIntTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceEntriesToIntTask<K, V> nextRight,
        ToIntFunction<Map.Entry<K, V>> transformer,
        int basis,
        IntBinaryOperator reducer
    ) {
  ...
  static final class MapReduceMappingsToIntTask<K, V> extends BulkTask<K, V, Integer> {
    ...
    MapReduceMappingsToIntTask(
        ...
        int f,
        Node<K, V> @Nullable [] t,
        @Nullable MapReduceMappingsToIntTask<K, V> nextRight,
        ToIntBiFunction<? super K, ? super V> transformer,
        int basis,
        IntBinaryOperator reducer
    ) {
  ...
  @Override
  public int hashCode(final @Nullable K object) {
    return object == null ? 0 : object.hashCode();
  }

  @Override
  public boolean equals(final @Nullable K o1, final @Nullable K o2) {
