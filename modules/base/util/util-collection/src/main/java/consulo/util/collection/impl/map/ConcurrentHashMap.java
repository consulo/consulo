...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, HashingStrategy<K> {
        ...
        if (x instanceof Comparable) {
            ...
            if ((ts = c.getGenericInterfaces()) != null) {
                for (int i = 0; i < ts.length; ++i) {
                    if (ts[i] instanceof ParameterizedType pType
        ...
        @Nullable Node<K, V> find(int h, Object k) {
            ...
            for (Node<K, V>[] tab = nextTable; ; ) {
                ...
                for (; ; ) {
                    int eh;
                    K ek;
                    if ((eh = e.hash) == h && ((ek = e.key) == k || (ek != null && isEqual((K) k, ek, hashingStrategy)))) {
                        return e;
                    }
                    if (eh < 0) {
    ...
    private final void transfer(Node<K, V>[] tab, Node<K, V> @Nullable [] nextTab) {
        ...
        for (int i = 0, bound = 0; ; ) {
            ...
            else if ((fh = Objects.requireNonNull(f).hash) == MOVED) {
            ...
            if (k != null) {
                for (Node<K, V> e = first; e != null; ) {
                    ...
                    if (((s = lockState) & (WAITER | WRITER)) != 0) {
                        if (e.hash == h && ((ek = e.key) == k || (ek != null && isEqual((K) k, ek, hashingStrategy)))) {
                            return e;
                        }
                        e = e.next;
                    }
