...
public abstract class JBIterable<E extends @Nullable Object> implements Iterable<E> {
  ...
  public static <E> JBIterable<E> once(Iterator<E> iterator) {
    return of(SimpleReference.<@Nullable Iterator<E>>create(iterator))
        .intercept((Iterator<SimpleReference<@Nullable Iterator<E>>> refIterator) -> {
          SimpleReference<@Nullable Iterator<E>> ref = refIterator.next();
   ...
   */
  public final <K, V> Map<K, V> toMap(Function<E, K> toKey, Function<E, V> toValue) {
