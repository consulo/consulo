...
public class FList<E> extends AbstractList<E> {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof FList that) {
            ...
            while (list1 != null) {
                if (!Objects.equals(list1.myHead, Objects.requireNonNull(list2).myHead)) {
                    return false;
                }
                list1 = list1.getTail();
                list2 = list2.getTail();
    ...
    /**
     * Creates an FList object with the elements of the given sequence in the reversed order,
     * i.e. the last element of {@code from} will be the result's {@link #getHead()}
     */
