 ...
 */
public abstract class RefHashMap<K, V extends @Nullable Object> extends AbstractMap<K, V> implements Map<K, V> {
    ...
    @Nullable V removeKey(Key<K> key) {
    ...
    @Nullable V putKey(Key<K> weakKey, V value) {
    ...
    private static class MyEntry<K, V extends @Nullable Object> implements Entry<K, V> {
