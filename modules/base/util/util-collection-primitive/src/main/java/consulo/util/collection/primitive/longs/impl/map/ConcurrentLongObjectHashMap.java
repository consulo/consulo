 ...
 * @author Doug Lea
 */
public class ConcurrentLongObjectHashMap<V> extends AbstractLong2ObjectMap<V> implements ConcurrentLongObjectMap<V> {
  ...
  static class Node<V> {
    ...
    public final int hashCode() {
      return (int)(key ^ Objects.hashCode(val));
    }
    ...
    public final boolean equals(Object o) {
      ...
      return ((o instanceof Long2ObjectMap.Entry) && (e = (Long2ObjectMap.Entry<?>)o).getLongKey() == key && (v = e.getValue()) != null && (v == (u = val) || v.equals(u)));
    }
   ...
   */
  transient volatile Node<V> @Nullable [] table = null;

  /**
   * The next table to use; non-null only while resizing.
   */
  private transient volatile Node<V> @Nullable [] nextTable = null;
  ...
  // views
  private transient @Nullable ObjectSet<Long2ObjectMap.Entry<V>> entrySet = null;
  ...
  public ObjectSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
    ObjectSet<Long2ObjectMap.Entry<V>> es;
  ...
  public int hashCode() {
    ...
    if ((t = table) != null) {
      Traverser<V> it = new Traverser<>(t, t.length, 0, t.length);
      for (Node<V> p; (p = it.advance()) != null; ) {
        h += p.key ^ Objects.hashCode(p.val);
      }
    }
    return h;
  }
   ...
   */
  final Node<V> @Nullable [] helpTransfer(Node<V>[] tab, Node<V> f) {
    Node<V>[] nextTab;
    int sc;
   ...
   */
  private void transfer(Node<V>[] tab, Node<V> @Nullable [] nextTab) {
   ...
   */
  private void treeifyBin(Node<V> @Nullable [] tab, int index) {
    Node<V> b;
    int n, sc;
    if (tab != null) {
  ...
  static final class TreeNode<V> extends Node<V> {
    @Nullable TreeNode<V> parent; // red-black tree links
    @Nullable TreeNode<V> left = null;
    @Nullable TreeNode<V> right = null;
    @Nullable TreeNode<V> prev = null; // needed to unlink next upon deletion
    boolean red;

    TreeNode(int hash, long key, @Nullable V val, @Nullable Node<V> next, @Nullable TreeNode<V> parent) {
  ...
  static final class TreeBin<V> extends Node<V> {
     ...
     */
    @Override
    final @Nullable Node<V> find(int h, long k) {
      ...
      for (TreeNode<V> p = root; ; ) {
        ...
        if (p == null) {
          ...
          if (!searched) {
            TreeNode<V> q, ch;
            searched = true;
            if (((ch = p.left) != null && (q = ch.findTreeNode(h, k)) != null) || ((ch = p.right) != null && (q = ch.findTreeNode(h, k)) != null)) {
              return q;
            }
          }
          dir = 0;
    ...
    static <V> TreeNode<V> balanceInsertion(@Nullable TreeNode<V> root, TreeNode<V> x) {
      x.red = true;
  ...
  static final class TableStack<V> {
    int length;
    int index;
    Node<V> @Nullable [] tab = null;

    @Nullable TableStack<V> next = null;
  }
  ...
  static class Traverser<V> {
    Node<V> @Nullable [] tab; // current table; updated if resized
    @Nullable Node<V> next;         // the next entry to use
    @Nullable TableStack<V> stack = null, spare = null; // to save/restore on ForwardingNodes
    int index;              // index of bin to use next
    int baseIndex;          // current index of initial table
    int baseLimit;          // index bound for initial table
    final int baseSize;     // initial table size

    Traverser(Node<V> @Nullable [] tab, int size, int index, int limit) {
      this.tab = tab;
      baseSize = size;
  ...
  static class BaseIterator<V> extends Traverser<V> {
    ...
    @Nullable Node<V> lastReturned = null;

    BaseIterator(Node<V> @Nullable [] tab, int size, int index, int limit, ConcurrentLongObjectHashMap<V> map) {
  ...
  static final class EntryIterator<V> extends BaseIterator<V> implements ObjectIterator<Long2ObjectMap.Entry<V>> {
    EntryIterator(Node<V> @Nullable [] tab, int index, int size, int limit, ConcurrentLongObjectHashMap<V> map) {
      super(tab, index, size, limit, map);
    }

    @Override
    public final Long2ObjectMap.Entry<V> next() {
      Node<V> p = next;
      if (p == null) {
      ...
      lastReturned = p;
      advance();
      return new AbstractLong2ObjectMap.BasicEntry<>(k, v);
    }
  }
  ...
  static final class EntrySetView<V> extends AbstractObjectSet<Long2ObjectMap.Entry<V>> {
    final ConcurrentLongObjectHashMap<V> map;
    ...
    public boolean remove(Object o) {
      ...
      Long2ObjectMap.Entry<?> e = (Long2ObjectMap.Entry<?>)o;
      Object v = e.getValue();
      return v != null && map.remove(e.getLongKey(), v);
    }
  ...
  static {
    try {
      MethodHandles.Lookup l = MethodHandles.lookup();
      SIZECTL = l.findVarHandle(ConcurrentLongObjectHashMap.class, "sizeCtl", int.class);
      TRANSFERINDEX = l.findVarHandle(ConcurrentLongObjectHashMap.class, "transferIndex", int.class);
      BASECOUNT = l.findVarHandle(ConcurrentLongObjectHashMap.class, "baseCount", long.class);
      CELLSBUSY = l.findVarHandle(ConcurrentLongObjectHashMap.class, "cellsBusy", int.class);
      CELLVALUE = l.findVarHandle(ConcurrentIntObjectHashMap.CounterCell.class, "value", long.class);
   ...
   */
  @Override
  public V cacheOrGet(long key, V defaultValue) {
    V v = get(key);
    if (v != null) return v;
