...
public class RecursionManager {
  private static final Logger LOG = LoggerFactory.getLogger(RecursionManager.class);
  ...
  private static class CalculationStack {
    ...
    private final Set<MyKey> preventions = Collections.newSetFromMap(new IdentityHashMap<>());
