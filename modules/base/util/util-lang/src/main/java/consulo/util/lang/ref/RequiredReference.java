 ...
 * @since 2026-04-04
 */
public final class RequiredReference<T extends @Nullable Object> implements Supplier<T> {
    ...
    private RequiredReference(T value) {
        myInitialized = true;
        myValue = value;
    }
    ...
    public static <T extends @Nullable Object> RequiredReference<T> empty() {
        return new RequiredReference<>();
    }

    public static <T extends @Nullable Object> RequiredReference<T> of(T value) {
        return new RequiredReference<>(value);
    }
