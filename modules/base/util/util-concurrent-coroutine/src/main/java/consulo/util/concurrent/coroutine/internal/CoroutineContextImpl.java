 ...
 * @author eso
 */
public final class CoroutineContextImpl extends CoroutineEnvironmentImpl implements CoroutineContext {
     ...
     */
    public CoroutineContextImpl(Executor executor, ScheduledExecutorService scheduler) {
    ...
    public CoroutineContext copy() {
        CoroutineContextImpl context = new CoroutineContextImpl(executor, scheduler);
