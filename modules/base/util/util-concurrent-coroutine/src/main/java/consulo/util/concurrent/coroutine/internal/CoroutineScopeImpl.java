...
import consulo.util.concurrent.coroutine.CoroutineScopeException;
 ...
 * through the factory method {@link CoroutineScope#launch(CoroutineContext, CoroutineScope.ScopeCode)} It
 * executes an instance of the functional interface {@link CoroutineScope.ScopeCode} and blocks
 ...
 * {@link CoroutineScope#produce(CoroutineContext, Function, CoroutineScope.ScopeCode)}. It also executes the
 ...
 * @author eso
 */
public class CoroutineScopeImpl extends CoroutineEnvironmentImpl implements CoroutineScope {
    ...
    public CoroutineScopeImpl(CoroutineContext context) {
        ...
        ((CoroutineContextImpl) this.context).scopeLaunched(this);
    }
    ...
    public static void launch(CoroutineContext context, CoroutineScope.ScopeCode code) {
        CoroutineScopeImpl aScope = new CoroutineScopeImpl(context);
    ...
    public static <T> ScopeFuture<T> produce(CoroutineContext context,
                                             Function<? super CoroutineScope, T> getResult, CoroutineScope.ScopeCode code) {
        return new ScopeFuture<>(new CoroutineScopeImpl(context), getResult, code);
    }
    ...
    public void await() {
        try {
            ...
            ((CoroutineContextImpl) context).scopeFinished(this);
     ...
     *
     * @see CoroutineEnvironmentImpl#getChannel(ChannelId)
     */
    @Override
     ...
     *
     * @see CoroutineEnvironmentImpl#hasChannel(ChannelId)
     */
    @Override
     ...
     *
     * @see CoroutineEnvironmentImpl#removeChannel(ChannelId)
     */
    @Override
    ...
    public String toString() {
        return String.format("%s[%d]", "CoroutineScope",
     ...
     * {@link CoroutineScope#launch(CoroutineContext, CoroutineScope.ScopeCode)} methods.
     *
    ...
    public static class ScopeFuture<T> implements Future<T> {
        ...
        private final CoroutineScopeImpl scope;
         ...
         */
        public ScopeFuture(CoroutineScopeImpl scope,
                           Function<? super CoroutineScope, T> getResult, CoroutineScope.ScopeCode code) {
            this.scope = scope;
