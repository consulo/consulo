 ...
 */
class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, TObjectHashingStrategy<K> {
  ...
  static class Node<K, V> implements Map.Entry<K, V> {
    ...
    Node(int hash, K key, V val, @Nonnull TObjectHashingStrategy<K> hashingStrategy) {
      this.hash = hash;
      this.key = key;
      this.val = val;
    ...
    public final int hashCode() {
      return hashingStrategy.computeHashCode(key) ^ val.hashCode();
    }
  ...
  ConcurrentHashMap(int initialCapacity, float loadFactor, int concurrencyLevel, @Nonnull TObjectHashingStrategy<K> hashingStrategy) {
  ...
  ConcurrentHashMap(@Nonnull TObjectHashingStrategy<K> hashingStrategy) {
  ...
  static final class ForwardingNode<K, V> extends Node<K, V> {
    ...
    ForwardingNode(Node<K, V>[] tab, @Nonnull TObjectHashingStrategy<K> hashingStrategy) {
  ...
  static final class ReservationNode<K, V> extends Node<K, V> {
    ReservationNode(@Nonnull TObjectHashingStrategy<K> hashingStrategy) {
  ...
  static final class TreeNode<K, V> extends Node<K, V> {
    ...
    TreeNode(int hash, K key, V val, Node<K, V> next, TreeNode<K, V> parent, @Nonnull TObjectHashingStrategy<K> hashingStrategy) {
  ...
  static final class TreeBin<K, V> extends Node<K, V> {
     ...
     */
    TreeBin(TreeNode<K, V> b, @Nonnull TObjectHashingStrategy<K> hashingStrategy) {
