...
public final class BrowseCallHierarchyAction extends BrowseHierarchyActionBase {
    public BrowseCallHierarchyAction() {
        super(
            ActionLocalize.actionCallhierarchyText(),
            ActionLocalize.actionCallhierarchyDescription(),
            StandardHierarchyKinds.CALL
        );
    }
    ...
    public Coroutine<?, ?> updateAsync(AnActionEvent e) {
        if (!ActionPlaces.MAIN_MENU.equals(e.getPlace())) {
            e.getPresentation().setText(LanguageEditorLocalize.actionBrowseCallHierarchy());
        }
