...
public final class NameUtil {
  ...
  /**
   * @deprecated use {@link consulo.language.editor.impl.internal.completion.Matcher}
   */
  @Deprecated
  ...
  public static consulo.language.editor.impl.internal.completion.Matcher buildMatcher(@Nonnull String pattern, int exactPrefixLen, boolean allowToUpper, boolean allowToLower) {
  ...
  @Deprecated
  @Nonnull
  public static consulo.language.editor.impl.internal.completion.Matcher buildMatcher(@Nonnull String pattern,
                                                                                      int exactPrefixLen,
