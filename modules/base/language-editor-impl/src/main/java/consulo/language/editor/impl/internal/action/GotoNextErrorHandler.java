...
public class GotoNextErrorHandler implements CodeInsightActionHandler {
    ...
    private void gotoNextError(Project project, Editor editor, PsiFile file, int caretOffset) {
        SeverityRegistrar severityRegistrar = SeverityRegistrarImpl.getSeverityRegistrar(project);
    ...
    static void showMessageWhenNoHighlights(Project project, PsiFile file, Editor editor) {
        DaemonCodeAnalyzerInternal codeHighlighter = (DaemonCodeAnalyzerInternal) DaemonCodeAnalyzer.getInstance(project);
    ...
    public static void navigateToError(Project project, final Editor editor, HighlightInfoImpl info) {
