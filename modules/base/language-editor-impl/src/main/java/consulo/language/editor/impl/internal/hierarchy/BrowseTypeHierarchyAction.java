...
@ActionImpl(id = "TypeHierarchy")
public final class BrowseTypeHierarchyAction extends BrowseHierarchyActionBase {
    public BrowseTypeHierarchyAction() {
        super(
            ActionLocalize.actionTypehierarchyText(),
            ActionLocalize.actionTypehierarchyDescription(),
            StandardHierarchyKinds.TYPE
        );
    }
    ...
    public Coroutine<?, ?> updateAsync(AnActionEvent e) {
        if (!ActionPlaces.MAIN_MENU.equals(e.getPlace())) {
            e.getPresentation().setText(LanguageEditorLocalize.actionBrowseTypeHierarchy());
        }
