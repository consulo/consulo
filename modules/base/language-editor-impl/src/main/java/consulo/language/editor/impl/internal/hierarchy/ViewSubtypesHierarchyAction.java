 ...
 * @author cdr
 */
@ActionImpl(id = "TypeHierarchy.Subtypes")
public final class ViewSubtypesHierarchyAction extends ChangeViewTypeAction {
    public ViewSubtypesHierarchyAction() {
        super(StandardHierarchyViewTypes.SUBTYPES);
    }
}
