...
final class DocRenderSelectionManager implements CaretListener, SelectionListener, Disposable {
    ...
    void setPaneWithSelection(@Nullable DocRenderer.EditorInlineHtmlPane pane) {
    ...
    public void selectionChanged(SelectionEvent e) {
        if (!mySkipSelectionEvents) {
            setPaneWithSelection(null);
        }
    }

    public static @Nullable DocRenderer.EditorInlineHtmlPane getPaneWithSelection(Editor editor) {
