...
/**
 * Copy of {@link com.intellij.ui.components.panels.Wrapper} - but not placed inside independent module
 */
@Internal
public class Wrapper2 extends JPanel implements NullableComponent {
  ...
  public Wrapper2(JComponent wrapped) {
    setLayout(new BorderLayout());
    add(wrapped, BorderLayout.CENTER);
    setOpaque(false);
  }

  public Wrapper2(LayoutManager layout, JComponent wrapped) {
    super(layout);
    add(wrapped);
    setOpaque(false);
  }

  public Wrapper2(boolean isDoubleBuffered) {
    super(isDoubleBuffered);
    setOpaque(false);
  }

  public Wrapper2(LayoutManager layout) {
    super(layout);
    setOpaque(false);
  }

  public Wrapper2(LayoutManager layout, boolean isDoubleBuffered) {
  ...
  public final Wrapper2 setVerticalSizeReferent(JComponent verticalSizeReferent) {
    myVerticalSizeReferent = verticalSizeReferent;
    return this;
  }

  public final Wrapper2 setHorizontalSizeReferent(JComponent horizontalSizeReferent) {
