...
public class mxGraph extends mxEventSource {
      ...
      if (!tmp.isEmpty()) {
        ...
        for (int i = 0; i < cells.length; i++) {
          if (!allowInvalidEdges &&
              ...
              getEdgeValidationError(clones[i], model.getTerminal(clones[i], true), model.getTerminal(clones[i], false)) != null) {
            clones[i] = null;
          }
          else {
   ...
   */
  public mxCell insertVertex(Object parent, String id, Object value, double x, double y, double width, double height) {
   ...
   */
  public mxCell insertVertex(Object parent, String id, Object value, double x, double y, double width, double height, String style) {
   ...
   */
  public mxCell insertEdge(Object parent, String id, Object value, Object source, Object target) {
   ...
   */
  public mxCell createEdge(Object parent, String id, Object value, Object source, Object target, String style) {
   ...
   */
  public Object addEdge(mxCell edge, Object parent, Object source, Object target, Integer index) {
