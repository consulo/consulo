...
public class Main {
  ...
  public static void main(final String[] args) {
    ...
    if (!SystemInfoRt.isJavaVersionAtLeast(8, 0, 0)) {
      showMessage("Unsupported Java Version", "Cannot start under Java " + System.getProperty("java.runtime.version") + ": Java 1.8 or later is required.", true);
