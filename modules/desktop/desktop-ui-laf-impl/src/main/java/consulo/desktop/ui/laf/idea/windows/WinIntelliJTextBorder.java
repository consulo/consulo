...
import consulo.desktop.ui.laf.idea.darcula.DarculaTextBorder;
...
import static consulo.desktop.ui.laf.idea.windows.WinIntelliJTextFieldUI.HOVER_PROPERTY;
...
public class WinIntelliJTextBorder extends DarculaTextBorder {
  ...
  public Insets getBorderInsets(Component c) {
    return DarculaUIUtil.isTableCellEditor(c) || DarculaUIUtil.isCompact(c) ? JBUI.insets(1, 1, 1, 4).asUIResource() : JBUI.insets(1).asUIResource();
  }
