  ...
  protected void paintIcon(JComponent c, Graphics2D g, Rectangle viewRect, Rectangle iconRect) {
    ...
    if (focus) {
      ...
      if (UIUtil.isUnderDarcula()) {
        ...
        g.setPaint(c.isEnabled() ? Gray._30 : Gray._130);
        g.drawOval(0, JBUI.scale(1), w - 1, h - 1);
      }
    }
    ...
    if (selected) {
      ...
      g.setColor(UIManager.getColor(
              enabled ? "RadioButton.darcula.selectionEnabledShadowColor" : "RadioButton.darcula.selectionDisabledShadowColor"));// ? Gray._30 : Gray._60);
      final int yOff = 1 + JBUI.scale(1);
      g.fillOval(w / 2 - rad / 2, h / 2 - rad / 2 + yOff, rad, rad);
      g.setColor(UIManager.getColor(
              enabled ? "RadioButton.darcula.selectionEnabledColor" : "RadioButton.darcula.selectionDisabledColor")); //Gray._170 : Gray._120);
