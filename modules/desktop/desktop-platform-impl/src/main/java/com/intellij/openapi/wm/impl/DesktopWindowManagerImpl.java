...
public final class DesktopWindowManagerImpl extends WindowManagerEx implements NamedComponent, PersistentStateComponent<Element> {
  ...
  public JFrame findVisibleFrame() {
    ...
    DesktopIdeFrame desktopIdeFrame = (DesktopIdeFrame)WelcomeFrame.getInstance();
  ...
  public final IdeFrameEx allocateFrame(@Nonnull final Project project) {
    ...
    if (myProject2Frame.containsKey(null)) {
      ...
      frame = new DesktopIdeFrameImpl(myActionManager, myDataManager, ApplicationManager.getApplication());
