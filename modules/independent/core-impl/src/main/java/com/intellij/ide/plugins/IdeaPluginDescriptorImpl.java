...
public class IdeaPluginDescriptorImpl implements IdeaPluginDescriptor {
  ...
  public void registerExtensionPoints(@Nonnull ExtensionsAreaImpl area) {
    if (myExtensionsPoints != null) {
      for (Element element : myExtensionsPoints.get(StringUtil.notNullize(area.getId()))) {
        area.registerExtensionPointImpl(this, element);
      }
    }
  }
  ...
  void registerExtensions(@Nonnull ExtensionsAreaImpl area, @Nonnull String epName) {
    if (myExtensions != null) {
      for (Element element : myExtensions.get(epName)) {
        area.registerExtensionImpl(this, element);
      }
    }
  }
