...
class RangeHighlighterTree extends RangeMarkerTree<RangeHighlighterEx> {
  ...
  @Nonnull
  @Override
  protected RHNode createNewNode(@Nonnull RangeHighlighterEx key, int start, int end, boolean greedyToLeft, boolean greedyToRight, int layer) {
  ...
  static class RHNode extends RMNode<RangeHighlighterEx> {
    ...
    public RHNode(@Nonnull RangeHighlighterTree rangeMarkerTree,
