...
public class InlayModelImpl implements InlayModel, Disposable {
  ...
  private static final Comparator<Inlay> INLAY_COMPARATOR =
          Comparator.comparingInt(Inlay::getOffset).thenComparing(i -> i.isRelatedToPrecedingText()).thenComparingInt(i -> ((InlayImpl)i).myOriginalOffset);
