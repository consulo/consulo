...
public class ExtensionsAreaImpl implements ExtensionsArea {
  ...
  @TestOnly
  ExtensionsAreaImpl(@Nonnull LogProvider logger) {
  ...
  public void registerExtensionPointImpl(@Nonnull PluginDescriptor pluginDescriptor, @Nonnull Element extensionPointElement) {
  ...
  private void registerExtensionPoint(@Nonnull String extensionPointName, @Nonnull String extensionPointBeanClass, @Nonnull PluginDescriptor descriptor, @Nonnull ExtensionPoint.Kind kind) {
    if (hasExtensionPoint(extensionPointName)) {
      if (DEBUG_REGISTRATION) {
        ...
        myLogger.error("Duplicate registration for EP: " + extensionPointName + ": original plugin " + oldEP.getDescriptor().getPluginId() + ", new plugin " + descriptor.getPluginId(),
  ...
  public void registerExtensionImpl(@Nonnull final PluginDescriptor pluginDescriptor, @Nonnull final Element extensionElement) {
