...
import com.intellij.ui.border.IdeaTitledBorder2;
...
public class IdeBorderFactory2 {
  ...
  @Deprecated
  public static IdeaTitledBorder2 createTitledBorder(String title, boolean hasBoldFont, boolean hasIndent, boolean hasSmallFont) {
    return createTitledBorder(title, hasIndent);
  }

  @Deprecated
  public static IdeaTitledBorder2 createTitledBorder(String title, boolean hasBoldFont, boolean hasIndent, boolean hasSmallFont, Insets insets) {
    return createTitledBorder(title, hasIndent, insets);
  }

  public static IdeaTitledBorder2 createTitledBorder(String title, boolean hasIndent) {
  ...
  public static IdeaTitledBorder2 createTitledBorder(String title, boolean hasIndent, Insets insets) {
    int indent = hasIndent ? TITLED_BORDER_INDENT : 0;
    return new IdeaTitledBorder2(title, indent, insets);
  }

  @Deprecated
  // Don't remove, used in TeamCity plugin.
  public static TitledBorder createTitledHeaderBorder(String title) {
    return new IdeaTitledBorder2(title, 10, new Insets(5, 0, 10, 0));
  }
  ...
  public static class PlainSmallWithIndent {
    ...
    public static TitledBorder createTitledBorder(Border border,
                                                  ...
                                                  Font titleFont,
                                                  Color titleColor) {
      return IdeBorderFactory2.createTitledBorder(title, true);
    }
  }
  ...
  public static class PlainSmallWithoutIndent {
    ...
    public static TitledBorder createTitledBorder(Border border,
                                                  ...
                                                  Font titleFont,
                                                  Color titleColor) {
      return IdeBorderFactory2.createTitledBorder(title, false);
    }
  }
  ...
  public static class PlainSmallWithoutIndentWithoutInsets {
    ...
    public static TitledBorder createTitledBorder(Border border,
                                                  ...
                                                  Font titleFont,
                                                  Color titleColor) {
      return IdeBorderFactory2.createTitledBorder(title, false, new Insets(TITLED_BORDER_TOP_INSET,0,0,0));
    }
  }
  ...
  public static class PlainSmallWithIndentWithoutInsets {
    ...
    public static TitledBorder createTitledBorder(Border border,
                                                  ...
                                                  Font titleFont,
                                                  Color titleColor) {
      return IdeBorderFactory2.createTitledBorder(title, true, new Insets(TITLED_BORDER_TOP_INSET,0,0,0));
    }
  }
}
