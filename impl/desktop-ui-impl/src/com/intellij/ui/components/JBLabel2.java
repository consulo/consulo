...
public class JBLabel2 extends JLabel implements AnchorableComponent {
  ...
  public JBLabel2(@NotNull UIUtil.ComponentStyle componentStyle) {
    super();
    setComponentStyle(componentStyle);
  }

  public JBLabel2(@Nullable Icon image) {
    super(image);
  }

  public JBLabel2(@NotNull String text) {
    super(text);
  }

  public JBLabel2(@NotNull String text, @NotNull UIUtil.ComponentStyle componentStyle) {
    super(text);
    setComponentStyle(componentStyle);
  }

  public JBLabel2(@NotNull String text, @NotNull UIUtil.ComponentStyle componentStyle, @NotNull UIUtil.FontColor fontColor) {
    super(text);
    setComponentStyle(componentStyle);
    setFontColor(fontColor);
  }

  public JBLabel2(@NotNull String text, @JdkConstants.HorizontalAlignment int horizontalAlignment) {
    super(text, horizontalAlignment);
  }

  public JBLabel2(@Nullable Icon image, @JdkConstants.HorizontalAlignment int horizontalAlignment) {
    super(image, horizontalAlignment);
  }

  public JBLabel2(@NotNull String text, @Nullable Icon icon, @JdkConstants.HorizontalAlignment int horizontalAlignment) {
  ...
  /**
   *
   * In 'copyable' mode JBLabel2 has the same appearance but user can select text with mouse and copy it to clipboard with standard shortcut.
   * @return 'this' (the same instance)
   */
  //
  // By default JBLabel2 is NOT copyable
  // This method re
  public JBLabel2 setCopyable(boolean copyable) {
    if (copyable ^ myEditorPane != null) {
      if (myEditorPane == null) {
        final JLabel ellipsisLabel = new JBLabel2("...");
