 ...
 */
public class IdeaTitledBorder2 extends TitledBorder {

  private final TitledSeparator titledSeparator;
  private final Insets insideInsets;
  private final Insets outsideInsets;

  public IdeaTitledBorder2(String title, int indent, Insets insets) {
    super(title);
    titledSeparator = new TitledSeparator(title);
    titledSeparator.setText(title);
    //FIXME [VISTALL] DialogUtil.registerMnemonic(titledSeparator.getLabel(), null);
