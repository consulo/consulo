 ...
 *
 * See TODO - its a different from {@link com.intellij.ui.SimpleColoredComponent}
 *
...
public class SimpleColoredComponent2 extends JComponent implements Accessible, ColoredTextContainer {
  ...
  public SimpleColoredComponent2() {
  ...
  @NotNull
  public final SimpleColoredComponent2 append(@NotNull String fragment) {
  ...
  public static class BrowserLauncherTag implements Runnable {
    ...
    @Override
    public void run() {
      //TODO [VISTALL] no access BrowserUtil.browse(myUrl);
    }
  }
