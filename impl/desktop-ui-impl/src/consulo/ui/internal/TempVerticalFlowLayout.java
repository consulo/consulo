...
class TempVerticalFlowLayout extends FlowLayout implements Serializable {
  ...
  public TempVerticalFlowLayout() {
    this(TOP, 0, 0, true, false);
  }

  public TempVerticalFlowLayout(@VerticalFlowAlignment int alignment) {
    this(alignment, 0, 0, true, false);
  }

  public TempVerticalFlowLayout(boolean fillHorizontally, boolean fillVertically) {
    this(TOP, 0, 0, fillHorizontally, fillVertically);
  }

  public TempVerticalFlowLayout(@VerticalFlowAlignment int alignment, boolean fillHorizontally, boolean fillVertically) {
    this(alignment, 0, 0, fillHorizontally, fillVertically);
  }

  public TempVerticalFlowLayout(int hGap, int vGap) {
    this(TOP, hGap, vGap, true, false);
  }

  public TempVerticalFlowLayout(@VerticalFlowAlignment int alignment, int hGap, int vGap, boolean fillHorizontally, boolean fillVertically) {
