...
public abstract class ParsingTestCase2 extends UsefulTestCase {
  ...
  public ParsingTestCase2(@NonNls @NotNull String dataPath, @NotNull FileType fileType) {
  ...
  protected void doTest(boolean checkResult) {
    ...
    try {
      String text = loadFile(name + "." + myFileType.getDefaultExtension());
  ...
  protected PsiFile createPsiFile(String name, String text) {
    return createFile(name + "." + myFileType.getDefaultExtension(), myFileType, text);
  }

  protected PsiFile createFile(@NonNls String name, @NotNull FileType fileType, String text) {
    return myFileFactory.createFileFromText(name, fileType, text);
  }
