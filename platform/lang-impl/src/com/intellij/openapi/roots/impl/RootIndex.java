...
class RootIndex {
      ...
      for (OrderEntry orderEntry : orderEntries) {
        ...
        if (orderEntry instanceof ModuleOrderEntry) {
          ...
          for (final VirtualFile sourceRoot : sourceRoots) {
            ...
            int sourceRootTypeData = DirectoryInfo
              .createSourceRootTypeData(info.isInModuleSource(), true, getRootTypeId(ProductionContentFolderTypeProvider.getInstance()));
  ...
  private int getRootTypeId(ContentFolderTypeProvider rootType) {
  ...
  List<VirtualFile> getDirectoriesByPackageName(@NotNull final String packageName, final boolean includeLibrarySources) {
    Map<String, List<VirtualFile>> cacheMap =
      includeLibrarySources ? myDirectoriesByPackageNameCacheWithLibSrc : myDirectoriesByPackageNameCache;
  ...
  @Nullable
  public ContentFolderTypeProvider getSourceRootType(@NotNull DirectoryInfo directoryInfo) {
