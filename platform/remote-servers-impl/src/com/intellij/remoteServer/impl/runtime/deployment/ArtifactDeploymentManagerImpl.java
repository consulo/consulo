...
import com.intellij.remoteServer.configuration.deployment.ArtifactDeploymentManager;
 ...
 * @author nik
 */
public class ArtifactDeploymentManagerImpl extends ArtifactDeploymentManager {
  @NotNull
  @Override
  ...
  public List<DeploymentSource> createArtifactDeploymentSources(@NotNull Project project,
    ...
    for (Artifact artifact : artifacts) {
      sources.add(createArtifactDeploymentSource(pointerManager.create(artifact)));
    }
    return sources;
  }
}
