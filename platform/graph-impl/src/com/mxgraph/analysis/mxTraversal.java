...
public class mxTraversal {
  ...
  public static void dijkstra(mxAnalysisGraph aGraph, Object startVertex, Object endVertex, mxICellVisitor visitor)
    ...
    while (vertexList.size() > 0) {
      ...
      Object[] neighborVertices =
        aGraph.getOpposites(aGraph.getEdges(closestVertex, null, true, true, false, true), closestVertex, true, true);
  ...
  private static ArrayList<Object> getWFIPathRec(mxAnalysisGraph aGraph,
                                                 ...
                                                 Object startVertex,
                                                 Object targetVertex,
                                                 ArrayList<Object> currPath,
                                                 mxCostFunction cf,
                                                 mxGraphView view) throws StructuralException {
