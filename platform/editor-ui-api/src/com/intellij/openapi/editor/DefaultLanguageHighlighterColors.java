...
public interface DefaultLanguageHighlighterColors {
  ...
  TextAttributesKey TEMPLATE_LANGUAGE_COLOR =
  ...
  TextAttributesKey FUNCTION_CALL =
    TextAttributesKey.createTextAttributesKey("DEFAULT_FUNCTION_CALL", IDENTIFIER);
  TextAttributesKey PARAMETER =
    TextAttributesKey.createTextAttributesKey("DEFAULT_PARAMETER", IDENTIFIER);
  TextAttributesKey TYPE_ALIAS_NAME =
    TextAttributesKey.createTextAttributesKey("DEFAULT_TYPE_ALIAS_NAME", IDENTIFIER);
  ...
  TextAttributesKey DOC_COMMENT_TAG_VALUE =
