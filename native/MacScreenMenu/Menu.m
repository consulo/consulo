...
#define GET_MENU_CLASS() GET_CLASS(sjc_Menu, "consulo/desktop/awt/ui/mac/screenmenu/Menu");
...
- (void)menuNeedsUpdate:(NSMenu *)menu {
    ...
    if (sUpdateInProgress) {
        // Nested updates can lead to crash
...
/*
 * Class:     consulo_desktop_awt_ui_mac_screenmenu_Menu
 * Method:    nativeCreateMenu
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL
Java_consulo_desktop_awt_ui_mac_screenmenu_Menu_nativeCreateMenu
 ...
 */
JNIEXPORT jlong JNICALL
Java_consulo_desktop_awt_ui_mac_screenmenu_Menu_nativeAttachMenu
...
Java_consulo_desktop_awt_ui_mac_screenmenu_Menu_nativeSetTitle
 ...
 */
JNIEXPORT void JNICALL
Java_consulo_desktop_awt_ui_mac_screenmenu_Menu_nativeAddItem
 ...
 */
JNIEXPORT void JNICALL
Java_consulo_desktop_awt_ui_mac_screenmenu_Menu_nativeInsertItem
...
- (void)refill {
    ...
    if (menu == nil) {
        // Going to update main menu. Will defer update in some cases
        bool defer = false;
        if (sUpdateInProgress) {
 ...
 */
JNIEXPORT void JNICALL
Java_consulo_desktop_awt_ui_mac_screenmenu_Menu_nativeRefill
 ...
 */
JNIEXPORT void JNICALL
Java_consulo_desktop_awt_ui_mac_screenmenu_Menu_nativeInitClass(JNIEnv *env, jclass peerClass) {
    if (sjc_Menu == NULL) {
...
Java_consulo_desktop_awt_ui_mac_screenmenu_Menu_nativeFindIndexByTitle(JNIEnv *env, jobject peer, jlong menuObj, jstring re) {
    JNI_COCOA_ENTER();
    __strong Menu * menu = (Menu *)menuObj;
 ...
 */
JNIEXPORT jlong JNICALL
Java_consulo_desktop_awt_ui_mac_screenmenu_Menu_nativeFindItemByTitle(JNIEnv *env, jobject peer, jlong menuObj, jstring re) {
    JNI_COCOA_ENTER();
    __strong Menu * menu = (Menu *)menuObj;
    __strong NSString* regexp = JavaStringToNSString(env, re);
 ...
 */
JNIEXPORT jlong JNICALL
Java_consulo_desktop_awt_ui_mac_screenmenu_Menu_nativeGetAppMenu(JNIEnv *env, jclass peerClass) {
    JNI_COCOA_ENTER();
 ...
 */
JNIEXPORT void JNICALL
Java_consulo_desktop_awt_ui_mac_screenmenu_Menu_nativeRenameAppMenuItems(JNIEnv *env, jclass peerClass, jobjectArray jStringArray) {
    JNI_COCOA_ENTER();
